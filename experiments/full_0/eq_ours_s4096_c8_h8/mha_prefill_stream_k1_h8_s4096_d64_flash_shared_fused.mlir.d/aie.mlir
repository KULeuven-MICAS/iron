      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c8 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c64 step %c1_1 {
            ...
            %c4096_i32 = arith.constant 4096 : i32
            %c4096_i32_10 = arith.constant 4096 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_4_3, %flash_index_4_3, %13, %c64_i32, %c64_i32_9, %c4096_i32, %c4096_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c8 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c64 step %c1_1 {
            ...
            %c4096_i32 = arith.constant 4096 : i32
            %c4096_i32_10 = arith.constant 4096 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_5_3, %flash_index_5_3, %13, %c64_i32, %c64_i32_9, %c4096_i32, %c4096_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c8 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c64 step %c1_1 {
            ...
            %c4096_i32 = arith.constant 4096 : i32
            %c4096_i32_10 = arith.constant 4096 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_6_3, %flash_index_6_3, %13, %c64_i32, %c64_i32_9, %c4096_i32, %c4096_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c8 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c64 step %c1_1 {
            ...
            %c4096_i32 = arith.constant 4096 : i32
            %c4096_i32_10 = arith.constant 4096 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_7_3, %flash_index_7_3, %13, %c64_i32, %c64_i32_9, %c4096_i32, %c4096_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
