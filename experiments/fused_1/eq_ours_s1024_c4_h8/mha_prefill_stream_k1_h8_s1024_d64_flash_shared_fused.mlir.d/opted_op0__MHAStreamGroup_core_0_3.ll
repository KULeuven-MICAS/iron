; ModuleID = '/home/micas/iron-stream-dse/experiments/fused_1/eq_ours_s1024_c4_h8/mha_prefill_stream_k1_h8_s1024_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_3.ll'
...
14:                                               ; preds = %6, %26
  ...
  %spec.select5 = select i1 %cond1, ptr @of_7_unicast_0_0_cons_buff_1, ptr @of_7_unicast_0_0_cons_buff_0
  ...
  %21 = select i1 %cond3, ptr @flash_scale_0_2_buff_1, ptr @flash_scale_0_2_buff_0
  %22 = icmp ne i32 %20, 0
  %23 = zext i1 %22 to i32
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %19, ptr nonnull %spec.select, ptr nonnull %21, i32 64, i32 %23, ptr nonnull @flash_index_0_3)
  %24 = icmp eq i32 %20, 15
  br i1 %24, label %25, label %26

25:                                               ; preds = %14
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %21, i32 64, ptr nonnull @flash_index_0_3)
  br label %26
...
26:                                               ; preds = %25, %14
  ...
  %37 = icmp samesign ult i64 %18, 15
