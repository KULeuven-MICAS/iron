; ModuleID = '/home/micas/iron-stream-dse/experiments/fused_1/eq_ours_s1024_c4_h8/mha_prefill_stream_k1_h8_s1024_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_3.ll'
...
15:                                               ; preds = %6, %27
  ...
  %spec.select5 = select i1 %cond1, ptr @of_7_unicast_1_0_cons_buff_1, ptr @of_7_unicast_1_0_cons_buff_0
  ...
  %22 = select i1 %cond3, ptr @flash_scale_1_2_buff_1, ptr @flash_scale_1_2_buff_0
  %23 = icmp ne i32 %21, 0
  %24 = zext i1 %23 to i32
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %20, ptr nonnull %spec.select, ptr nonnull %22, i32 64, i32 %24, ptr nonnull @flash_index_1_3)
  %25 = icmp eq i32 %21, 15
  br i1 %25, label %26, label %27

26:                                               ; preds = %15
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %22, i32 64, ptr nonnull @flash_index_1_3)
  br label %27
