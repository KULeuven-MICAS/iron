; ModuleID = '/home/micas/iron-stream-dse/experiments/fused_1/eq_ours_s1024_c4_h8/mha_prefill_stream_k1_h8_s1024_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_3_2.ll'
...
15:                                               ; preds = %6, %24
  ...
  %spec.select5 = select i1 %cond1, ptr @of_6_unicast_3_buff_1, ptr @of_6_unicast_3_buff_0
...
24:                                               ; preds = %23, %15
  tail call void @op0_matmul_softmax(ptr nonnull %spec.select, ptr nonnull %20, ptr nonnull %spec.select5, ptr nonnull @flash_state_3_2, ptr nonnull @flash_index_3_2, bfloat 0xR3FB9, i32 64, i32 64, i32 1024, i32 1024)
