; ModuleID = '/home/micas/iron-stream-dse/experiments/depth_0132_6/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_4.ll'
...
@switch.table.core_0_4.1 = private unnamed_addr constant [5 x ptr] [ptr @flash_scale_0_5_buff_1, ptr @flash_scale_0_5_buff_2, ptr @flash_scale_0_5_buff_3, ptr @flash_scale_0_5_buff_4, ptr @flash_scale_0_5_buff_5], align 4
...
switch.lookup:                                    ; preds = %39
  ...
  %switch.gep = getelementptr inbounds nuw [5 x ptr], ptr @switch.table.core_0_4, i20 0, i20 %41
...
49:                                               ; preds = %32
  ...
  %50 = icmp ult i32 %switch.tableidx40, 5
  br i1 %50, label %switch.lookup39, label %52

switch.lookup39:                                  ; preds = %49
  %51 = trunc nuw i32 %switch.tableidx40 to i20
  %switch.gep41 = getelementptr inbounds nuw [5 x ptr], ptr @switch.table.core_0_4.1, i20 0, i20 %51
