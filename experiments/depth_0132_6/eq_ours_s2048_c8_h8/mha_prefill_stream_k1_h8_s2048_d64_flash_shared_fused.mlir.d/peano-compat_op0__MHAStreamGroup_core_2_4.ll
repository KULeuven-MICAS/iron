...
74:                                               ; preds = %142, %144, %146, %148, %150, %152, %72
  %75 = phi ptr [ %153, %152 ], [ %151, %150 ], [ %149, %148 ], [ %147, %146 ], [ %145, %144 ], [ %143, %142 ], [ @flash_scale_2_3_buff_0, %72 ]
...
90:                                               ; preds = %154, %156, %158, %160, %162, %164, %88
  %91 = phi ptr [ %165, %164 ], [ %163, %162 ], [ %161, %160 ], [ %159, %158 ], [ %157, %156 ], [ %155, %154 ], [ @flash_scale_2_5_buff_0, %88 ]
...
154:                                              ; preds = %88
  %155 = phi ptr [ @flash_scale_2_5_buff_0, %88 ]
  br label %90

156:                                              ; preds = %88
  %157 = phi ptr [ @flash_scale_2_5_buff_1, %88 ]
  br label %90

158:                                              ; preds = %88
  %159 = phi ptr [ @flash_scale_2_5_buff_2, %88 ]
  br label %90

160:                                              ; preds = %88
  %161 = phi ptr [ @flash_scale_2_5_buff_3, %88 ]
  br label %90

162:                                              ; preds = %88
  %163 = phi ptr [ @flash_scale_2_5_buff_4, %88 ]
  br label %90

164:                                              ; preds = %88
  %165 = phi ptr [ @flash_scale_2_5_buff_5, %88 ]
  br label %90
}
