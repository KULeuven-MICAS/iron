module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<256x512xbf16>, %arg1: memref<512x2048xbf16>, %arg2: memref<512x2048xbf16>, %arg3: memref<2048x512xbf16>, %arg4: memref<256x512xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x512xbf16> offset = 0 len = 16384 sizes = [8, 16, 32, 32] strides = [16384, 32, 512, 1])
        aie.end
      ...
      %10 = aiex.dma_configure_task_for @of_3_mem_0 {
        aie.dma_bd(%arg3 : memref<2048x512xbf16> offset = 0 len = 32768 sizes = [16, 8, 128, 32] strides = [65536, 64, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 32768 : index, repeat_count = 15 : i32}
      aiex.dma_start_task(%10)
      %11 = aiex.dma_configure_task_for @of_3_mem_1 {
        aie.dma_bd(%arg3 : memref<2048x512xbf16> offset = 32 len = 32768 sizes = [16, 8, 128, 32] strides = [65536, 64, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 32768 : index, repeat_count = 15 : i32}
    ...
    aie.objectfifo @of_0_mem_0(%shim_noc_tile_0_0, {%mem_tile_0_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<16x4x32x32xbf16>>  
    aie.objectfifo @of_0_mem_1(%shim_noc_tile_1_0, {%mem_tile_1_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<16x4x32x32xbf16>>  
    aie.objectfifo @of_1_mem_0(%shim_noc_tile_4_0, {%mem_tile_4_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_1_mem_1(%shim_noc_tile_6_0, {%mem_tile_6_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_2_mem_0(%shim_noc_tile_3_0, {%mem_tile_3_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_2_mem_1(%shim_noc_tile_5_0, {%mem_tile_5_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_3_mem_0(%shim_noc_tile_2_0, {%mem_tile_2_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x32xbf16>>  
    aie.objectfifo @of_3_mem_1(%shim_noc_tile_7_0, {%mem_tile_7_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x32xbf16>>  
    aie.objectfifo @of_4_distribute_0_0(%mem_tile_0_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_2_2, %tile_0_2}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_distribute_0_1(%mem_tile_0_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_0_3, %tile_2_3}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_distribute_0_2(%mem_tile_0_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_2_4, %tile_0_4}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_distribute_0_3(%mem_tile_0_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_2_5, %tile_0_5}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo.link [@of_0_mem_0] -> [@of_4_distribute_0_0, @of_4_distribute_0_1, @of_4_distribute_0_2, @of_4_distribute_0_3]([] [0, 16384, 32768, 49152])
    aie.objectfifo @of_4_distribute_1_0(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_3_2, %tile_1_2}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_distribute_1_1(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_3_3, %tile_1_3}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_distribute_1_2(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_3_4, %tile_1_4}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_distribute_1_3(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_1_5, %tile_3_5}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo.link [@of_0_mem_1] -> [@of_4_distribute_1_0, @of_4_distribute_1_1, @of_4_distribute_1_2, @of_4_distribute_1_3]([] [0, 16384, 32768, 49152])
    aie.objectfifo @of_5_broadcast_0_0(%mem_tile_4_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_2, %tile_0_3, %tile_0_4, %tile_0_5}, [2 : i32, 2 : i32, 2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo.link [@of_1_mem_0] -> [@of_5_broadcast_0_0]([] [])
    aie.objectfifo @of_5_broadcast_1_0(%mem_tile_6_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_1_2, %tile_1_3, %tile_1_4, %tile_1_5}, [2 : i32, 2 : i32, 2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo.link [@of_1_mem_1] -> [@of_5_broadcast_1_0]([] [])
    aie.objectfifo @of_6_broadcast_0_0(%mem_tile_3_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_2_2, %tile_2_3, %tile_2_4, %tile_2_5}, [2 : i32, 2 : i32, 2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo.link [@of_2_mem_0] -> [@of_6_broadcast_0_0]([] [])
    aie.objectfifo @of_6_broadcast_1_0(%mem_tile_5_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_3_2, %tile_3_3, %tile_3_4, %tile_3_5}, [2 : i32, 2 : i32, 2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo.link [@of_2_mem_1] -> [@of_6_broadcast_1_0]([] [])
    aie.objectfifo @of_7_broadcast_0_0(%mem_tile_2_1 dimensionsToStream [<size = 8, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_6_2, %tile_6_3, %tile_6_4, %tile_6_5}, [2 : i32, 2 : i32, 2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x32xbf16>>  
    ...
    aie.objectfifo @of_11_broadcast_2(%tile_5_4, {%tile_6_4, %tile_7_4}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_11_broadcast_3(%tile_5_5, {%tile_7_5, %tile_6_5}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_12_join_0_0(%tile_6_2, {%mem_tile_5_1}, [8 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_12_join_0_1(%tile_6_3, {%mem_tile_5_1}, [8 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_12_join_0_2(%tile_6_4, {%mem_tile_5_1}, [8 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_12_join_0_3(%tile_6_5, {%mem_tile_5_1}, [8 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    ...
    aie.objectfifo @of_13_mem_0(%mem_tile_5_1 dimensionsToStream [<size = 4, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%shim_noc_tile_5_0}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<8x4x32x32xbf16>>  
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<3276800xbf16>, %arg1: memref<131072xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        ...
        %subview_4 = memref.subview %arg0[2228224] [1048576] [1] : memref<3276800xbf16> to memref<1048576xbf16, strided<[1], offset: 2228224>>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [2048, 512], strides: [512, 1] : memref<1048576xbf16, strided<[1], offset: 2228224>> to memref<2048x512xbf16>
        %subview_6 = memref.subview %arg1[0] [131072] [1] : memref<131072xbf16> to memref<131072xbf16>
        %reinterpret_cast_7 = memref.reinterpret_cast %subview_6 to offset: [0], sizes: [256, 512], strides: [512, 1] : memref<131072xbf16> to memref<256x512xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5, %reinterpret_cast_7) : (memref<256x512xbf16>, memref<512x2048xbf16>, memref<512x2048xbf16>, memref<2048x512xbf16>, memref<256x512xbf16>)
      }
