...
15:                                               ; preds = %57, %59, %13
  %16 = phi ptr [ %60, %59 ], [ %58, %57 ], [ @of_3_unicast_6_0_cons_buff_0, %13 ]
...
29:                                               ; preds = %61, %63, %27
  %30 = phi ptr [ %64, %63 ], [ %62, %61 ], [ @of_6_unicast_6_buff_0, %27 ]
...
34:                                               ; preds = %65, %67, %32
  %35 = phi ptr [ %68, %67 ], [ %66, %65 ], [ @of_4_broadcast_0_0_6_cons_buff_0, %32 ]
...
57:                                               ; preds = %13
  %58 = phi ptr [ @of_3_unicast_6_0_cons_buff_0, %13 ]
  br label %15

59:                                               ; preds = %13
  %60 = phi ptr [ @of_3_unicast_6_0_cons_buff_1, %13 ]
  br label %15

61:                                               ; preds = %27
  %62 = phi ptr [ @of_6_unicast_6_buff_0, %27 ]
  br label %29

63:                                               ; preds = %27
  %64 = phi ptr [ @of_6_unicast_6_buff_1, %27 ]
  br label %29

65:                                               ; preds = %32
  %66 = phi ptr [ @of_4_broadcast_0_0_6_cons_buff_0, %32 ]
  br label %34

67:                                               ; preds = %32
  %68 = phi ptr [ @of_4_broadcast_0_0_6_cons_buff_1, %32 ]
  br label %34
}
