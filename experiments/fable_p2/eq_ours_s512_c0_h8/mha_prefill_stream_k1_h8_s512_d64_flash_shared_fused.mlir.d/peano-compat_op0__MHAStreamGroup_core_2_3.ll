...
15:                                               ; preds = %46, %48, %13
  %16 = phi ptr [ %49, %48 ], [ %47, %46 ], [ @of_8_unicast_2_buff_0, %13 ]
...
20:                                               ; preds = %50, %52, %18
  %21 = phi ptr [ %53, %52 ], [ %51, %50 ], [ @of_7_unicast_2_0_cons_buff_0, %18 ]
...
27:                                               ; preds = %26, %23
  call void @op0_partial_softmax(ptr %22, ptr %17, ptr @flash_state_2_3, ptr @flash_index_2_3, bfloat 0xR3FB9, i32 64, i32 64, i32 512, i32 512)
...
29:                                               ; preds = %54, %56, %27
  %30 = phi ptr [ %57, %56 ], [ %55, %54 ], [ @flash_scale_2_3_2_4_buff_0, %27 ]
...
46:                                               ; preds = %13
  %47 = phi ptr [ @of_8_unicast_2_buff_0, %13 ]
  br label %15

48:                                               ; preds = %13
  %49 = phi ptr [ @of_8_unicast_2_buff_1, %13 ]
  br label %15

50:                                               ; preds = %18
  %51 = phi ptr [ @of_7_unicast_2_0_cons_buff_0, %18 ]
  br label %20

52:                                               ; preds = %18
  %53 = phi ptr [ @of_7_unicast_2_0_cons_buff_1, %18 ]
  br label %20

54:                                               ; preds = %27
  %55 = phi ptr [ @flash_scale_2_3_2_4_buff_0, %27 ]
  br label %29

56:                                               ; preds = %27
  %57 = phi ptr [ @flash_scale_2_3_2_4_buff_1, %27 ]
  br label %29
}
