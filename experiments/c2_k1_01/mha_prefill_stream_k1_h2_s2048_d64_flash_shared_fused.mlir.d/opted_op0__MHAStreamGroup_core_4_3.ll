; ModuleID = '/home/micas/iron-stream-dse/experiments/c2_k1_01/mha_prefill_stream_k1_h2_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_4_3.ll'
...
15:                                               ; preds = %6, %27
  ...
  %22 = select i1 %cond3, ptr @flash_scale_4_2_buff_1, ptr @flash_scale_4_2_buff_0
  %23 = icmp ne i32 %21, 0
  %24 = zext i1 %23 to i32
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %20, ptr nonnull %spec.select, ptr nonnull %22, i32 64, i32 %24, ptr nonnull @flash_index_4_3)
  %25 = icmp eq i32 %21, 31
  br i1 %25, label %26, label %27

26:                                               ; preds = %15
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %22, i32 64, ptr nonnull @flash_index_4_3)
  br label %27
