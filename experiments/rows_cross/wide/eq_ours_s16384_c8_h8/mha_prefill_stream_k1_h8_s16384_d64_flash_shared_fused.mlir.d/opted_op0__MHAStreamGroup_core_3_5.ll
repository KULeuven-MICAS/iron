; ModuleID = '/home/micas/iron-stream-dse/experiments/rows_cross/wide/eq_ours_s16384_c8_h8/mha_prefill_stream_k1_h8_s16384_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_3_5.ll'
...
22:                                               ; preds = %21, %13
  tail call void @op0_partial_softmax_mode(ptr nonnull %18, ptr nonnull %spec.select, ptr nonnull @flash_state_3_5, ptr nonnull @flash_index_3_5, bfloat 0xR3FB9, i32 64, i32 64, i32 16384, i32 16384, i32 2)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %cond2 = icmp eq i32 %14, 1
  %spec.select4 = select i1 %cond2, ptr @flash_scale_3_5_3_4_buff_1, ptr @flash_scale_3_5_3_4_buff_0
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_3_5, ptr nonnull %spec.select4, i32 256)
