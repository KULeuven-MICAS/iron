  ...
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<1024x64xbf16>, %arg1: memref<64x1024xbf16>, %arg2: memref<1024x64xbf16>, %arg3: memref<1024x64xbf16>) {
      ...
      %8 = aiex.dma_configure_task_for @of_1_mem {
        ...
        aie.end
      } {iteration_t = 0 : index, repeat_count = 1 : i32}
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c16 step %c1_1 {
            ...
            %c1024_i32 = arith.constant 1024 : i32
            %c1024_i32_10 = arith.constant 1024 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_4_3, %flash_index_4_3, %13, %c64_i32, %c64_i32_9, %c1024_i32, %c1024_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c16 step %c1_1 {
            ...
            %c1024_i32 = arith.constant 1024 : i32
            %c1024_i32_10 = arith.constant 1024 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_5_3, %flash_index_5_3, %13, %c64_i32, %c64_i32_9, %c1024_i32, %c1024_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c16 step %c1_1 {
            ...
            %c1024_i32 = arith.constant 1024 : i32
            %c1024_i32_10 = arith.constant 1024 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_6_3, %flash_index_6_3, %13, %c64_i32, %c64_i32_9, %c1024_i32, %c1024_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c16 step %c1_1 {
            ...
            %c1024_i32 = arith.constant 1024 : i32
            %c1024_i32_10 = arith.constant 1024 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_7_3, %flash_index_7_3, %13, %c64_i32, %c64_i32_9, %c1024_i32, %c1024_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
