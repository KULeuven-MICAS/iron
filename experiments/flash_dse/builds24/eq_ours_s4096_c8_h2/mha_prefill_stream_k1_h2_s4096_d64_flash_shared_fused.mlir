  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<1572864xbf16>, %arg1: memref<524288xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [262144] [1] : memref<1572864xbf16> to memref<262144xbf16>
        ...
        %subview_0 = memref.subview %arg0[524288] [262144] [1] : memref<1572864xbf16> to memref<262144xbf16, strided<[1], offset: 524288>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 4096], strides: [4096, 1] : memref<262144xbf16, strided<[1], offset: 524288>> to memref<64x4096xbf16>
        %subview_2 = memref.subview %arg0[1048576] [262144] [1] : memref<1572864xbf16> to memref<262144xbf16, strided<[1], offset: 1048576>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [4096, 64], strides: [64, 1] : memref<262144xbf16, strided<[1], offset: 1048576>> to memref<4096x64xbf16>
        %subview_4 = memref.subview %arg1[0] [262144] [1] : memref<524288xbf16> to memref<262144xbf16>
        ...
        %subview_6 = memref.subview %arg0[262144] [262144] [1] : memref<1572864xbf16> to memref<262144xbf16, strided<[1], offset: 262144>>
        ...
        %subview_8 = memref.subview %arg0[786432] [262144] [1] : memref<1572864xbf16> to memref<262144xbf16, strided<[1], offset: 786432>>
        %reinterpret_cast_9 = memref.reinterpret_cast %subview_8 to offset: [0], sizes: [64, 4096], strides: [4096, 1] : memref<262144xbf16, strided<[1], offset: 786432>> to memref<64x4096xbf16>
        %subview_10 = memref.subview %arg0[1310720] [262144] [1] : memref<1572864xbf16> to memref<262144xbf16, strided<[1], offset: 1310720>>
        %reinterpret_cast_11 = memref.reinterpret_cast %subview_10 to offset: [0], sizes: [4096, 64], strides: [64, 1] : memref<262144xbf16, strided<[1], offset: 1310720>> to memref<4096x64xbf16>
        %subview_12 = memref.subview %arg1[262144] [262144] [1] : memref<524288xbf16> to memref<262144xbf16, strided<[1], offset: 262144>>
