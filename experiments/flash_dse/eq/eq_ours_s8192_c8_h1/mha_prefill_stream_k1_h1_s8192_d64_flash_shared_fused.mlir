  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<1572864xbf16>, %arg1: memref<524288xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [524288] [1] : memref<1572864xbf16> to memref<524288xbf16>
        ...
        %subview_0 = memref.subview %arg0[524288] [524288] [1] : memref<1572864xbf16> to memref<524288xbf16, strided<[1], offset: 524288>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 8192], strides: [8192, 1] : memref<524288xbf16, strided<[1], offset: 524288>> to memref<64x8192xbf16>
        %subview_2 = memref.subview %arg0[1048576] [524288] [1] : memref<1572864xbf16> to memref<524288xbf16, strided<[1], offset: 1048576>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [8192, 64], strides: [64, 1] : memref<524288xbf16, strided<[1], offset: 1048576>> to memref<8192x64xbf16>
        %subview_4 = memref.subview %arg1[0] [524288] [1] : memref<524288xbf16> to memref<524288xbf16>
