  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<196608xbf16>, %arg1: memref<65536xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        ...
        %subview_2 = memref.subview %arg0[131072] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 131072>>
        ...
        %subview_4 = memref.subview %arg1[0] [16384] [1] : memref<65536xbf16> to memref<16384xbf16>
        ...
        %subview_6 = memref.subview %arg0[16384] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 16384>>
        ...
        %subview_8 = memref.subview %arg0[81920] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 81920>>
        %reinterpret_cast_9 = memref.reinterpret_cast %subview_8 to offset: [0], sizes: [64, 256], strides: [256, 1] : memref<16384xbf16, strided<[1], offset: 81920>> to memref<64x256xbf16>
        %subview_10 = memref.subview %arg0[147456] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 147456>>
        %reinterpret_cast_11 = memref.reinterpret_cast %subview_10 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 147456>> to memref<256x64xbf16>
        %subview_12 = memref.subview %arg1[16384] [16384] [1] : memref<65536xbf16> to memref<16384xbf16, strided<[1], offset: 16384>>
        ...
        %subview_14 = memref.subview %arg0[32768] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 32768>>
        ...
        %subview_16 = memref.subview %arg0[98304] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 98304>>
        %reinterpret_cast_17 = memref.reinterpret_cast %subview_16 to offset: [0], sizes: [64, 256], strides: [256, 1] : memref<16384xbf16, strided<[1], offset: 98304>> to memref<64x256xbf16>
        %subview_18 = memref.subview %arg0[163840] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 163840>>
        %reinterpret_cast_19 = memref.reinterpret_cast %subview_18 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 163840>> to memref<256x64xbf16>
        %subview_20 = memref.subview %arg1[32768] [16384] [1] : memref<65536xbf16> to memref<16384xbf16, strided<[1], offset: 32768>>
        ...
        %subview_22 = memref.subview %arg0[49152] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 49152>>
        ...
        %subview_24 = memref.subview %arg0[114688] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 114688>>
        %reinterpret_cast_25 = memref.reinterpret_cast %subview_24 to offset: [0], sizes: [64, 256], strides: [256, 1] : memref<16384xbf16, strided<[1], offset: 114688>> to memref<64x256xbf16>
        %subview_26 = memref.subview %arg0[180224] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 180224>>
        %reinterpret_cast_27 = memref.reinterpret_cast %subview_26 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 180224>> to memref<256x64xbf16>
        %subview_28 = memref.subview %arg1[49152] [16384] [1] : memref<65536xbf16> to memref<16384xbf16, strided<[1], offset: 49152>>
