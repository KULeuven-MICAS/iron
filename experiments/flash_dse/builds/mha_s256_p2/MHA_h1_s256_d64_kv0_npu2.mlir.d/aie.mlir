module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<1x256x64xbf16>, %arg1: memref<1x16384xbf16>, %arg2: memref<1x16384xbf16>, %arg3: memref<1x256x64xbf16>) {
      ...
      aiex.npu.rtp_write(@mha_rtpss_0_stage0, 3, %c256_i32_15) : i32
      %c2_i32_16 = arith.constant 2 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage0, 0, %c2_i32_16) : i32
      %c4_i32_17 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage0, 1, %c4_i32_17) : i32
      %c256_i32_18 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage0, 2, %c256_i32_18) : i32
      %c256_i32_19 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage0, 3, %c256_i32_19) : i32
      %c2_i32_20 = arith.constant 2 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 0, %c2_i32_20) : i32
      %c4_i32_21 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 1, %c4_i32_21) : i32
      %c256_i32_22 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 2, %c256_i32_22) : i32
      %c256_i32_23 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 3, %c256_i32_23) : i32
      %c2_i32_24 = arith.constant 2 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage1, 0, %c2_i32_24) : i32
      %c4_i32_25 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage1, 1, %c4_i32_25) : i32
      %c256_i32_26 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage1, 2, %c256_i32_26) : i32
      %c256_i32_27 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage1, 3, %c256_i32_27) : i32
      %c2_i32_28 = arith.constant 2 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 0, %c2_i32_28) : i32
      %c4_i32_29 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 1, %c4_i32_29) : i32
      %c256_i32_30 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 2, %c256_i32_30) : i32
      %c256_i32_31 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 3, %c256_i32_31) : i32
      %c2_i32_32 = arith.constant 2 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage2, 0, %c2_i32_32) : i32
      %c4_i32_33 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage2, 1, %c4_i32_33) : i32
      %c256_i32_34 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage2, 2, %c256_i32_34) : i32
      %c256_i32_35 = arith.constant 256 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage2, 3, %c256_i32_35) : i32
      ...
      %0 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x256x64xbf16> offset = 0 len = 8192 sizes = [1, 1, 128, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %3 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x256x64xbf16> offset = 0 len = 8192 sizes = [1, 1, 128, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %4 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x256x64xbf16> offset = 8192 len = 8192 sizes = [1, 1, 128, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %7 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x256x64xbf16> offset = 8192 len = 8192 sizes = [1, 1, 128, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
