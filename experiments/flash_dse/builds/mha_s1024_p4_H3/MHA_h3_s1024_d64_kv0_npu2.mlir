module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<3x1024x64xbf16>, %arg1: memref<3x65536xbf16>, %arg2: memref<3x65536xbf16>, %arg3: memref<3x1024x64xbf16>) {
      %c4_i32 = arith.constant 4 : i32
      ...
      %0 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 0 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @inK {
        aie.dma_bd(%arg1 : memref<3x65536xbf16> offset = 0 len = 65536 sizes = [1, 1, 1, 65536] strides = [0, 0, 0, 1])
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @inV {
        aie.dma_bd(%arg2 : memref<3x65536xbf16> offset = 0 len = 65536 sizes = [1, 1, 1, 65536] strides = [0, 0, 0, 1])
        aie.end
      }
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 0 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %4 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 16384 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %7 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 16384 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %8 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 32768 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %11 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 32768 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %12 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 49152 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %15 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 49152 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %16 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 65536 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%16)
      %17 = aiex.dma_configure_task_for @inK {
        aie.dma_bd(%arg1 : memref<3x65536xbf16> offset = 65536 len = 65536 sizes = [1, 1, 1, 65536] strides = [0, 0, 0, 1])
        aie.end
      }
      aiex.dma_start_task(%17)
      %18 = aiex.dma_configure_task_for @inV {
        aie.dma_bd(%arg2 : memref<3x65536xbf16> offset = 65536 len = 65536 sizes = [1, 1, 1, 65536] strides = [0, 0, 0, 1])
        aie.end
      }
      aiex.dma_start_task(%18)
      %19 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 65536 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %20 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 81920 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %23 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 81920 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %24 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 98304 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %27 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 98304 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %28 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 114688 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %31 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 114688 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %32 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 131072 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%32)
      %33 = aiex.dma_configure_task_for @inK {
        aie.dma_bd(%arg1 : memref<3x65536xbf16> offset = 131072 len = 65536 sizes = [1, 1, 1, 65536] strides = [0, 0, 0, 1])
        aie.end
      }
      aiex.dma_start_task(%33)
      %34 = aiex.dma_configure_task_for @inV {
        aie.dma_bd(%arg2 : memref<3x65536xbf16> offset = 131072 len = 65536 sizes = [1, 1, 1, 65536] strides = [0, 0, 0, 1])
        aie.end
      }
      aiex.dma_start_task(%34)
      %35 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 131072 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %36 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 147456 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %39 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 147456 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %40 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 163840 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %43 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 163840 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %44 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<3x1024x64xbf16> offset = 180224 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %47 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<3x1024x64xbf16> offset = 180224 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
