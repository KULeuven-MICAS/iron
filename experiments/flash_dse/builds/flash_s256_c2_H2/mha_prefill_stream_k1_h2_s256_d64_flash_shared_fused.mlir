module {
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<256x64xbf16>, %arg1: memref<64x256xbf16>, %arg2: memref<256x64xbf16>, %arg3: memref<256x64xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x64xbf16> offset = 0 len = 8192 sizes = [1, 2, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {iteration_t = 0 : index}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @of_0_mem_1 {
        aie.dma_bd(%arg0 : memref<256x64xbf16> offset = 4096 len = 8192 sizes = [1, 2, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {iteration_t = 0 : index}
      ...
      %4 = aiex.dma_configure_task_for @of_11_mem_0 {
        aie.dma_bd(%arg3 : memref<256x64xbf16> offset = 0 len = 8192 sizes = [1, 2, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @of_11_mem_1 {
        aie.dma_bd(%arg3 : memref<256x64xbf16> offset = 4096 len = 8192 sizes = [1, 2, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        %0 = aie.objectfifo.acquire @of_4_broadcast_0_0(Consume, 4) : !aie.objectfifosubview<memref<64x64xbf16>>
        ...
        %3 = aie.objectfifo.subview.access %0[2] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        %4 = aie.objectfifo.subview.access %0[3] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        %c0_0 = arith.constant 0 : index
        %c1_1 = arith.constant 1 : index
        %c2 = arith.constant 2 : index
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          %5 = aie.objectfifo.acquire @of_3_unicast_0_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
          ...
          scf.for %arg2 = %c0_0 to %c4 step %c1_1 {
            %7 = aie.objectfifo.acquire @of_6_unicast_0(Produce, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            ...
            %13 = scf.index_switch %c0_5 -> memref<64x64xbf16> 
            case 0 {
            ...
            %14 = scf.index_switch %c0_7 -> memref<64x64xbf16> 
            case 0 {
            ...
            %16 = arith.muli %15, %c1_i32 : i32
            %c0_i32 = arith.constant 0 : i32
            %17 = arith.addi %c0_i32, %16 : i32
            %18 = arith.index_cast %arg1 : index to i32
            %c2_i32 = arith.constant 2 : i32
            %19 = arith.muli %18, %c2_i32 : i32
            %c0_i32_8 = arith.constant 0 : i32
            %20 = arith.addi %c0_i32_8, %19 : i32
            %21 = arith.cmpi sle, %17, %20 : i32
            scf.if %21 {
              func.call @op0_matmul_bf16_bf16_64_64_64(%13, %12, %14) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
            }
            aie.objectfifo.release @of_6_unicast_0(Produce, 1)
          }
          aie.objectfifo.release @of_3_unicast_0_0(Consume, 1)
        }
        aie.objectfifo.release @of_4_broadcast_0_0(Consume, 4)
      }
      aie.end
    ...
    %core_1_2 = aie.core(%tile_1_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        %c2 = arith.constant 2 : index
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          %5 = aie.objectfifo.acquire @of_3_unicast_1_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
          %6 = aie.objectfifo.subview.access %5[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
          %c4 = arith.constant 4 : index
          scf.for %arg2 = %c0_0 to %c4 step %c1_1 {
            %7 = aie.objectfifo.acquire @of_6_unicast_1(Produce, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            %8 = aie.objectfifo.subview.access %7[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
            func.call @op0_zero_bf16_64_64_64(%8) : (memref<64x64xbf16>) -> ()
            %c1_2 = arith.constant 1 : index
            %c0_3 = arith.constant 0 : index
    ...
    %core_0_4 = aie.core(%tile_0_4) {
      ...
      %c4294967295 = arith.constant 4294967295 : index
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        %0 = aie.objectfifo.acquire @of_5_broadcast_0_0(Consume, 4) : !aie.objectfifosubview<memref<64x64xbf16>>
        %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        %2 = aie.objectfifo.subview.access %0[1] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        %3 = aie.objectfifo.subview.access %0[2] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        %4 = aie.objectfifo.subview.access %0[3] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
        ...
        %c2 = arith.constant 2 : index
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          %5 = aie.objectfifo.acquire @of_10_unicast_0(Produce, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
          %6 = aie.objectfifo.subview.access %5[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
          func.call @op0_zero_bf16(%6) : (memref<64x64xbf16>) -> ()
          %c4 = arith.constant 4 : index
          scf.for %arg2 = %c0_0 to %c4 step %c1_1 {
            %7 = aie.objectfifo.acquire @of_9_unicast_0_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            %8 = aie.objectfifo.subview.access %7[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
            %c1_2 = arith.constant 1 : index
            %c0_3 = arith.constant 0 : index
            %9 = arith.muli %c1_2, %arg2 : index
            ...
            memref.store %17, %flash_index_0_4[%c0_9] : memref<2xi32>
            memref.store %20, %flash_index_0_4[%c1_10] : memref<2xi32>
            %21 = aie.objectfifo.acquire @flash_scale_0_3(Consume, 1) : !aie.objectfifosubview<memref<256xbf16>>
            %22 = aie.objectfifo.subview.access %21[0] : !aie.objectfifosubview<memref<256xbf16>> -> memref<256xbf16>
            %c64_i32 = arith.constant 64 : i32
            %c0_i32_11 = arith.constant 0 : i32
            %23 = arith.cmpi ne, %17, %c0_i32_11 : i32
            %24 = arith.extui %23 : i1 to i32
            func.call @op0_matmul_PV(%13, %12, %14, %22, %c64_i32, %24, %flash_index_0_4) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, i32, i32, memref<2xi32>) -> ()
            %c3_i32 = arith.constant 3 : i32
            %25 = arith.cmpi eq, %17, %c3_i32 : i32
            scf.if %25 {
              func.call @op0_rescale_O(%14, %22, %c64_i32, %flash_index_0_4) : (memref<64x64xbf16>, memref<256xbf16>, i32, memref<2xi32>) -> ()
            }
        ...
        aie.objectfifo.release @of_5_broadcast_0_0(Consume, 4)
      }
      aie.end
    } {link_with = "op0_mha.o"}
    ...
    %core_1_4 = aie.core(%tile_1_4) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        %c2 = arith.constant 2 : index
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          %5 = aie.objectfifo.acquire @of_10_unicast_1(Produce, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
          %6 = aie.objectfifo.subview.access %5[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
          func.call @op0_zero_bf16(%6) : (memref<64x64xbf16>) -> ()
          %c4 = arith.constant 4 : index
          scf.for %arg2 = %c0_0 to %c4 step %c1_1 {
            %7 = aie.objectfifo.acquire @of_9_unicast_1_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            %8 = aie.objectfifo.subview.access %7[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
            %c1_2 = arith.constant 1 : index
            %c0_3 = arith.constant 0 : index
            %9 = arith.muli %c1_2, %arg2 : index
            ...
            %c0_9 = arith.constant 0 : index
            %c1_10 = arith.constant 1 : index
            memref.store %17, %flash_index_1_4[%c0_9] : memref<2xi32>
            memref.store %20, %flash_index_1_4[%c1_10] : memref<2xi32>
            %21 = aie.objectfifo.acquire @flash_scale_1_3(Consume, 1) : !aie.objectfifosubview<memref<256xbf16>>
            %22 = aie.objectfifo.subview.access %21[0] : !aie.objectfifosubview<memref<256xbf16>> -> memref<256xbf16>
            %c64_i32 = arith.constant 64 : i32
            %c0_i32_11 = arith.constant 0 : i32
            %23 = arith.cmpi ne, %17, %c0_i32_11 : i32
            %24 = arith.extui %23 : i1 to i32
            func.call @op0_matmul_PV(%13, %12, %14, %22, %c64_i32, %24, %flash_index_1_4) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, i32, i32, memref<2xi32>) -> ()
            %c3_i32 = arith.constant 3 : i32
            %25 = arith.cmpi eq, %17, %c3_i32 : i32
            scf.if %25 {
              func.call @op0_rescale_O(%14, %22, %c64_i32, %flash_index_1_4) : (memref<64x64xbf16>, memref<256xbf16>, i32, memref<2xi32>) -> ()
            }
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c4 step %c1_1 {
            ...
            func.call @op0_partial_softmax(%4, %5, %flash_state_0_3, %flash_index_0_3, %13, %c64_i32, %c64_i32_10, %c256_i32, %c256_i32_11) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
            ...
            func.call @op0_passThroughLine(%flash_state_0_3, %15, %c256_i32_12) : (memref<256xbf16>, memref<256xbf16>, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c4 step %c1_1 {
            ...
            %c256_i32 = arith.constant 256 : i32
            %c256_i32_11 = arith.constant 256 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_1_3, %flash_index_1_3, %13, %c64_i32, %c64_i32_10, %c256_i32, %c256_i32_11) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
            %14 = aie.objectfifo.acquire @flash_scale_1_3(Produce, 1) : !aie.objectfifosubview<memref<256xbf16>>
            %15 = aie.objectfifo.subview.access %14[0] : !aie.objectfifosubview<memref<256xbf16>> -> memref<256xbf16>
            %c256_i32_12 = arith.constant 256 : i32
            func.call @op0_passThroughLine(%flash_state_1_3, %15, %c256_i32_12) : (memref<256xbf16>, memref<256xbf16>, i32) -> ()
    ...
    aie.objectfifo @of_0_mem_0(%shim_noc_tile_6_0, {%mem_tile_6_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_0_mem_1(%shim_noc_tile_7_0, {%mem_tile_7_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_1_mem(%shim_noc_tile_2_0, {%mem_tile_2_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<4x64x64xbf16>>  
    aie.objectfifo @of_2_mem(%shim_noc_tile_1_0, {%mem_tile_1_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<4x64x64xbf16>>  
    aie.objectfifo @of_3_unicast_0_0(%mem_tile_6_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_2}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_0_mem_0] -> [@of_3_unicast_0_0]([] [0])
    aie.objectfifo @of_3_unicast_1_0(%mem_tile_7_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_1_2}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_0_mem_1] -> [@of_3_unicast_1_0]([] [0])
    aie.objectfifo @of_4_broadcast_0_0(%mem_tile_2_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_2, %tile_1_2}, [2 : i32, 4 : i32, 4 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_1_mem] -> [@of_4_broadcast_0_0]([] [0])
    aie.objectfifo @of_5_broadcast_0_0(%mem_tile_1_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_4, %tile_1_4}, [2 : i32, 4 : i32, 4 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    ...
    aie.objectfifo @of_8_unicast_0(%tile_0_3, {%mem_tile_3_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_unicast_1(%tile_1_3, {%mem_tile_5_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_0_0(%mem_tile_3_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_4}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_unicast_0] -> [@of_9_unicast_0_0]([] [0])
    aie.objectfifo @of_9_unicast_1_0(%mem_tile_5_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_1_4}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_unicast_1] -> [@of_9_unicast_1_0]([] [0])
    aie.objectfifo @of_10_unicast_0(%tile_0_4, {%mem_tile_6_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_10_unicast_1(%tile_1_4, {%mem_tile_7_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_11_mem_0(%mem_tile_6_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%shim_noc_tile_6_0}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<98304xbf16>, %arg1: memref<32768xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        ...
        %subview_2 = memref.subview %arg0[65536] [16384] [1] : memref<98304xbf16> to memref<16384xbf16, strided<[1], offset: 65536>>
        ...
        %subview_4 = memref.subview %arg1[0] [16384] [1] : memref<32768xbf16> to memref<16384xbf16>
        ...
        %subview_6 = memref.subview %arg0[16384] [16384] [1] : memref<98304xbf16> to memref<16384xbf16, strided<[1], offset: 16384>>
        ...
        %subview_8 = memref.subview %arg0[49152] [16384] [1] : memref<98304xbf16> to memref<16384xbf16, strided<[1], offset: 49152>>
        %reinterpret_cast_9 = memref.reinterpret_cast %subview_8 to offset: [0], sizes: [64, 256], strides: [256, 1] : memref<16384xbf16, strided<[1], offset: 49152>> to memref<64x256xbf16>
        %subview_10 = memref.subview %arg0[81920] [16384] [1] : memref<98304xbf16> to memref<16384xbf16, strided<[1], offset: 81920>>
        %reinterpret_cast_11 = memref.reinterpret_cast %subview_10 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 81920>> to memref<256x64xbf16>
        %subview_12 = memref.subview %arg1[16384] [16384] [1] : memref<32768xbf16> to memref<16384xbf16, strided<[1], offset: 16384>>
