module {
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<768x64xbf16>, %arg1: memref<64x768xbf16>, %arg2: memref<768x64xbf16>, %arg3: memref<768x64xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<768x64xbf16> offset = 0 len = 12288 sizes = [1, 3, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {iteration_t = 0 : index}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @of_0_mem_1 {
        aie.dma_bd(%arg0 : memref<768x64xbf16> offset = 4096 len = 12288 sizes = [1, 3, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {iteration_t = 0 : index}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @of_0_mem_2 {
        aie.dma_bd(%arg0 : memref<768x64xbf16> offset = 8192 len = 12288 sizes = [1, 3, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {iteration_t = 0 : index}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @of_0_mem_3 {
        aie.dma_bd(%arg0 : memref<768x64xbf16> offset = 12288 len = 12288 sizes = [1, 3, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {iteration_t = 0 : index}
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x768xbf16> offset = 0 len = 49152 sizes = [3, 12, 64, 64] strides = [0, 64, 768, 1])
        aie.end
      } {iteration_t = 0 : index, repeat_count = 2 : i32}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<768x64xbf16> offset = 0 len = 49152 sizes = [3, 1, 192, 256] strides = [0, 0, 256, 1])
        aie.end
      } {iteration_t = 0 : index, repeat_count = 2 : i32}
      aiex.dma_start_task(%5)
      %6 = aiex.dma_configure_task_for @of_11_mem_0 {
        aie.dma_bd(%arg3 : memref<768x64xbf16> offset = 0 len = 12288 sizes = [1, 3, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @of_11_mem_1 {
        aie.dma_bd(%arg3 : memref<768x64xbf16> offset = 4096 len = 12288 sizes = [1, 3, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%7)
      %8 = aiex.dma_configure_task_for @of_11_mem_2 {
        aie.dma_bd(%arg3 : memref<768x64xbf16> offset = 8192 len = 12288 sizes = [1, 3, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%8)
      %9 = aiex.dma_configure_task_for @of_11_mem_3 {
        aie.dma_bd(%arg3 : memref<768x64xbf16> offset = 12288 len = 12288 sizes = [1, 3, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c3 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c12 step %c1_1 {
            ...
            %19 = arith.cmpi eq, %11, %c11_i32 : i32
            scf.if %19 {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c3 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c12 step %c1_1 {
            ...
            func.call @op0_partial_softmax(%4, %5, %flash_state_0_3, %flash_index_0_3, %13, %c64_i32, %c64_i32_10, %c768_i32, %c768_i32_11) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c3 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c12 step %c1_1 {
            ...
            %c768_i32 = arith.constant 768 : i32
            %c768_i32_11 = arith.constant 768 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_1_3, %flash_index_1_3, %13, %c64_i32, %c64_i32_10, %c768_i32, %c768_i32_11) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c3 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c12 step %c1_1 {
            ...
            func.call @op0_partial_softmax(%4, %5, %flash_state_2_3, %flash_index_2_3, %13, %c64_i32, %c64_i32_9, %c768_i32, %c768_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c3 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c12 step %c1_1 {
            ...
            %c768_i32 = arith.constant 768 : i32
            %c768_i32_10 = arith.constant 768 : i32
            func.call @op0_partial_softmax(%4, %5, %flash_state_3_3, %flash_index_3_3, %13, %c64_i32, %c64_i32_9, %c768_i32, %c768_i32_10) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
    ...
    aie.objectfifo @of_8_unicast_3(%tile_3_3, {%mem_tile_4_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    ...
    aie.objectfifo @of_9_unicast_3_0(%mem_tile_4_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_3_4}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    ...
    aie.objectfifo @of_10_unicast_3(%tile_3_4, {%mem_tile_5_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    ...
    aie.objectfifo @of_11_mem_3(%mem_tile_5_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%shim_noc_tile_5_0}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<147456xbf16>, %arg1: memref<49152xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [49152] [1] : memref<147456xbf16> to memref<49152xbf16>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [768, 64], strides: [64, 1] : memref<49152xbf16> to memref<768x64xbf16>
        %subview_0 = memref.subview %arg0[49152] [49152] [1] : memref<147456xbf16> to memref<49152xbf16, strided<[1], offset: 49152>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 768], strides: [768, 1] : memref<49152xbf16, strided<[1], offset: 49152>> to memref<64x768xbf16>
        %subview_2 = memref.subview %arg0[98304] [49152] [1] : memref<147456xbf16> to memref<49152xbf16, strided<[1], offset: 98304>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [768, 64], strides: [64, 1] : memref<49152xbf16, strided<[1], offset: 98304>> to memref<768x64xbf16>
        %subview_4 = memref.subview %arg1[0] [49152] [1] : memref<49152xbf16> to memref<49152xbf16>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [768, 64], strides: [64, 1] : memref<49152xbf16> to memref<768x64xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5) : (memref<768x64xbf16>, memref<64x768xbf16>, memref<768x64xbf16>, memref<768x64xbf16>)
      }
