  ...
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<4096x64xbf16>, %arg1: memref<64x4096xbf16>, %arg2: memref<4096x64xbf16>, %arg3: memref<4096x64xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<4096x64xbf16> offset = 0 len = 131072 sizes = [1, 32, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {iteration_t = 0 : index}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @of_0_mem_1 {
        aie.dma_bd(%arg0 : memref<4096x64xbf16> offset = 4096 len = 131072 sizes = [1, 32, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {iteration_t = 0 : index}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x4096xbf16> offset = 0 len = 262144 sizes = [32, 64, 64, 64] strides = [0, 64, 4096, 1])
        aie.end
      } {iteration_t = 0 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<4096x64xbf16> offset = 0 len = 262144 sizes = [32, 1, 512, 512] strides = [0, 0, 512, 1])
        aie.end
      } {iteration_t = 0 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @of_11_mem_0 {
        aie.dma_bd(%arg3 : memref<4096x64xbf16> offset = 0 len = 131072 sizes = [1, 32, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @of_11_mem_1 {
        aie.dma_bd(%arg3 : memref<4096x64xbf16> offset = 4096 len = 131072 sizes = [1, 32, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
