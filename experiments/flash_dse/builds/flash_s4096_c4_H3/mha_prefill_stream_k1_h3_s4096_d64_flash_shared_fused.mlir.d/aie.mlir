  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<2359296xbf16>, %arg1: memref<786432xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [262144] [1] : memref<2359296xbf16> to memref<262144xbf16>
        ...
        %subview_0 = memref.subview %arg0[786432] [262144] [1] : memref<2359296xbf16> to memref<262144xbf16, strided<[1], offset: 786432>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 4096], strides: [4096, 1] : memref<262144xbf16, strided<[1], offset: 786432>> to memref<64x4096xbf16>
        %subview_2 = memref.subview %arg0[1572864] [262144] [1] : memref<2359296xbf16> to memref<262144xbf16, strided<[1], offset: 1572864>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [4096, 64], strides: [64, 1] : memref<262144xbf16, strided<[1], offset: 1572864>> to memref<4096x64xbf16>
        %subview_4 = memref.subview %arg1[0] [262144] [1] : memref<786432xbf16> to memref<262144xbf16>
        ...
        %subview_6 = memref.subview %arg0[262144] [262144] [1] : memref<2359296xbf16> to memref<262144xbf16, strided<[1], offset: 262144>>
        ...
        %subview_8 = memref.subview %arg0[1048576] [262144] [1] : memref<2359296xbf16> to memref<262144xbf16, strided<[1], offset: 1048576>>
        %reinterpret_cast_9 = memref.reinterpret_cast %subview_8 to offset: [0], sizes: [64, 4096], strides: [4096, 1] : memref<262144xbf16, strided<[1], offset: 1048576>> to memref<64x4096xbf16>
        %subview_10 = memref.subview %arg0[1835008] [262144] [1] : memref<2359296xbf16> to memref<262144xbf16, strided<[1], offset: 1835008>>
        %reinterpret_cast_11 = memref.reinterpret_cast %subview_10 to offset: [0], sizes: [4096, 64], strides: [64, 1] : memref<262144xbf16, strided<[1], offset: 1835008>> to memref<4096x64xbf16>
        %subview_12 = memref.subview %arg1[262144] [262144] [1] : memref<786432xbf16> to memref<262144xbf16, strided<[1], offset: 262144>>
        ...
        %subview_14 = memref.subview %arg0[524288] [262144] [1] : memref<2359296xbf16> to memref<262144xbf16, strided<[1], offset: 524288>>
        ...
        %subview_16 = memref.subview %arg0[1310720] [262144] [1] : memref<2359296xbf16> to memref<262144xbf16, strided<[1], offset: 1310720>>
        %reinterpret_cast_17 = memref.reinterpret_cast %subview_16 to offset: [0], sizes: [64, 4096], strides: [4096, 1] : memref<262144xbf16, strided<[1], offset: 1310720>> to memref<64x4096xbf16>
        %subview_18 = memref.subview %arg0[2097152] [262144] [1] : memref<2359296xbf16> to memref<262144xbf16, strided<[1], offset: 2097152>>
        %reinterpret_cast_19 = memref.reinterpret_cast %subview_18 to offset: [0], sizes: [4096, 64], strides: [64, 1] : memref<262144xbf16, strided<[1], offset: 2097152>> to memref<4096x64xbf16>
        %subview_20 = memref.subview %arg1[524288] [262144] [1] : memref<786432xbf16> to memref<262144xbf16, strided<[1], offset: 524288>>
