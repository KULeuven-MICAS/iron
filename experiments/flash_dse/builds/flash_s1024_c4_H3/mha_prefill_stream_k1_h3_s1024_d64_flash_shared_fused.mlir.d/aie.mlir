  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<589824xbf16>, %arg1: memref<196608xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [65536] [1] : memref<589824xbf16> to memref<65536xbf16>
        ...
        %subview_0 = memref.subview %arg0[196608] [65536] [1] : memref<589824xbf16> to memref<65536xbf16, strided<[1], offset: 196608>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 1024], strides: [1024, 1] : memref<65536xbf16, strided<[1], offset: 196608>> to memref<64x1024xbf16>
        %subview_2 = memref.subview %arg0[393216] [65536] [1] : memref<589824xbf16> to memref<65536xbf16, strided<[1], offset: 393216>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [1024, 64], strides: [64, 1] : memref<65536xbf16, strided<[1], offset: 393216>> to memref<1024x64xbf16>
        %subview_4 = memref.subview %arg1[0] [65536] [1] : memref<196608xbf16> to memref<65536xbf16>
        ...
        %subview_6 = memref.subview %arg0[65536] [65536] [1] : memref<589824xbf16> to memref<65536xbf16, strided<[1], offset: 65536>>
        ...
        %subview_8 = memref.subview %arg0[262144] [65536] [1] : memref<589824xbf16> to memref<65536xbf16, strided<[1], offset: 262144>>
        %reinterpret_cast_9 = memref.reinterpret_cast %subview_8 to offset: [0], sizes: [64, 1024], strides: [1024, 1] : memref<65536xbf16, strided<[1], offset: 262144>> to memref<64x1024xbf16>
        %subview_10 = memref.subview %arg0[458752] [65536] [1] : memref<589824xbf16> to memref<65536xbf16, strided<[1], offset: 458752>>
        %reinterpret_cast_11 = memref.reinterpret_cast %subview_10 to offset: [0], sizes: [1024, 64], strides: [64, 1] : memref<65536xbf16, strided<[1], offset: 458752>> to memref<1024x64xbf16>
        %subview_12 = memref.subview %arg1[65536] [65536] [1] : memref<196608xbf16> to memref<65536xbf16, strided<[1], offset: 65536>>
        ...
        %subview_14 = memref.subview %arg0[131072] [65536] [1] : memref<589824xbf16> to memref<65536xbf16, strided<[1], offset: 131072>>
        ...
        %subview_16 = memref.subview %arg0[327680] [65536] [1] : memref<589824xbf16> to memref<65536xbf16, strided<[1], offset: 327680>>
        %reinterpret_cast_17 = memref.reinterpret_cast %subview_16 to offset: [0], sizes: [64, 1024], strides: [1024, 1] : memref<65536xbf16, strided<[1], offset: 327680>> to memref<64x1024xbf16>
        %subview_18 = memref.subview %arg0[524288] [65536] [1] : memref<589824xbf16> to memref<65536xbf16, strided<[1], offset: 524288>>
        %reinterpret_cast_19 = memref.reinterpret_cast %subview_18 to offset: [0], sizes: [1024, 64], strides: [64, 1] : memref<65536xbf16, strided<[1], offset: 524288>> to memref<1024x64xbf16>
        %subview_20 = memref.subview %arg1[131072] [65536] [1] : memref<196608xbf16> to memref<65536xbf16, strided<[1], offset: 131072>>
