...
13:                                               ; preds = %32, %34, %11
  %14 = phi ptr [ %35, %34 ], [ %33, %32 ], [ @of_8_unicast_1_buff_0, %11 ]
...
18:                                               ; preds = %36, %38, %16
  %19 = phi ptr [ %39, %38 ], [ %37, %36 ], [ @of_7_unicast_1_0_cons_buff_0, %16 ]
  %20 = getelementptr [16 x [256 x bfloat]], ptr %19, i32 0, i32 0, i32 0
  br label %21

21:                                               ; preds = %18
  call void @op0_softmax_rows_bf16(ptr %20, ptr %15, i32 16, i32 256)
...
32:                                               ; preds = %11
  %33 = phi ptr [ @of_8_unicast_1_buff_0, %11 ]
  br label %13

34:                                               ; preds = %11
  %35 = phi ptr [ @of_8_unicast_1_buff_1, %11 ]
  br label %13

36:                                               ; preds = %16
  %37 = phi ptr [ @of_7_unicast_1_0_cons_buff_0, %16 ]
  br label %18

38:                                               ; preds = %16
  %39 = phi ptr [ @of_7_unicast_1_0_cons_buff_1, %16 ]
  br label %18
}
