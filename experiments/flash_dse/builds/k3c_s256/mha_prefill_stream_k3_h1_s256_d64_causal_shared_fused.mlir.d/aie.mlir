module {
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.objectfifo @of_3_broadcast_0_0(%mem_tile_6_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_2, %tile_0_3, %tile_0_4, %tile_0_5}, [2 : i32, 2 : i32, 2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<49152xbf16>, %arg1: memref<16384xbf16>, %arg2: memref<131072xbf16>) {
      ...
      aiex.configure @op2__MHAStreamGroup {
        ...
        %subview_0 = memref.subview %arg0[32768] [16384] [1] : memref<49152xbf16> to memref<16384xbf16, strided<[1], offset: 32768>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 32768>> to memref<256x64xbf16>
        %subview_2 = memref.subview %arg1[0] [16384] [1] : memref<16384xbf16> to memref<16384xbf16>
