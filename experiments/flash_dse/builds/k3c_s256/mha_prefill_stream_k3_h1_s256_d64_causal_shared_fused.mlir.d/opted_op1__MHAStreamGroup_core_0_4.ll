; ModuleID = '/home/micas/iron-stream-dse/experiments/flash_dse/builds/k3c_s256/mha_prefill_stream_k3_h1_s256_d64_causal_shared_fused.mlir.d/peano-linked_op1__MHAStreamGroup_core_0_4.ll'
...
4:                                                ; preds = %4, %.preheader
  ...
  %spec.select = select i1 %cond, ptr @of_2_join_0_2_buff_1, ptr @of_2_join_0_2_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1 = icmp eq i32 %5, 1
  %8 = select i1 %cond1, ptr @of_1_distribute_0_2_cons_buff_1, ptr @of_1_distribute_0_2_cons_buff_0
  ...
  %spec.select.1 = select i1 %cond.1, ptr @of_2_join_0_2_buff_1, ptr @of_2_join_0_2_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.1 = icmp eq i32 %14, 1
  %18 = select i1 %cond1.1, ptr @of_1_distribute_0_2_cons_buff_1, ptr @of_1_distribute_0_2_cons_buff_0
  ...
  %spec.select.2 = select i1 %cond.2, ptr @of_2_join_0_2_buff_1, ptr @of_2_join_0_2_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.2 = icmp eq i32 %24, 1
  %28 = select i1 %cond1.2, ptr @of_1_distribute_0_2_cons_buff_1, ptr @of_1_distribute_0_2_cons_buff_0
  ...
  %spec.select.3 = select i1 %cond.3, ptr @of_2_join_0_2_buff_1, ptr @of_2_join_0_2_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.3 = icmp eq i32 %34, 1
  %39 = select i1 %cond1.3, ptr @of_1_distribute_0_2_cons_buff_1, ptr @of_1_distribute_0_2_cons_buff_0
