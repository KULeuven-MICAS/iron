...
14:                                               ; preds = %33, %35, %12
  %15 = phi ptr [ %36, %35 ], [ %34, %33 ], [ @of_6_unicast_3_buff_0, %12 ]
  %16 = getelementptr [16 x [256 x bfloat]], ptr %15, i32 0, i32 0, i32 0
  br label %17

17:                                               ; preds = %14
  call void @op0_zero_bf16_16_64_256(ptr %16)
...
19:                                               ; preds = %37, %39, %17
  %20 = phi ptr [ %40, %39 ], [ %38, %37 ], [ @of_3_unicast_3_0_cons_buff_0, %17 ]
  %21 = getelementptr [16 x [64 x bfloat]], ptr %20, i32 0, i32 0, i32 0
  br label %22

22:                                               ; preds = %19
  call void @op0_matmul_bf16_bf16_16_64_256(ptr %21, ptr @of_4_broadcast_0_0_3_cons_buff_0, ptr %16)
...
33:                                               ; preds = %12
  %34 = phi ptr [ @of_6_unicast_3_buff_0, %12 ]
  br label %14

35:                                               ; preds = %12
  %36 = phi ptr [ @of_6_unicast_3_buff_1, %12 ]
  br label %14

37:                                               ; preds = %17
  %38 = phi ptr [ @of_3_unicast_3_0_cons_buff_0, %17 ]
  br label %19

39:                                               ; preds = %17
  %40 = phi ptr [ @of_3_unicast_3_0_cons_buff_1, %17 ]
  br label %19
}
