; ModuleID = '/home/micas/iron-stream-dse/experiments/flash_dse/builds/k1c_s256_c8/mha_prefill_stream_k1_h1_s256_d64_causal_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_2_3.ll'
...
.preheader:                                       ; preds = %.preheader, %0
  ...
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  tail call void @op0_softmax_rows_causal_bf16(ptr nonnull @of_7_unicast_2_0_cons_buff_1, ptr nonnull @of_8_unicast_2_buff_1, i32 16, i32 256, i32 160)
  tail call void @llvm.aie2p.release(i32 50, i32 1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
