...
@idx_buffer_pv_0 = global [2 x i32] zeroinitializer
...
@memK_cons_buff_1 = external global [64 x [64 x bfloat]]
@memK_cons_buff_0 = external global [64 x [64 x bfloat]]
@inQ_cons_buff_1 = external global [64 x [64 x bfloat]]
@inQ_cons_buff_0 = external global [64 x [64 x bfloat]]
...
@memV_cons_buff_1 = external global [64 x [64 x bfloat]]
@memV_cons_buff_0 = external global [64 x [64 x bfloat]]
...
@outO0_cons_buff_1 = external global [64 x [64 x bfloat]]
@outO0_cons_buff_0 = external global [64 x [64 x bfloat]]
...
define void @core_0_4() {
  ...
  %1 = load i32, ptr @mha_rtpss_0_stage2
  %2 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_0_stage2, i64 4)
  %3 = sext i32 %1 to i64
  %4 = icmp sgt i32 %2, 2
  %5 = icmp sgt i32 %2, 1
  br label %6
...
13:                                               ; preds = %6
  store i32 0, ptr @idx_buffer_pv_0
  store i32 0, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_pv_0, i64 4)
  br label %14
...
23:                                               ; preds = %137, %139, %21
  %24 = phi ptr [ %140, %139 ], [ %138, %137 ], [ @outO0_buff_0, %21 ]
...
28:                                               ; preds = %141, %143, %26
  %29 = phi ptr [ %144, %143 ], [ %142, %141 ], [ @outP0_cons_buff_0, %26 ]
...
33:                                               ; preds = %145, %147, %31
  %34 = phi ptr [ %148, %147 ], [ %146, %145 ], [ @memV_cons_buff_0, %31 ]
...
38:                                               ; preds = %149, %151, %36
  %39 = phi ptr [ %152, %151 ], [ %150, %149 ], [ @scaleOF0_buff_0, %36 ]
  %40 = getelementptr [256 x bfloat], ptr %39, i32 0, i32 0
  br label %41

41:                                               ; preds = %38
  call void @matmul_PV(ptr %30, ptr %35, ptr %25, ptr %40, i32 64, i32 0, ptr @idx_buffer_pv_0)
  ...
  %51 = load i32, ptr @idx_buffer_pv_0
  %52 = add i32 %51, 1
  store i32 %52, ptr @idx_buffer_pv_0
...
64:                                               ; preds = %153, %155, %62
  %65 = phi ptr [ %156, %155 ], [ %154, %153 ], [ @outP0_cons_buff_0, %62 ]
...
69:                                               ; preds = %157, %159, %67
  %70 = phi ptr [ %160, %159 ], [ %158, %157 ], [ @memV_cons_buff_0, %67 ]
...
74:                                               ; preds = %161, %163, %72
  %75 = phi ptr [ %164, %163 ], [ %162, %161 ], [ @scaleOF0_buff_0, %72 ]
  %76 = getelementptr [256 x bfloat], ptr %75, i32 0, i32 0
  br label %77

77:                                               ; preds = %74
  call void @matmul_PV(ptr %66, ptr %71, ptr %25, ptr %76, i32 64, i32 1, ptr @idx_buffer_pv_0)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %78 = add i32 %58, 1
  ...
  %87 = load i32, ptr @idx_buffer_pv_0
  %88 = add i32 %87, 1
  store i32 %88, ptr @idx_buffer_pv_0
  %89 = add i64 %57, 1
  br label %56
...
96:                                               ; preds = %165, %167, %94
  %97 = phi ptr [ %168, %167 ], [ %166, %165 ], [ @outP0_cons_buff_0, %94 ]
...
101:                                              ; preds = %169, %171, %99
  %102 = phi ptr [ %172, %171 ], [ %170, %169 ], [ @memV_cons_buff_0, %99 ]
...
106:                                              ; preds = %173, %175, %104
  %107 = phi ptr [ %176, %175 ], [ %174, %173 ], [ @scaleOF0_buff_0, %104 ]
  %108 = getelementptr [256 x bfloat], ptr %107, i32 0, i32 0
  br label %109

109:                                              ; preds = %106
  call void @matmul_PV(ptr %98, ptr %103, ptr %25, ptr %108, i32 64, i32 1, ptr @idx_buffer_pv_0)
  call void @rescale_O(ptr %25, ptr %108, i32 64, ptr @idx_buffer_pv_0)
  call void @llvm.aie2p.release(i32 48, i32 1)
  %110 = add i32 %91, 1
  ...
  %119 = load i32, ptr @idx_buffer_pv_0
  %120 = add i32 %119, 1
  store i32 %120, ptr @idx_buffer_pv_0
  br label %124

121:                                              ; preds = %90
  call void @rescale_O(ptr %25, ptr %40, i32 64, ptr @idx_buffer_pv_0)
  %122 = load i32, ptr @idx_buffer_pv_0
  %123 = add i32 %122, 1
  store i32 %123, ptr @idx_buffer_pv_0
  br label %124
...
124:                                              ; preds = %109, %121
  ...
  store i32 0, ptr @idx_buffer_pv_0
  %128 = load i32, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_pv_0, i64 4)
  %129 = add i32 %128, 1
  store i32 %129, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_pv_0, i64 4)
...
137:                                              ; preds = %21
  %138 = phi ptr [ @outO0_buff_0, %21 ]
  br label %23

139:                                              ; preds = %21
  %140 = phi ptr [ @outO0_buff_1, %21 ]
  br label %23

141:                                              ; preds = %26
  %142 = phi ptr [ @outP0_cons_buff_0, %26 ]
  br label %28

143:                                              ; preds = %26
  %144 = phi ptr [ @outP0_cons_buff_1, %26 ]
  br label %28

145:                                              ; preds = %31
  %146 = phi ptr [ @memV_cons_buff_0, %31 ]
  br label %33

147:                                              ; preds = %31
  %148 = phi ptr [ @memV_cons_buff_1, %31 ]
  br label %33

149:                                              ; preds = %36
  %150 = phi ptr [ @scaleOF0_buff_0, %36 ]
  br label %38

151:                                              ; preds = %36
  %152 = phi ptr [ @scaleOF0_buff_1, %36 ]
  br label %38

153:                                              ; preds = %62
  %154 = phi ptr [ @outP0_cons_buff_0, %62 ]
  br label %64

155:                                              ; preds = %62
  %156 = phi ptr [ @outP0_cons_buff_1, %62 ]
  br label %64

157:                                              ; preds = %67
  %158 = phi ptr [ @memV_cons_buff_0, %67 ]
  br label %69

159:                                              ; preds = %67
  %160 = phi ptr [ @memV_cons_buff_1, %67 ]
  br label %69

161:                                              ; preds = %72
  %162 = phi ptr [ @scaleOF0_buff_0, %72 ]
  br label %74

163:                                              ; preds = %72
  %164 = phi ptr [ @scaleOF0_buff_1, %72 ]
  br label %74

165:                                              ; preds = %94
  %166 = phi ptr [ @outP0_cons_buff_0, %94 ]
  br label %96

167:                                              ; preds = %94
  %168 = phi ptr [ @outP0_cons_buff_1, %94 ]
  br label %96

169:                                              ; preds = %99
  %170 = phi ptr [ @memV_cons_buff_0, %99 ]
  br label %101

171:                                              ; preds = %99
  %172 = phi ptr [ @memV_cons_buff_1, %99 ]
  br label %101

173:                                              ; preds = %104
  %174 = phi ptr [ @scaleOF0_buff_0, %104 ]
  br label %106

175:                                              ; preds = %104
  %176 = phi ptr [ @scaleOF0_buff_1, %104 ]
  br label %106
}
