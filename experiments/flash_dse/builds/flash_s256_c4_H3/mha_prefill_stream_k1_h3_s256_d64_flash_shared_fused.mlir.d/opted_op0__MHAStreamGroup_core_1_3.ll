; ModuleID = '/home/micas/iron-stream-dse/experiments/flash_dse/builds/flash_s256_c4_H3/mha_prefill_stream_k1_h3_s256_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_3.ll'
...
5:                                                ; preds = %.preheader, %14
  ...
  %10 = select i1 %cond1, ptr @of_7_unicast_1_0_cons_buff_1, ptr @of_7_unicast_1_0_cons_buff_0
...
14:                                               ; preds = %13, %5
  tail call void @op0_partial_softmax(ptr nonnull %10, ptr nonnull %spec.select, ptr nonnull @flash_state_1_3, ptr nonnull @flash_index_1_3, bfloat 0xR3FB9, i32 64, i32 64, i32 256, i32 256)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %cond2 = icmp eq i32 %6, 1
  %spec.select3 = select i1 %cond2, ptr @flash_scale_1_3_buff_1, ptr @flash_scale_1_3_buff_0
