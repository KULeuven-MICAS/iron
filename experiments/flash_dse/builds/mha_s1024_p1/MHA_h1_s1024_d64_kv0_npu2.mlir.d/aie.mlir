module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<1x1024x64xbf16>, %arg1: memref<1x65536xbf16>, %arg2: memref<1x65536xbf16>, %arg3: memref<1x1024x64xbf16>) {
      ...
      aiex.npu.rtp_write(@mha_rtpss_0_stage0, 1, %c16_i32_10) : i32
      %c1024_i32 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage0, 2, %c1024_i32) : i32
      %c1024_i32_11 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage0, 3, %c1024_i32_11) : i32
      %c16_i32_12 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 0, %c16_i32_12) : i32
      %c16_i32_13 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 1, %c16_i32_13) : i32
      %c1024_i32_14 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 2, %c1024_i32_14) : i32
      %c1024_i32_15 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 3, %c1024_i32_15) : i32
      %c16_i32_16 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 0, %c16_i32_16) : i32
      %c16_i32_17 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 1, %c16_i32_17) : i32
      %c1024_i32_18 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 2, %c1024_i32_18) : i32
      %c1024_i32_19 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 3, %c1024_i32_19) : i32
      aiex.set_lock(%lock_0_2, 1)
      aiex.set_lock(%lock_0_3, 1)
      aiex.set_lock(%lock_0_4, 1)
      %0 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 0 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %3 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 0 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %4 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 4096 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %7 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 4096 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %8 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 8192 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %11 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 8192 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %12 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 12288 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %15 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 12288 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %16 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 16384 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %19 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 16384 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %20 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 20480 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %23 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 20480 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %24 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 24576 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %27 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 24576 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %28 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 28672 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %31 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 28672 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %32 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 32768 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %35 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 32768 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %36 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 36864 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %39 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 36864 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %40 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 40960 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %43 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 40960 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %44 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 45056 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %47 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 45056 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %48 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 49152 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %51 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 49152 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %52 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 53248 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %55 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 53248 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %56 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 57344 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %59 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 57344 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      ...
      %60 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x1024x64xbf16> offset = 61440 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      ...
      %63 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x1024x64xbf16> offset = 61440 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
