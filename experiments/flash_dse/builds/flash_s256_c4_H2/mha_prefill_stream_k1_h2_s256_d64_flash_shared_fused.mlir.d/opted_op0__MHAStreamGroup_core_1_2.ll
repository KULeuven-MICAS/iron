; ModuleID = '/home/micas/iron-stream-dse/experiments/flash_dse/builds/flash_s256_c4_H2/mha_prefill_stream_k1_h2_s256_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_2.ll'
...
5:                                                ; preds = %1, %12
  ...
  %spec.select = select i1 %cond, ptr @of_6_unicast_1_buff_1, ptr @of_6_unicast_1_buff_0
...
10:                                               ; preds = %5
  ...
  %11 = select i1 %cond1, ptr @of_4_broadcast_0_0_1_cons_buff_1, ptr @of_4_broadcast_0_0_1_cons_buff_0
  tail call void @op0_matmul_bf16_bf16_64_64_64(ptr nonnull @of_3_unicast_1_0_cons_buff_0, ptr nonnull %11, ptr nonnull %spec.select)
  br label %12
