module {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<196608xbf16>, %arg1: memref<65536xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [65536] [1] : memref<196608xbf16> to memref<65536xbf16>
        ...
        %subview_0 = memref.subview %arg0[65536] [65536] [1] : memref<196608xbf16> to memref<65536xbf16, strided<[1], offset: 65536>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 1024], strides: [1024, 1] : memref<65536xbf16, strided<[1], offset: 65536>> to memref<64x1024xbf16>
        %subview_2 = memref.subview %arg0[131072] [65536] [1] : memref<196608xbf16> to memref<65536xbf16, strided<[1], offset: 131072>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [1024, 64], strides: [64, 1] : memref<65536xbf16, strided<[1], offset: 131072>> to memref<1024x64xbf16>
        %subview_4 = memref.subview %arg1[0] [65536] [1] : memref<65536xbf16> to memref<65536xbf16>
