...
63:                                               ; preds = %129, %131, %61
  %64 = phi ptr [ %132, %131 ], [ %130, %129 ], [ @flash_scale_1_3_1_4_buff_0, %61 ]
...
79:                                               ; preds = %133, %135, %77
  %80 = phi ptr [ %136, %135 ], [ %134, %133 ], [ @flash_scale_1_5_1_4_buff_0, %77 ]
...
129:                                              ; preds = %61
  %130 = phi ptr [ @flash_scale_1_3_1_4_buff_0, %61 ]
  br label %63

131:                                              ; preds = %61
  %132 = phi ptr [ @flash_scale_1_3_1_4_buff_1, %61 ]
  br label %63

133:                                              ; preds = %77
  %134 = phi ptr [ @flash_scale_1_5_1_4_buff_0, %77 ]
  br label %79

135:                                              ; preds = %77
  %136 = phi ptr [ @flash_scale_1_5_1_4_buff_1, %77 ]
  br label %79
}
