...
15:                                               ; preds = %46, %48, %13
  %16 = phi ptr [ %49, %48 ], [ %47, %46 ], [ @of_8_switch_join_4_0_buff_0, %13 ]
...
20:                                               ; preds = %50, %52, %18
  %21 = phi ptr [ %53, %52 ], [ %51, %50 ], [ @of_7_distribute_4_0_cons_buff_0, %18 ]
  %22 = getelementptr [64 x [64 x bfloat]], ptr %21, i32 0, i32 0, i32 0
  br label %23

23:                                               ; preds = %20
  %24 = trunc i64 %8 to i32
  store i32 %24, ptr @flash_index_4_3
  store i32 4, ptr getelementptr inbounds nuw (i8, ptr @flash_index_4_3, i64 4)
  %25 = icmp eq i32 %24, 0
...
27:                                               ; preds = %26, %23
  call void @op0_partial_softmax_mode(ptr %22, ptr %17, ptr @flash_state_4_3, ptr @flash_index_4_3, bfloat 0xR3FB9, i32 64, i32 64, i32 1024, i32 1024, i32 2)
...
29:                                               ; preds = %54, %56, %27
  %30 = phi ptr [ %57, %56 ], [ %55, %54 ], [ @flash_scale_4_3_buff_0, %27 ]
  %31 = getelementptr [256 x bfloat], ptr %30, i32 0, i32 0
  br label %32

32:                                               ; preds = %29
  call void @op0_passThroughLine(ptr @flash_state_4_3, ptr %31, i32 256)
...
46:                                               ; preds = %13
  %47 = phi ptr [ @of_8_switch_join_4_0_buff_0, %13 ]
  br label %15

48:                                               ; preds = %13
  %49 = phi ptr [ @of_8_switch_join_4_0_buff_1, %13 ]
  br label %15

50:                                               ; preds = %18
  %51 = phi ptr [ @of_7_distribute_4_0_cons_buff_0, %18 ]
  br label %20

52:                                               ; preds = %18
  %53 = phi ptr [ @of_7_distribute_4_0_cons_buff_1, %18 ]
  br label %20

54:                                               ; preds = %27
  %55 = phi ptr [ @flash_scale_4_3_buff_0, %27 ]
  br label %29

56:                                               ; preds = %27
  %57 = phi ptr [ @flash_scale_4_3_buff_1, %27 ]
  br label %29
}
