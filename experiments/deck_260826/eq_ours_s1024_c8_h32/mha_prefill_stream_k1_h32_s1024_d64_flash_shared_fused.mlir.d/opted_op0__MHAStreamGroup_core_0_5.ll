; ModuleID = '/home/micas/iron-stream-dse/experiments/deck_260826/eq_ours_s1024_c8_h32/mha_prefill_stream_k1_h32_s1024_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_5.ll'
...
5:                                                ; preds = %.preheader, %14
  ...
  %10 = select i1 %cond1, ptr @of_7_distribute_0_1_cons_buff_1, ptr @of_7_distribute_0_1_cons_buff_0
  %11 = trunc nuw nsw i64 %9 to i32
  store i32 %11, ptr @flash_index_0_5, align 4
  store i32 8, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_5, i20 4), align 4
  %12 = icmp eq i32 %11, 0
...
14:                                               ; preds = %13, %5
  tail call void @op0_partial_softmax_mode(ptr nonnull %10, ptr nonnull %spec.select, ptr nonnull @flash_state_0_5, ptr nonnull @flash_index_0_5, bfloat 0xR3FB9, i32 64, i32 64, i32 1024, i32 1024, i32 2)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %cond2 = icmp eq i32 %6, 1
  %spec.select3 = select i1 %cond2, ptr @flash_scale_0_5_buff_1, ptr @flash_scale_0_5_buff_0
