...
1:                                                ; preds = %108, %0
  %2 = phi i64 [ %109, %108 ], [ 0, %0 ]
  %3 = phi i32 [ %12, %108 ], [ 0, %0 ]
  %4 = phi i32 [ %13, %108 ], [ 0, %0 ]
  %5 = phi i32 [ %14, %108 ], [ 0, %0 ]
  %6 = phi i32 [ %15, %108 ], [ 0, %0 ]
  %7 = phi i32 [ %16, %108 ], [ 0, %0 ]
...
10:                                               ; preds = %97, %9
  %11 = phi i64 [ %107, %97 ], [ 0, %9 ]
  %12 = phi i32 [ %106, %97 ], [ %3, %9 ]
  %13 = phi i32 [ %100, %97 ], [ %4, %9 ]
  %14 = phi i32 [ %103, %97 ], [ %5, %9 ]
  %15 = phi i32 [ %49, %97 ], [ %6, %9 ]
  %16 = phi i32 [ %50, %97 ], [ %7, %9 ]
...
20:                                               ; preds = %111, %113, %18
  %21 = phi ptr [ %114, %113 ], [ %112, %111 ], [ @of_5_broadcast_0_0_3_cons_buff_0, %18 ]
...
25:                                               ; preds = %115, %117, %23
  %26 = phi ptr [ %118, %117 ], [ %116, %115 ], [ @of_8_switch_join_3_0_buff_0, %23 ]
  %27 = getelementptr [64 x [64 x bfloat]], ptr %26, i32 0, i32 0, i32 0
  %28 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } { ptr inttoptr (i64 3735928559 to ptr), ptr poison, i64 poison, [2 x i64] poison, [2 x i64] poison }, ptr %27, 1
  %29 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %28, i64 0, 2
  %30 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %29, i64 64, 3, 0
  %31 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %30, i64 64, 3, 1
  %32 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %31, i64 64, 4, 0
...
36:                                               ; preds = %119, %121, %34
  %37 = phi ptr [ %122, %121 ], [ %120, %119 ], [ @of_8_switch_join_3_1_buff_0, %34 ]
  %38 = getelementptr [64 x [64 x bfloat]], ptr %37, i32 0, i32 0, i32 0
  %39 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } { ptr inttoptr (i64 3735928559 to ptr), ptr poison, i64 poison, [2 x i64] poison, [2 x i64] poison }, ptr %38, 1
  %40 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %39, i64 0, 2
  %41 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %40, i64 64, 3, 0
  %42 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %41, i64 64, 3, 1
  %43 = insertvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %42, i64 64, 4, 0
...
47:                                               ; preds = %93, %45
  %48 = phi i64 [ %96, %93 ], [ 0, %45 ]
  %49 = phi i32 [ %94, %93 ], [ %15, %45 ]
  %50 = phi i32 [ %95, %93 ], [ %16, %45 ]
  %51 = icmp slt i64 %48, 2
...
53:                                               ; preds = %123, %125, %52
  %54 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %126, %125 ], [ %124, %123 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_3_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %52 ]
  br label %55
...
56:                                               ; preds = %127, %55
  %57 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %128, %127 ], [ %33, %55 ]
  %58 = trunc i64 %48 to i32
  %59 = mul i32 %58, 8
  %60 = add i32 %59, 3
  store i32 %46, ptr @flash_index_3_4
  store i32 %60, ptr getelementptr inbounds nuw (i8, ptr @flash_index_3_4, i64 4)
...
63:                                               ; preds = %129, %131, %61
  %64 = phi ptr [ %132, %131 ], [ %130, %129 ], [ @flash_scale_3_3_buff_0, %61 ]
  %65 = getelementptr [256 x bfloat], ptr %64, i32 0, i32 0
  br label %66

66:                                               ; preds = %63
  %67 = icmp ne i32 %46, 0
  %68 = zext i1 %67 to i32
  %69 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %57, 1
  %70 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %54, 1
  call void @op0_matmul_PV(ptr %69, ptr %22, ptr %70, ptr %65, i32 64, i32 %68, ptr @flash_index_3_4)
  %71 = icmp eq i32 %46, 15
  br i1 %71, label %72, label %73

72:                                               ; preds = %66
  call void @op0_rescale_O(ptr %70, ptr %65, i32 64, ptr @flash_index_3_4)
  br label %73
...
79:                                               ; preds = %133, %135, %77
  %80 = phi ptr [ %136, %135 ], [ %134, %133 ], [ @flash_scale_3_5_buff_0, %77 ]
  %81 = getelementptr [256 x bfloat], ptr %80, i32 0, i32 0
  br label %82

82:                                               ; preds = %79
  %83 = icmp ne i32 %46, 0
  %84 = zext i1 %83 to i32
  %85 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %57, 1
  %86 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %54, 1
  call void @op0_matmul_PV(ptr %85, ptr %22, ptr %86, ptr %81, i32 64, i32 %84, ptr @flash_index_3_4)
  %87 = icmp eq i32 %46, 15
  br i1 %87, label %88, label %89

88:                                               ; preds = %82
  call void @op0_rescale_O(ptr %86, ptr %81, i32 64, ptr @flash_index_3_4)
  br label %89
...
93:                                               ; preds = %73, %89
  %94 = phi i32 [ %49, %89 ], [ %76, %73 ]
  %95 = phi i32 [ %92, %89 ], [ %50, %73 ]
  %96 = add i64 %48, 1
  br label %47
...
111:                                              ; preds = %18
  %112 = phi ptr [ @of_5_broadcast_0_0_3_cons_buff_0, %18 ]
  br label %20

113:                                              ; preds = %18
  %114 = phi ptr [ @of_5_broadcast_0_0_3_cons_buff_1, %18 ]
  br label %20

115:                                              ; preds = %23
  %116 = phi ptr [ @of_8_switch_join_3_0_buff_0, %23 ]
  br label %25

117:                                              ; preds = %23
  %118 = phi ptr [ @of_8_switch_join_3_0_buff_1, %23 ]
  br label %25

119:                                              ; preds = %34
  %120 = phi ptr [ @of_8_switch_join_3_1_buff_0, %34 ]
  br label %36

121:                                              ; preds = %34
  %122 = phi ptr [ @of_8_switch_join_3_1_buff_1, %34 ]
  br label %36

123:                                              ; preds = %52
  %124 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_3_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %52 ]
  br label %53

125:                                              ; preds = %52
  %126 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_3_buff_1, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %52 ]
  br label %53

127:                                              ; preds = %55
  %128 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %44, %55 ]
  br label %56

129:                                              ; preds = %61
  %130 = phi ptr [ @flash_scale_3_3_buff_0, %61 ]
  br label %63

131:                                              ; preds = %61
  %132 = phi ptr [ @flash_scale_3_3_buff_1, %61 ]
  br label %63

133:                                              ; preds = %77
  %134 = phi ptr [ @flash_scale_3_5_buff_0, %77 ]
  br label %79

135:                                              ; preds = %77
  %136 = phi ptr [ @flash_scale_3_5_buff_1, %77 ]
  br label %79
}
