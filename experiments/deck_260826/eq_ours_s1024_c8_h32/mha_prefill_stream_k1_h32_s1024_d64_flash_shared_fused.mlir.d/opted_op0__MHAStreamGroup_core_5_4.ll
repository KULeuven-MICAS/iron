; ModuleID = '/home/micas/iron-stream-dse/experiments/deck_260826/eq_ours_s1024_c8_h32/mha_prefill_stream_k1_h32_s1024_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_5_4.ll'
...
8:                                                ; preds = %1, %48
  ...
  %15 = select i1 %cond3, ptr @of_8_switch_join_5_0_buff_1, ptr @of_8_switch_join_5_0_buff_0
  %cond4 = icmp eq i32 %11, 1
  %16 = select i1 %cond4, ptr @of_8_switch_join_5_1_buff_1, ptr @of_8_switch_join_5_1_buff_0
...
24:                                               ; preds = %8, %43
  ...
  store i32 %17, ptr @flash_index_5_4, align 4
  store i32 %30, ptr getelementptr inbounds nuw (i8, ptr @flash_index_5_4, i20 4), align 4
  br i1 %cond5, label %37, label %31

31:                                               ; preds = %24
  tail call void @llvm.aie2p.acquire(i32 5, i32 -1)
  %cond6 = icmp eq i32 %26, 1
  %spec.select22 = select i1 %cond6, ptr @flash_scale_5_3_buff_1, ptr @flash_scale_5_3_buff_0
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select22, i32 64, i32 %19, ptr nonnull @flash_index_5_4)
...
37:                                               ; preds = %24
  ...
  %spec.select23 = select i1 %cond7, ptr @flash_scale_5_5_buff_1, ptr @flash_scale_5_5_buff_0
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select23, i32 64, i32 %22, ptr nonnull @flash_index_5_4)
