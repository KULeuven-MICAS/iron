...
12:                                               ; preds = %44, %46, %10
  %13 = phi ptr [ %47, %46 ], [ %45, %44 ], [ @of_4_broadcast_0_0_7_cons_buff_0, %10 ]
...
21:                                               ; preds = %48, %50, %20
  %22 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %51, %50 ], [ %49, %48 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_7_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %20 ]
  br label %23
...
24:                                               ; preds = %52, %54, %23
  %25 = phi ptr [ %55, %54 ], [ %53, %52 ], [ @of_3_unicast_7_0_cons_buff_0, %23 ]
...
44:                                               ; preds = %10
  %45 = phi ptr [ @of_4_broadcast_0_0_7_cons_buff_0, %10 ]
  br label %12

46:                                               ; preds = %10
  %47 = phi ptr [ @of_4_broadcast_0_0_7_cons_buff_1, %10 ]
  br label %12

48:                                               ; preds = %20
  %49 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_7_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %20 ]
  br label %21

50:                                               ; preds = %20
  %51 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_7_relay_1_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %20 ]
  br label %21

52:                                               ; preds = %23
  %53 = phi ptr [ @of_3_unicast_7_0_cons_buff_0, %23 ]
  br label %24

54:                                               ; preds = %23
  %55 = phi ptr [ @of_3_unicast_7_0_cons_buff_1, %23 ]
  br label %24
}
