...
20:                                               ; preds = %111, %113, %18
  %21 = phi ptr [ %114, %113 ], [ %112, %111 ], [ @of_5_broadcast_0_0_7_cons_buff_0, %18 ]
...
25:                                               ; preds = %115, %117, %23
  %26 = phi ptr [ %118, %117 ], [ %116, %115 ], [ @of_8_switch_join_7_0_buff_0, %23 ]
...
36:                                               ; preds = %119, %121, %34
  %37 = phi ptr [ %122, %121 ], [ %120, %119 ], [ @of_8_switch_join_7_1_buff_0, %34 ]
...
53:                                               ; preds = %123, %125, %52
  %54 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %126, %125 ], [ %124, %123 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_7_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %52 ]
  br label %55
...
56:                                               ; preds = %127, %55
  ...
  %59 = mul i32 %58, 8
  %60 = add i32 %59, 7
  store i32 %46, ptr @flash_index_7_4
  store i32 %60, ptr getelementptr inbounds nuw (i8, ptr @flash_index_7_4, i64 4)
...
63:                                               ; preds = %129, %131, %61
  %64 = phi ptr [ %132, %131 ], [ %130, %129 ], [ @flash_scale_7_3_buff_0, %61 ]
...
66:                                               ; preds = %63
  ...
  call void @op0_matmul_PV(ptr %69, ptr %22, ptr %70, ptr %65, i32 64, i32 %68, ptr @flash_index_7_4)
  %71 = icmp eq i32 %46, 15
  br i1 %71, label %72, label %73

72:                                               ; preds = %66
  call void @op0_rescale_O(ptr %70, ptr %65, i32 64, ptr @flash_index_7_4)
  br label %73
...
79:                                               ; preds = %133, %135, %77
  %80 = phi ptr [ %136, %135 ], [ %134, %133 ], [ @flash_scale_7_5_buff_0, %77 ]
...
82:                                               ; preds = %79
  ...
  call void @op0_matmul_PV(ptr %85, ptr %22, ptr %86, ptr %81, i32 64, i32 %84, ptr @flash_index_7_4)
  %87 = icmp eq i32 %46, 15
  br i1 %87, label %88, label %89

88:                                               ; preds = %82
  call void @op0_rescale_O(ptr %86, ptr %81, i32 64, ptr @flash_index_7_4)
  br label %89
...
111:                                              ; preds = %18
  %112 = phi ptr [ @of_5_broadcast_0_0_7_cons_buff_0, %18 ]
  br label %20

113:                                              ; preds = %18
  %114 = phi ptr [ @of_5_broadcast_0_0_7_cons_buff_1, %18 ]
  br label %20

115:                                              ; preds = %23
  %116 = phi ptr [ @of_8_switch_join_7_0_buff_0, %23 ]
  br label %25

117:                                              ; preds = %23
  %118 = phi ptr [ @of_8_switch_join_7_0_buff_1, %23 ]
  br label %25

119:                                              ; preds = %34
  %120 = phi ptr [ @of_8_switch_join_7_1_buff_0, %34 ]
  br label %36

121:                                              ; preds = %34
  %122 = phi ptr [ @of_8_switch_join_7_1_buff_1, %34 ]
  br label %36

123:                                              ; preds = %52
  %124 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_7_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %52 ]
  br label %53

125:                                              ; preds = %52
  %126 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_7_buff_1, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %52 ]
  br label %53
...
129:                                              ; preds = %61
  %130 = phi ptr [ @flash_scale_7_3_buff_0, %61 ]
  br label %63

131:                                              ; preds = %61
  %132 = phi ptr [ @flash_scale_7_3_buff_1, %61 ]
  br label %63

133:                                              ; preds = %77
  %134 = phi ptr [ @flash_scale_7_5_buff_0, %77 ]
  br label %79

135:                                              ; preds = %77
  %136 = phi ptr [ @flash_scale_7_5_buff_1, %77 ]
  br label %79
}
