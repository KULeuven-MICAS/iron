; ModuleID = '/home/micas/iron-stream-dse/experiments/deck_260826/eq_ours_s1024_c8_h32/mha_prefill_stream_k1_h32_s1024_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_4.ll'
...
8:                                                ; preds = %1, %48
  ...
  %15 = select i1 %cond3, ptr @of_8_switch_join_1_0_buff_1, ptr @of_8_switch_join_1_0_buff_0
  %cond4 = icmp eq i32 %11, 1
  %16 = select i1 %cond4, ptr @of_8_switch_join_1_1_buff_1, ptr @of_8_switch_join_1_1_buff_0
...
24:                                               ; preds = %8, %43
  ...
  store i32 %17, ptr @flash_index_1_4, align 4
  store i32 %30, ptr getelementptr inbounds nuw (i8, ptr @flash_index_1_4, i20 4), align 4
...
31:                                               ; preds = %24
  ...
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select22, i32 64, i32 %19, ptr nonnull @flash_index_1_4)
...
37:                                               ; preds = %24
  ...
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select23, i32 64, i32 %22, ptr nonnull @flash_index_1_4)
