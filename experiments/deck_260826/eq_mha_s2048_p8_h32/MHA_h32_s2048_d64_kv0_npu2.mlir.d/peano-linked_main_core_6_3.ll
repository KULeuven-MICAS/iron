...
define void @core_6_3() {
  ...
  %1 = load i32, ptr @mha_rtpss_6_stage1
  %2 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_6_stage1, i64 4)
  %3 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_6_stage1, i64 8)
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_6_stage1, i64 12)
  %5 = sext i32 %1 to i64
  %6 = sext i32 %2 to i64
  br label %7
...
13:                                               ; preds = %7
  store i32 0, ptr @idx_buffer_softmax_6
  store i32 6, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_softmax_6, i64 4)
  br label %14
...
20:                                               ; preds = %14
  call void @init_scale_buffer(ptr @scale_buffer_softmax_6, i32 64)
  br label %21
...
29:                                               ; preds = %62, %64, %27
  %30 = phi ptr [ %65, %64 ], [ %63, %62 ], [ @memP6_buff_0, %27 ]
...
34:                                               ; preds = %66, %68, %32
  %35 = phi ptr [ %69, %68 ], [ %67, %66 ], [ @outA6_cons_buff_0, %32 ]
...
39:                                               ; preds = %70, %72, %37
  %40 = phi ptr [ %73, %72 ], [ %71, %70 ], [ @scaleOF6_buff_0, %37 ]
  %41 = getelementptr [256 x bfloat], ptr %40, i32 0, i32 0
  br label %42

42:                                               ; preds = %39
  call void @partial_softmax(ptr %36, ptr %31, ptr @scale_buffer_softmax_6, ptr @idx_buffer_softmax_6, bfloat 0xR3E39, i32 64, i32 64, i32 %3, i32 %4)
  call void @passThroughLine(ptr @scale_buffer_softmax_6, ptr %41, i32 256)
  ...
  %52 = load i32, ptr @idx_buffer_softmax_6
  %53 = add i32 %52, 1
  store i32 %53, ptr @idx_buffer_softmax_6
  %54 = add i64 %22, 1
  br label %21

55:                                               ; preds = %21
  store i32 0, ptr @idx_buffer_softmax_6
  %56 = load i32, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_softmax_6, i64 4)
  %57 = add i32 %56, 8
  store i32 %57, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_softmax_6, i64 4)
  %58 = add i64 %15, 1
  br label %14
...
62:                                               ; preds = %27
  %63 = phi ptr [ @memP6_buff_0, %27 ]
  br label %29

64:                                               ; preds = %27
  %65 = phi ptr [ @memP6_buff_1, %27 ]
  br label %29

66:                                               ; preds = %32
  %67 = phi ptr [ @outA6_cons_buff_0, %32 ]
  br label %34

68:                                               ; preds = %32
  %69 = phi ptr [ @outA6_cons_buff_1, %32 ]
  br label %34

70:                                               ; preds = %37
  %71 = phi ptr [ @scaleOF6_buff_0, %37 ]
  br label %39

72:                                               ; preds = %37
  %73 = phi ptr [ @scaleOF6_buff_1, %37 ]
  br label %39
}
