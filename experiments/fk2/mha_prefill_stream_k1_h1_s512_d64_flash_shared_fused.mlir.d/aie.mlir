  ...
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<512x64xbf16>, %arg1: memref<64x512xbf16>, %arg2: memref<512x64xbf16>, %arg3: memref<512x64xbf16>) {
      ...
      %2 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 0 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<512x64xbf16> offset = 0 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @of_10_mem_0 {
        aie.dma_bd(%arg3 : memref<512x64xbf16> offset = 0 len = 16384 sizes = [1, 4, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @of_10_mem_1 {
        aie.dma_bd(%arg3 : memref<512x64xbf16> offset = 4096 len = 16384 sizes = [1, 4, 64, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%5)
      %6 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 64 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 4 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<512x64xbf16> offset = 4096 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 4 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%7)
      aiex.dma_await_task(%2)
      %8 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 128 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 8 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%8)
      aiex.dma_await_task(%3)
      %9 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<512x64xbf16> offset = 8192 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 8 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%9)
      aiex.dma_await_task(%6)
      %10 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 192 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 12 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%10)
      aiex.dma_await_task(%7)
      %11 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<512x64xbf16> offset = 12288 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 12 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%11)
      aiex.dma_await_task(%8)
      %12 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 256 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 16 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%12)
      aiex.dma_await_task(%9)
      %13 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<512x64xbf16> offset = 16384 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 16 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%13)
      aiex.dma_await_task(%10)
      %14 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 320 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 20 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%14)
      aiex.dma_await_task(%11)
      %15 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<512x64xbf16> offset = 20480 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 20 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%15)
      aiex.dma_await_task(%12)
      %16 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 384 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 24 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%16)
      aiex.dma_await_task(%13)
      %17 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<512x64xbf16> offset = 24576 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 24 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%17)
      aiex.dma_await_task(%14)
      %18 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 448 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 28 : index, repeat_count = 1 : i32}
      aiex.dma_start_task(%18)
      aiex.dma_await_task(%15)
      %19 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<512x64xbf16> offset = 28672 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 28 : index, repeat_count = 1 : i32}
      ...
      %22 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 64 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 36 : index, repeat_count = 1 : i32}
      ...
      %24 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 128 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 40 : index, repeat_count = 1 : i32}
      ...
      %26 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 192 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 44 : index, repeat_count = 1 : i32}
      ...
      %30 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 320 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 52 : index, repeat_count = 1 : i32}
      ...
      %32 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 384 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 56 : index, repeat_count = 1 : i32}
      ...
      %34 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x512xbf16> offset = 448 len = 4096 sizes = [2, 1, 64, 64] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 60 : index, repeat_count = 1 : i32}
          ...
          scf.for %arg2 = %c0_0 to %c8 step %c1_1 {
            ...
            scf.for %arg3 = %c0_0 to %c2_2 step %c1_1 {
              ...
              case 0 {
                ...
                %27 = arith.cmpi eq, %16, %c7_i32 : i32
                scf.if %27 {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c8 step %c1_1 {
            ...
            func.call @op0_partial_softmax_tiled(%3, %1, %flash_state_0_2, %flash_index_0_2, %11, %c64_i32, %c64_i32_6, %c512_i32, %c512_i32_7) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c8 step %c1_1 {
            ...
            %c512_i32 = arith.constant 512 : i32
            %c512_i32_7 = arith.constant 512 : i32
            func.call @op0_partial_softmax_tiled(%3, %1, %flash_state_1_2, %flash_index_1_2, %11, %c64_i32, %c64_i32_6, %c512_i32, %c512_i32_7) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c8 step %c1_1 {
            ...
            func.call @op0_partial_softmax_tiled(%3, %1, %flash_state_0_4, %flash_index_0_4, %11, %c64_i32, %c64_i32_5, %c512_i32, %c512_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c8 step %c1_1 {
            ...
            %c512_i32 = arith.constant 512 : i32
            %c512_i32_6 = arith.constant 512 : i32
            func.call @op0_partial_softmax_tiled(%3, %1, %flash_state_1_4, %flash_index_1_4, %11, %c64_i32, %c64_i32_5, %c512_i32, %c512_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
    ...
    aie.objectfifo @of_0_mem_0(%shim_noc_tile_4_0, {%mem_tile_4_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<2x64x64xbf16>>  
    aie.objectfifo @of_0_mem_1(%shim_noc_tile_7_0, {%mem_tile_7_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<2x64x64xbf16>>  
    ...
    aie.objectfifo @of_3_unicast_0_0(%mem_tile_4_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_5}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_0_mem_0] -> [@of_3_unicast_0_0]([] [])
    aie.objectfifo @of_3_unicast_1_0(%mem_tile_7_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_1_5}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_0_mem_1] -> [@of_3_unicast_1_0]([] [])
    aie.objectfifo @of_4_broadcast_0_0(%mem_tile_1_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_5, %tile_1_5}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_1_mem] -> [@of_4_broadcast_0_0]([] [])
    aie.objectfifo @of_5_broadcast_0_0(%mem_tile_2_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_3, %tile_1_3}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_2_mem] -> [@of_5_broadcast_0_0]([] [])
    aie.objectfifo @of_6_unicast_0(%tile_0_5, {%mem_tile_3_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_6_unicast_1(%tile_1_5, {%mem_tile_5_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_7_distribute_0_0(%mem_tile_3_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_2}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_7_distribute_0_1(%mem_tile_3_1, {%tile_0_4}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_6_unicast_0] -> [@of_7_distribute_0_0, @of_7_distribute_0_1]([] [0, 2048])
    aie.objectfifo @of_7_distribute_1_0(%mem_tile_5_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_1_2}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_7_distribute_1_1(%mem_tile_5_1, {%tile_1_4}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    ...
    aie.objectfifo @of_9_unicast_0(%tile_0_3, {%mem_tile_1_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_1(%tile_1_3, {%mem_tile_6_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    ...
    aie.objectfifo @of_10_mem_1(%mem_tile_6_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%shim_noc_tile_6_0}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<2x64x64xbf16>>  
