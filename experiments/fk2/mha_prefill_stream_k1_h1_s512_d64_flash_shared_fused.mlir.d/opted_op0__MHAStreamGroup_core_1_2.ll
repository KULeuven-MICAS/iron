; ModuleID = '/home/micas/iron-stream-dse/experiments/fk2/mha_prefill_stream_k1_h1_s512_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_2.ll'
...
13:                                               ; preds = %5, %22
  ...
  store i32 %19, ptr @flash_index_1_2, align 4
  store i32 %12, ptr getelementptr inbounds nuw (i8, ptr @flash_index_1_2, i20 4), align 4
  %20 = icmp eq i32 %19, 0
...
22:                                               ; preds = %21, %13
  tail call void @op0_partial_softmax_tiled(ptr nonnull %18, ptr nonnull %spec.select, ptr nonnull @flash_state_1_2, ptr nonnull @flash_index_1_2, bfloat 0xR3FB9, i32 64, i32 64, i32 512, i32 512)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %cond2 = icmp eq i32 %14, 1
  %spec.select4 = select i1 %cond2, ptr @flash_scale_1_2_buff_1, ptr @flash_scale_1_2_buff_0
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_1_2, ptr nonnull %spec.select4, i32 256)
