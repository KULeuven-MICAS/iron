...
33:                                               ; preds = %145, %147, %31
  %34 = phi ptr [ %148, %147 ], [ %146, %145 ], [ @memV_0_cons_buff_0, %31 ]
...
69:                                               ; preds = %157, %159, %67
  %70 = phi ptr [ %160, %159 ], [ %158, %157 ], [ @memV_0_cons_buff_0, %67 ]
...
101:                                              ; preds = %169, %171, %99
  %102 = phi ptr [ %172, %171 ], [ %170, %169 ], [ @memV_0_cons_buff_0, %99 ]
...
145:                                              ; preds = %31
  %146 = phi ptr [ @memV_0_cons_buff_0, %31 ]
  br label %33

147:                                              ; preds = %31
  %148 = phi ptr [ @memV_0_cons_buff_1, %31 ]
  br label %33
...
157:                                              ; preds = %67
  %158 = phi ptr [ @memV_0_cons_buff_0, %67 ]
  br label %69

159:                                              ; preds = %67
  %160 = phi ptr [ @memV_0_cons_buff_1, %67 ]
  br label %69
...
169:                                              ; preds = %99
  %170 = phi ptr [ @memV_0_cons_buff_0, %99 ]
  br label %101

171:                                              ; preds = %99
  %172 = phi ptr [ @memV_0_cons_buff_1, %99 ]
  br label %101
