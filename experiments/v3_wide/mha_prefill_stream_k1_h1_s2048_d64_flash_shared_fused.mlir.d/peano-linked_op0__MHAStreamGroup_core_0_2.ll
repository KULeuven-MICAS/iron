...
32:                                               ; preds = %29
  ...
  store i32 %33, ptr @flash_index_0_2
  store i32 %15, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_2, i64 4)
  %34 = icmp eq i32 %33, 0
...
36:                                               ; preds = %35, %32
  call void @op0_partial_softmax_tiled(ptr %31, ptr %26, ptr @flash_state_0_2, ptr @flash_index_0_2, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048)
...
38:                                               ; preds = %65, %67, %36
  %39 = phi ptr [ %68, %67 ], [ %66, %65 ], [ @flash_scale_0_2_buff_0, %36 ]
  %40 = getelementptr [256 x bfloat], ptr %39, i32 0, i32 0
  br label %41

41:                                               ; preds = %38
  call void @op0_passThroughLine(ptr @flash_state_0_2, ptr %40, i32 256)
...
65:                                               ; preds = %36
  %66 = phi ptr [ @flash_scale_0_2_buff_0, %36 ]
  br label %38

67:                                               ; preds = %36
  %68 = phi ptr [ @flash_scale_0_2_buff_1, %36 ]
  br label %38
}
