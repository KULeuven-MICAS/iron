...
33:                                               ; preds = %126, %128, %31
  %34 = phi ptr [ %129, %128 ], [ %127, %126 ], [ @of_8_switch_join_6_0_buff_0, %31 ]
...
44:                                               ; preds = %130, %132, %42
  %45 = phi ptr [ %133, %132 ], [ %131, %130 ], [ @of_8_switch_join_6_1_buff_0, %42 ]
...
61:                                               ; preds = %134, %136, %60
  %62 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %137, %136 ], [ %135, %134 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_6_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %60 ]
  br label %63
...
126:                                              ; preds = %31
  %127 = phi ptr [ @of_8_switch_join_6_0_buff_0, %31 ]
  br label %33

128:                                              ; preds = %31
  %129 = phi ptr [ @of_8_switch_join_6_0_buff_1, %31 ]
  br label %33

130:                                              ; preds = %42
  %131 = phi ptr [ @of_8_switch_join_6_1_buff_0, %42 ]
  br label %44

132:                                              ; preds = %42
  %133 = phi ptr [ @of_8_switch_join_6_1_buff_1, %42 ]
  br label %44

134:                                              ; preds = %60
  %135 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_6_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %60 ]
  br label %61

136:                                              ; preds = %60
  %137 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_6_buff_1, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %60 ]
  br label %61
