; ModuleID = '/home/micas/iron-stream-dse/experiments/v3_wide/mha_prefill_stream_k1_h1_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_2.ll'
...
12:                                               ; preds = %5, %21
  ...
  store i32 %18, ptr @flash_index_0_2, align 4
  store i32 %11, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_2, i20 4), align 4
  %19 = icmp eq i32 %18, 0
...
21:                                               ; preds = %20, %12
  tail call void @op0_partial_softmax_tiled(ptr nonnull %17, ptr nonnull %spec.select, ptr nonnull @flash_state_0_2, ptr nonnull @flash_index_0_2, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %cond2 = icmp eq i32 %13, 1
  %spec.select4 = select i1 %cond2, ptr @flash_scale_0_2_buff_1, ptr @flash_scale_0_2_buff_0
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_0_2, ptr nonnull %spec.select4, i32 256)
  ...
  %32 = icmp samesign ult i64 %16, 31
