...
17:                                               ; preds = %70, %72, %15
  %18 = phi ptr [ %73, %72 ], [ %71, %70 ], [ @of_10_unicast_2_buff_0, %15 ]
...
32:                                               ; preds = %74, %76, %30
  %33 = phi ptr [ %77, %76 ], [ %75, %74 ], [ @of_9_unicast_2_0_cons_buff_0, %30 ]
...
43:                                               ; preds = %82, %84, %86, %88, %90, %92, %94, %96, %40
  %44 = phi ptr [ %97, %96 ], [ %95, %94 ], [ %93, %92 ], [ %91, %90 ], [ %89, %88 ], [ %87, %86 ], [ %85, %84 ], [ %83, %82 ], [ @flash_scale_2_3_buff_0, %40 ]
...
46:                                               ; preds = %43
  ...
  call void @op0_matmul_PV(ptr %34, ptr %39, ptr %19, ptr %45, i32 64, i32 %48, ptr @flash_index_2_4)
  %49 = icmp eq i32 %41, 31
  br i1 %49, label %50, label %51

50:                                               ; preds = %46
  call void @op0_rescale_O(ptr %19, ptr %45, i32 64, ptr @flash_index_2_4)
  br label %51
...
70:                                               ; preds = %15
  %71 = phi ptr [ @of_10_unicast_2_buff_0, %15 ]
  br label %17

72:                                               ; preds = %15
  %73 = phi ptr [ @of_10_unicast_2_buff_1, %15 ]
  br label %17

74:                                               ; preds = %30
  %75 = phi ptr [ @of_9_unicast_2_0_cons_buff_0, %30 ]
  br label %32

76:                                               ; preds = %30
  %77 = phi ptr [ @of_9_unicast_2_0_cons_buff_1, %30 ]
  br label %32
...
86:                                               ; preds = %40
  %87 = phi ptr [ @flash_scale_2_3_buff_2, %40 ]
  br label %43

88:                                               ; preds = %40
  %89 = phi ptr [ @flash_scale_2_3_buff_3, %40 ]
  br label %43

90:                                               ; preds = %40
  %91 = phi ptr [ @flash_scale_2_3_buff_4, %40 ]
  br label %43

92:                                               ; preds = %40
  %93 = phi ptr [ @flash_scale_2_3_buff_5, %40 ]
  br label %43

94:                                               ; preds = %40
  %95 = phi ptr [ @flash_scale_2_3_buff_6, %40 ]
  br label %43

96:                                               ; preds = %40
  %97 = phi ptr [ @flash_scale_2_3_buff_7, %40 ]
  br label %43
}
