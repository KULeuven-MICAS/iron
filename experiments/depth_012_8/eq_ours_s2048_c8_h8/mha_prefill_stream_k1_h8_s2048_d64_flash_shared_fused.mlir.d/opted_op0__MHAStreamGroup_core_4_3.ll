; ModuleID = '/home/micas/iron-stream-dse/experiments/depth_012_8/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_4_3.ll'
...
13:                                               ; preds = %5, %25
  ...
  %spec.select = select i1 %cond, ptr @of_8_unicast_4_buff_1, ptr @of_8_unicast_4_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1 = icmp eq i32 %15, 1
  %18 = select i1 %cond1, ptr @of_7_unicast_4_0_cons_buff_1, ptr @of_7_unicast_4_0_cons_buff_0
...
22:                                               ; preds = %21, %13
  tail call void @op0_partial_softmax(ptr nonnull %18, ptr nonnull %spec.select, ptr nonnull @flash_state_4_3, ptr nonnull @flash_index_4_3, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048)
