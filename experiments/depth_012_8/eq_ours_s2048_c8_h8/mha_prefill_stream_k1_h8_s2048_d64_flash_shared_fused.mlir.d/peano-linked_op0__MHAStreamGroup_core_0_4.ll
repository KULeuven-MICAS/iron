...
42:                                               ; preds = %81, %83, %85, %87, %89, %91, %93, %95, %39
  %43 = phi ptr [ %96, %95 ], [ %94, %93 ], [ %92, %91 ], [ %90, %89 ], [ %88, %87 ], [ %86, %85 ], [ %84, %83 ], [ %82, %81 ], [ @flash_scale_0_3_buff_0, %39 ]
...
85:                                               ; preds = %39
  %86 = phi ptr [ @flash_scale_0_3_buff_2, %39 ]
  br label %42

87:                                               ; preds = %39
  %88 = phi ptr [ @flash_scale_0_3_buff_3, %39 ]
  br label %42

89:                                               ; preds = %39
  %90 = phi ptr [ @flash_scale_0_3_buff_4, %39 ]
  br label %42

91:                                               ; preds = %39
  %92 = phi ptr [ @flash_scale_0_3_buff_5, %39 ]
  br label %42

93:                                               ; preds = %39
  %94 = phi ptr [ @flash_scale_0_3_buff_6, %39 ]
  br label %42

95:                                               ; preds = %39
  %96 = phi ptr [ @flash_scale_0_3_buff_7, %39 ]
  br label %42
}
