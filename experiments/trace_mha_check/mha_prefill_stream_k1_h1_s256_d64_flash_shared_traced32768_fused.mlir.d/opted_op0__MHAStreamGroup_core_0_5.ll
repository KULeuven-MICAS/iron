; ModuleID = '/home/micas/iron-stream-dse/experiments/trace_mha_check/mha_prefill_stream_k1_h1_s256_d64_flash_shared_traced32768_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_5.ll'
...
5:                                                ; preds = %.preheader, %14
  ...
  store i32 2, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_5, i20 4), align 4
  %12 = icmp eq i32 %11, 0
...
14:                                               ; preds = %13, %5
  tail call void @op0_partial_softmax_mode(ptr nonnull %10, ptr nonnull %spec.select, ptr nonnull @flash_state_0_5, ptr nonnull @flash_index_0_5, bfloat 0xR3FB9, i32 64, i32 64, i32 256, i32 256, i32 2)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %cond2 = icmp eq i32 %6, 1
  %spec.select3 = select i1 %cond2, ptr @flash_scale_0_5_0_4_buff_1, ptr @flash_scale_0_5_0_4_buff_0
