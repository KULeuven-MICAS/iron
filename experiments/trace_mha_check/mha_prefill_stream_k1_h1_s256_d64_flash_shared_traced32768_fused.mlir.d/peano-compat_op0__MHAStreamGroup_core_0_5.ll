...
23:                                               ; preds = %20
  ...
  store i32 2, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_5, i64 4)
  %25 = icmp eq i32 %24, 0
...
27:                                               ; preds = %26, %23
  call void @op0_partial_softmax_mode(ptr %22, ptr %17, ptr @flash_state_0_5, ptr @flash_index_0_5, bfloat 0xR3FB9, i32 64, i32 64, i32 256, i32 256, i32 2)
