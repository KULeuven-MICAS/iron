module {
  aie.device(npu2) @op0__MHAStreamGroup {
        ...
        scf.for %arg1 = %c0_0 to %c4 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c2 step %c1_1 {
            ...
            case 0 {
              ...
              %24 = arith.cmpi eq, %16, %c3_i32 : i32
              scf.if %24 {
    ...
    %core_0_3 = aie.core(%tile_0_3) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4 step %c1_1 {
          ...
          %c2_i32 = arith.constant 2 : i32
          func.call @op0_partial_softmax_mode(%3, %1, %flash_state_0_3, %flash_index_0_3, %8, %c64_i32, %c64_i32_6, %c256_i32, %c256_i32_7, %c2_i32) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32, i32) -> ()
          ...
          func.call @op0_passThroughLine(%flash_state_0_3, %10, %c256_i32_8) : (memref<256xbf16>, memref<256xbf16>, i32) -> ()
    ...
    %core_1_3 = aie.core(%tile_1_3) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4 step %c1_1 {
          ...
          %c256_i32_7 = arith.constant 256 : i32
          %c2_i32 = arith.constant 2 : i32
          func.call @op0_partial_softmax_mode(%3, %1, %flash_state_1_3, %flash_index_1_3, %8, %c64_i32, %c64_i32_6, %c256_i32, %c256_i32_7, %c2_i32) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32, i32) -> ()
          %c256_i32_8 = arith.constant 256 : i32
          %9 = aie.objectfifo.acquire @flash_scale_1_3_1_4(Produce, 1) : !aie.objectfifosubview<memref<256xbf16>>
          %10 = aie.objectfifo.subview.access %9[0] : !aie.objectfifosubview<memref<256xbf16>> -> memref<256xbf16>
          func.call @op0_passThroughLine(%flash_state_1_3, %10, %c256_i32_8) : (memref<256xbf16>, memref<256xbf16>, i32) -> ()
    ...
    %core_0_5 = aie.core(%tile_0_5) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4 step %c1_1 {
          ...
          memref.store %c2_i32, %flash_index_0_5[%c1_3] : memref<2xi32>
          %c64_i32 = arith.constant 64 : i32
          %c0_i32_4 = arith.constant 0 : i32
          ...
          func.call @op0_partial_softmax_mode(%3, %1, %flash_state_0_5, %flash_index_0_5, %8, %c64_i32, %c64_i32_5, %c256_i32, %c256_i32_6, %c2_i32_7) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32, i32) -> ()
          %c256_i32_8 = arith.constant 256 : i32
          %9 = aie.objectfifo.acquire @flash_scale_0_5_0_4(Produce, 1) : !aie.objectfifosubview<memref<256xbf16>>
          %10 = aie.objectfifo.subview.access %9[0] : !aie.objectfifosubview<memref<256xbf16>> -> memref<256xbf16>
          func.call @op0_passThroughLine(%flash_state_0_5, %10, %c256_i32_8) : (memref<256xbf16>, memref<256xbf16>, i32) -> ()
    ...
    %core_1_5 = aie.core(%tile_1_5) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c4 step %c1_1 {
          ...
          memref.store %c3_i32, %flash_index_1_5[%c1_3] : memref<2xi32>
          %c64_i32 = arith.constant 64 : i32
          %c0_i32_4 = arith.constant 0 : i32
          %7 = arith.cmpi eq, %6, %c0_i32_4 : i32
          scf.if %7 {
          ...
          %c256_i32_6 = arith.constant 256 : i32
          %c2_i32 = arith.constant 2 : i32
          func.call @op0_partial_softmax_mode(%3, %1, %flash_state_1_5, %flash_index_1_5, %8, %c64_i32, %c64_i32_5, %c256_i32, %c256_i32_6, %c2_i32) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32, i32) -> ()
          %c256_i32_7 = arith.constant 256 : i32
          %9 = aie.objectfifo.acquire @flash_scale_1_5_1_4(Produce, 1) : !aie.objectfifosubview<memref<256xbf16>>
          %10 = aie.objectfifo.subview.access %9[0] : !aie.objectfifosubview<memref<256xbf16>> -> memref<256xbf16>
          func.call @op0_passThroughLine(%flash_state_1_5, %10, %c256_i32_7) : (memref<256xbf16>, memref<256xbf16>, i32) -> ()
    ...
    aie.objectfifo @of_0_mem_1(%shim_noc_tile_6_0, {%mem_tile_6_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<2x64x64xbf16>>  
    ...
    aie.objectfifo @of_4_broadcast_0_0(%mem_tile_5_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_2, %tile_1_2}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    ...
    aie.objectfifo @of_6_unicast_0(%tile_0_2, {%mem_tile_2_1}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_6_unicast_0_relay_1(%tile_0_2, {%mem_tile_2_1}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_6_unicast_1(%tile_1_2, {%mem_tile_7_1}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_6_unicast_1_relay_1(%tile_1_2, {%mem_tile_7_1}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_7_distribute_0_0(%mem_tile_2_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_3}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_7_distribute_0_1(%mem_tile_2_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_5}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_6_unicast_0] -> [@of_7_distribute_0_0]([] [])
    aie.objectfifo.link [@of_6_unicast_0_relay_1] -> [@of_7_distribute_0_1]([] [])
    aie.objectfifo @of_7_distribute_1_0(%mem_tile_7_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_1_3}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_7_distribute_1_1(%mem_tile_7_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_1_5}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    ...
    aie.objectfifo @of_9_unicast_1(%tile_1_4, {%mem_tile_3_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    ...
    aie.objectfifo @of_10_mem_1(%mem_tile_3_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%shim_noc_tile_3_0}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<2x64x64xbf16>>  
    ...
    aie.trace @trace_core_3(%tile_1_4) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<49152xbf16>, %arg1: memref<16384xbf16>, %arg2: memref<1xbf16>, %arg3: memref<1xbf16>, %arg4: memref<32768xi8>) {
      aiex.configure @op0__MHAStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5, %arg4) : (memref<256x64xbf16>, memref<64x256xbf16>, memref<256x64xbf16>, memref<256x64xbf16>, memref<32768xi8>)
      }
