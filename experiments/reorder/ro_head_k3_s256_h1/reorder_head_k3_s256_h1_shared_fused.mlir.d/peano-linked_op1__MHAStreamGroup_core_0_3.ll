...
13:                                               ; preds = %35, %37, %11
  %14 = phi ptr [ %38, %37 ], [ %36, %35 ], [ @of_2_join_0_1_buff_0, %11 ]
...
18:                                               ; preds = %39, %41, %16
  %19 = phi ptr [ %42, %41 ], [ %40, %39 ], [ @of_1_distribute_0_1_cons_buff_0, %16 ]
...
35:                                               ; preds = %11
  %36 = phi ptr [ @of_2_join_0_1_buff_0, %11 ]
  br label %13

37:                                               ; preds = %11
  %38 = phi ptr [ @of_2_join_0_1_buff_1, %11 ]
  br label %13

39:                                               ; preds = %16
  %40 = phi ptr [ @of_1_distribute_0_1_cons_buff_0, %16 ]
  br label %18

41:                                               ; preds = %16
  %42 = phi ptr [ @of_1_distribute_0_1_cons_buff_1, %16 ]
  br label %18
}
