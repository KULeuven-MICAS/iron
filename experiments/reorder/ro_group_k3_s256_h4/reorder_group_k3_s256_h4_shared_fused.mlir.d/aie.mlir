module {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<196608xbf16>, %arg1: memref<65536xbf16>, %arg2: memref<524288xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [16384] [1] : memref<196608xbf16> to memref<16384xbf16>
        ...
        %subview_0 = memref.subview %arg0[65536] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 65536>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 256], strides: [256, 1] : memref<16384xbf16, strided<[1], offset: 65536>> to memref<64x256xbf16>
        %subview_2 = memref.subview %arg2[0] [65536] [1] : memref<524288xbf16> to memref<65536xbf16>
        ...
        %subview_4 = memref.subview %arg0[16384] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 16384>>
        ...
        %subview_6 = memref.subview %arg0[81920] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 81920>>
        %reinterpret_cast_7 = memref.reinterpret_cast %subview_6 to offset: [0], sizes: [64, 256], strides: [256, 1] : memref<16384xbf16, strided<[1], offset: 81920>> to memref<64x256xbf16>
        %subview_8 = memref.subview %arg2[65536] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 65536>>
        ...
        %subview_10 = memref.subview %arg0[32768] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 32768>>
        ...
        %subview_12 = memref.subview %arg0[98304] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 98304>>
        %reinterpret_cast_13 = memref.reinterpret_cast %subview_12 to offset: [0], sizes: [64, 256], strides: [256, 1] : memref<16384xbf16, strided<[1], offset: 98304>> to memref<64x256xbf16>
        %subview_14 = memref.subview %arg2[131072] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 131072>>
        ...
        %subview_16 = memref.subview %arg0[49152] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 49152>>
        ...
        %subview_18 = memref.subview %arg0[114688] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 114688>>
        %reinterpret_cast_19 = memref.reinterpret_cast %subview_18 to offset: [0], sizes: [64, 256], strides: [256, 1] : memref<16384xbf16, strided<[1], offset: 114688>> to memref<64x256xbf16>
        %subview_20 = memref.subview %arg2[196608] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 196608>>
      ...
      aiex.configure @op1__MHAStreamGroup {
        %subview = memref.subview %arg2[0] [65536] [1] : memref<524288xbf16> to memref<65536xbf16>
        ...
        %subview_0 = memref.subview %arg2[262144] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 262144>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [256, 256], strides: [256, 1] : memref<65536xbf16, strided<[1], offset: 262144>> to memref<256x256xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1) : (memref<256x256xbf16>, memref<256x256xbf16>)
        %subview_2 = memref.subview %arg2[65536] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 65536>>
        ...
        %subview_4 = memref.subview %arg2[327680] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 327680>>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [256, 256], strides: [256, 1] : memref<65536xbf16, strided<[1], offset: 327680>> to memref<256x256xbf16>
        aiex.run @sequence(%reinterpret_cast_3, %reinterpret_cast_5) : (memref<256x256xbf16>, memref<256x256xbf16>)
        %subview_6 = memref.subview %arg2[131072] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 131072>>
        ...
        %subview_8 = memref.subview %arg2[393216] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 393216>>
        %reinterpret_cast_9 = memref.reinterpret_cast %subview_8 to offset: [0], sizes: [256, 256], strides: [256, 1] : memref<65536xbf16, strided<[1], offset: 393216>> to memref<256x256xbf16>
        aiex.run @sequence(%reinterpret_cast_7, %reinterpret_cast_9) : (memref<256x256xbf16>, memref<256x256xbf16>)
        %subview_10 = memref.subview %arg2[196608] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 196608>>
        ...
        %subview_12 = memref.subview %arg2[458752] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 458752>>
        %reinterpret_cast_13 = memref.reinterpret_cast %subview_12 to offset: [0], sizes: [256, 256], strides: [256, 1] : memref<65536xbf16, strided<[1], offset: 458752>> to memref<256x256xbf16>
      ...
      aiex.configure @op2__MHAStreamGroup {
        %subview = memref.subview %arg2[262144] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 262144>>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [256, 256], strides: [256, 1] : memref<65536xbf16, strided<[1], offset: 262144>> to memref<256x256xbf16>
        %subview_0 = memref.subview %arg0[131072] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 131072>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 131072>> to memref<256x64xbf16>
        %subview_2 = memref.subview %arg1[0] [16384] [1] : memref<65536xbf16> to memref<16384xbf16>
        ...
        %subview_4 = memref.subview %arg2[327680] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 327680>>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [256, 256], strides: [256, 1] : memref<65536xbf16, strided<[1], offset: 327680>> to memref<256x256xbf16>
        %subview_6 = memref.subview %arg0[147456] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 147456>>
        %reinterpret_cast_7 = memref.reinterpret_cast %subview_6 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 147456>> to memref<256x64xbf16>
        %subview_8 = memref.subview %arg1[16384] [16384] [1] : memref<65536xbf16> to memref<16384xbf16, strided<[1], offset: 16384>>
        ...
        %subview_10 = memref.subview %arg2[393216] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 393216>>
        %reinterpret_cast_11 = memref.reinterpret_cast %subview_10 to offset: [0], sizes: [256, 256], strides: [256, 1] : memref<65536xbf16, strided<[1], offset: 393216>> to memref<256x256xbf16>
        %subview_12 = memref.subview %arg0[163840] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 163840>>
        %reinterpret_cast_13 = memref.reinterpret_cast %subview_12 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 163840>> to memref<256x64xbf16>
        %subview_14 = memref.subview %arg1[32768] [16384] [1] : memref<65536xbf16> to memref<16384xbf16, strided<[1], offset: 32768>>
        ...
        %subview_16 = memref.subview %arg2[458752] [65536] [1] : memref<524288xbf16> to memref<65536xbf16, strided<[1], offset: 458752>>
        %reinterpret_cast_17 = memref.reinterpret_cast %subview_16 to offset: [0], sizes: [256, 256], strides: [256, 1] : memref<65536xbf16, strided<[1], offset: 458752>> to memref<256x256xbf16>
        %subview_18 = memref.subview %arg0[180224] [16384] [1] : memref<196608xbf16> to memref<16384xbf16, strided<[1], offset: 180224>>
        %reinterpret_cast_19 = memref.reinterpret_cast %subview_18 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 180224>> to memref<256x64xbf16>
        %subview_20 = memref.subview %arg1[49152] [16384] [1] : memref<65536xbf16> to memref<16384xbf16, strided<[1], offset: 49152>>
