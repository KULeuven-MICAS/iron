module {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<393216xbf16>, %arg1: memref<131072xbf16>, %arg2: memref<2097152xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [32768] [1] : memref<393216xbf16> to memref<32768xbf16>
        ...
        %subview_0 = memref.subview %arg0[131072] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 131072>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 512], strides: [512, 1] : memref<32768xbf16, strided<[1], offset: 131072>> to memref<64x512xbf16>
        %subview_2 = memref.subview %arg2[0] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16>
        ...
        %subview_4 = memref.subview %arg0[32768] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 32768>>
        ...
        %subview_6 = memref.subview %arg0[163840] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 163840>>
        %reinterpret_cast_7 = memref.reinterpret_cast %subview_6 to offset: [0], sizes: [64, 512], strides: [512, 1] : memref<32768xbf16, strided<[1], offset: 163840>> to memref<64x512xbf16>
        %subview_8 = memref.subview %arg2[262144] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 262144>>
        ...
        %subview_10 = memref.subview %arg0[65536] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 65536>>
        ...
        %subview_12 = memref.subview %arg0[196608] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 196608>>
        %reinterpret_cast_13 = memref.reinterpret_cast %subview_12 to offset: [0], sizes: [64, 512], strides: [512, 1] : memref<32768xbf16, strided<[1], offset: 196608>> to memref<64x512xbf16>
        %subview_14 = memref.subview %arg2[524288] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 524288>>
        ...
        %subview_16 = memref.subview %arg0[98304] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 98304>>
        ...
        %subview_18 = memref.subview %arg0[229376] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 229376>>
        %reinterpret_cast_19 = memref.reinterpret_cast %subview_18 to offset: [0], sizes: [64, 512], strides: [512, 1] : memref<32768xbf16, strided<[1], offset: 229376>> to memref<64x512xbf16>
        %subview_20 = memref.subview %arg2[786432] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 786432>>
      ...
      aiex.configure @op1__MHAStreamGroup {
        %subview = memref.subview %arg2[0] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16>
        ...
        %subview_0 = memref.subview %arg2[1048576] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 1048576>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16, strided<[1], offset: 1048576>> to memref<512x512xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1) : (memref<512x512xbf16>, memref<512x512xbf16>)
        %subview_2 = memref.subview %arg2[262144] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 262144>>
        ...
        %subview_4 = memref.subview %arg2[1310720] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 1310720>>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16, strided<[1], offset: 1310720>> to memref<512x512xbf16>
        aiex.run @sequence(%reinterpret_cast_3, %reinterpret_cast_5) : (memref<512x512xbf16>, memref<512x512xbf16>)
        %subview_6 = memref.subview %arg2[524288] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 524288>>
        ...
        %subview_8 = memref.subview %arg2[1572864] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 1572864>>
        %reinterpret_cast_9 = memref.reinterpret_cast %subview_8 to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16, strided<[1], offset: 1572864>> to memref<512x512xbf16>
        aiex.run @sequence(%reinterpret_cast_7, %reinterpret_cast_9) : (memref<512x512xbf16>, memref<512x512xbf16>)
        %subview_10 = memref.subview %arg2[786432] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 786432>>
        ...
        %subview_12 = memref.subview %arg2[1835008] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 1835008>>
        %reinterpret_cast_13 = memref.reinterpret_cast %subview_12 to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16, strided<[1], offset: 1835008>> to memref<512x512xbf16>
      ...
      aiex.configure @op2__MHAStreamGroup {
        %subview = memref.subview %arg2[1048576] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 1048576>>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16, strided<[1], offset: 1048576>> to memref<512x512xbf16>
        %subview_0 = memref.subview %arg0[262144] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 262144>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [512, 64], strides: [64, 1] : memref<32768xbf16, strided<[1], offset: 262144>> to memref<512x64xbf16>
        %subview_2 = memref.subview %arg1[0] [32768] [1] : memref<131072xbf16> to memref<32768xbf16>
        ...
        %subview_4 = memref.subview %arg2[1310720] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 1310720>>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16, strided<[1], offset: 1310720>> to memref<512x512xbf16>
        %subview_6 = memref.subview %arg0[294912] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 294912>>
        %reinterpret_cast_7 = memref.reinterpret_cast %subview_6 to offset: [0], sizes: [512, 64], strides: [64, 1] : memref<32768xbf16, strided<[1], offset: 294912>> to memref<512x64xbf16>
        %subview_8 = memref.subview %arg1[32768] [32768] [1] : memref<131072xbf16> to memref<32768xbf16, strided<[1], offset: 32768>>
        ...
        %subview_10 = memref.subview %arg2[1572864] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 1572864>>
        %reinterpret_cast_11 = memref.reinterpret_cast %subview_10 to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16, strided<[1], offset: 1572864>> to memref<512x512xbf16>
        %subview_12 = memref.subview %arg0[327680] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 327680>>
        %reinterpret_cast_13 = memref.reinterpret_cast %subview_12 to offset: [0], sizes: [512, 64], strides: [64, 1] : memref<32768xbf16, strided<[1], offset: 327680>> to memref<512x64xbf16>
        %subview_14 = memref.subview %arg1[65536] [32768] [1] : memref<131072xbf16> to memref<32768xbf16, strided<[1], offset: 65536>>
        ...
        %subview_16 = memref.subview %arg2[1835008] [262144] [1] : memref<2097152xbf16> to memref<262144xbf16, strided<[1], offset: 1835008>>
        %reinterpret_cast_17 = memref.reinterpret_cast %subview_16 to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16, strided<[1], offset: 1835008>> to memref<512x512xbf16>
        %subview_18 = memref.subview %arg0[360448] [32768] [1] : memref<393216xbf16> to memref<32768xbf16, strided<[1], offset: 360448>>
        %reinterpret_cast_19 = memref.reinterpret_cast %subview_18 to offset: [0], sizes: [512, 64], strides: [64, 1] : memref<32768xbf16, strided<[1], offset: 360448>> to memref<512x64xbf16>
        %subview_20 = memref.subview %arg1[98304] [32768] [1] : memref<131072xbf16> to memref<32768xbf16, strided<[1], offset: 98304>>
