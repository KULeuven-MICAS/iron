module {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<98304xbf16>, %arg1: memref<32768xbf16>, %arg2: memref<524288xbf16>) {
      ...
      aiex.configure @op2__MHAStreamGroup {
        ...
        %subview_0 = memref.subview %arg0[65536] [32768] [1] : memref<98304xbf16> to memref<32768xbf16, strided<[1], offset: 65536>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [512, 64], strides: [64, 1] : memref<32768xbf16, strided<[1], offset: 65536>> to memref<512x64xbf16>
        %subview_2 = memref.subview %arg1[0] [32768] [1] : memref<32768xbf16> to memref<32768xbf16>
