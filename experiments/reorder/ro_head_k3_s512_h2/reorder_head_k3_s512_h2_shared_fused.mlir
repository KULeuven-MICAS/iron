module {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<196608xbf16>, %arg1: memref<65536xbf16>, %arg2: memref<524288xbf16>) {
      ...
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[32768] [32768] [1] : memref<196608xbf16> to memref<32768xbf16, strided<[1], offset: 32768>>
        ...
        %subview_0 = memref.subview %arg0[98304] [32768] [1] : memref<196608xbf16> to memref<32768xbf16, strided<[1], offset: 98304>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 512], strides: [512, 1] : memref<32768xbf16, strided<[1], offset: 98304>> to memref<64x512xbf16>
        %subview_2 = memref.subview %arg2[0] [262144] [1] : memref<524288xbf16> to memref<262144xbf16>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16> to memref<512x512xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3) : (memref<512x64xbf16>, memref<64x512xbf16>, memref<512x512xbf16>)
      }
      ...
      aiex.configure @op2__MHAStreamGroup {
        %subview = memref.subview %arg2[262144] [262144] [1] : memref<524288xbf16> to memref<262144xbf16, strided<[1], offset: 262144>>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [512, 512], strides: [512, 1] : memref<262144xbf16, strided<[1], offset: 262144>> to memref<512x512xbf16>
        %subview_0 = memref.subview %arg0[163840] [32768] [1] : memref<196608xbf16> to memref<32768xbf16, strided<[1], offset: 163840>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [512, 64], strides: [64, 1] : memref<32768xbf16, strided<[1], offset: 163840>> to memref<512x64xbf16>
        %subview_2 = memref.subview %arg1[32768] [32768] [1] : memref<65536xbf16> to memref<32768xbf16, strided<[1], offset: 32768>>
