; ModuleID = '/home/micas/iron-stream-dse/experiments/fable_k2/stream_s2048_e512_h2048/swiglu_prefill_stream_k2_m2048_e512_h2048_shared_fused.mlir.d/peano-linked_op0__SwiGLUStreamGroup_core_0_5.ll'
...
@switch.table.core_0_5 = private unnamed_addr constant [3 x ptr] [ptr @of_4_broadcast_0_0_3_cons_buff_1, ptr @of_4_broadcast_0_0_3_cons_buff_2, ptr @of_4_broadcast_0_0_3_cons_buff_3], align 4
@switch.table.core_0_5.1 = private unnamed_addr constant [3 x ptr] [ptr @of_3_distribute_0_3_0_cons_buff_1, ptr @of_3_distribute_0_3_0_cons_buff_2, ptr @of_3_distribute_0_3_0_cons_buff_3], align 4
...
9:                                                ; preds = %.preheader, %34
  ...
  %spec.select = select i1 %cond, ptr @of_6_switch_join_3_0_buff_1, ptr @of_6_switch_join_3_0_buff_0
...
switch.lookup:                                    ; preds = %14
  ...
  %switch.gep = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_0_5, i20 0, i20 %19
  %switch.load = load ptr, ptr %switch.gep, align 4
  br label %20

20:                                               ; preds = %switch.lookup, %14
  %21 = phi ptr [ @of_4_broadcast_0_0_3_cons_buff_0, %14 ], [ %switch.load, %switch.lookup ]
...
switch.lookup14:                                  ; preds = %20
  ...
  %switch.gep16 = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_0_5.1, i20 0, i20 %23
  %switch.load17 = load ptr, ptr %switch.gep16, align 4
  br label %24

24:                                               ; preds = %switch.lookup14, %20
  %25 = phi ptr [ @of_3_distribute_0_3_0_cons_buff_0, %20 ], [ %switch.load17, %switch.lookup14 ]
