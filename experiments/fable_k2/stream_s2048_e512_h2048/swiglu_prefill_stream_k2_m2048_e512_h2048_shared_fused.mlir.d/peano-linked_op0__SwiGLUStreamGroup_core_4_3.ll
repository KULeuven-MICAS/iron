...
21:                                               ; preds = %72, %74, %19
  %22 = phi ptr [ %75, %74 ], [ %73, %72 ], [ @of_6_switch_join_1_0_cons_buff_0, %19 ]
...
32:                                               ; preds = %76, %78, %30
  %33 = phi ptr [ %79, %78 ], [ %77, %76 ], [ @of_6_switch_join_1_1_cons_buff_0, %30 ]
...
48:                                               ; preds = %80, %82, %46
  %49 = phi ptr [ %83, %82 ], [ %81, %80 ], [ @of_8_unicast_1_buff_0, %46 ]
...
72:                                               ; preds = %19
  %73 = phi ptr [ @of_6_switch_join_1_0_cons_buff_0, %19 ]
  br label %21

74:                                               ; preds = %19
  %75 = phi ptr [ @of_6_switch_join_1_0_cons_buff_1, %19 ]
  br label %21

76:                                               ; preds = %30
  %77 = phi ptr [ @of_6_switch_join_1_1_cons_buff_0, %30 ]
  br label %32

78:                                               ; preds = %30
  %79 = phi ptr [ @of_6_switch_join_1_1_cons_buff_1, %30 ]
  br label %32

80:                                               ; preds = %46
  %81 = phi ptr [ @of_8_unicast_1_buff_0, %46 ]
  br label %48

82:                                               ; preds = %46
  %83 = phi ptr [ @of_8_unicast_1_buff_1, %46 ]
  br label %48
