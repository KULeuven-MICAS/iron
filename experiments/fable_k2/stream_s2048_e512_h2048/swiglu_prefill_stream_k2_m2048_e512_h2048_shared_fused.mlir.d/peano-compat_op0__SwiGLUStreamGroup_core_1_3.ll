...
21:                                               ; preds = %58, %60, %19
  %22 = phi ptr [ %61, %60 ], [ %59, %58 ], [ @of_6_switch_join_1_1_buff_0, %19 ]
...
32:                                               ; preds = %62, %64, %66, %68, %30
  %33 = phi ptr [ %69, %68 ], [ %67, %66 ], [ %65, %64 ], [ %63, %62 ], [ @of_4_broadcast_1_0_1_cons_buff_0, %30 ]
...
37:                                               ; preds = %70, %72, %74, %76, %35
  %38 = phi ptr [ %77, %76 ], [ %75, %74 ], [ %73, %72 ], [ %71, %70 ], [ @of_3_distribute_1_1_1_cons_buff_0, %35 ]
...
58:                                               ; preds = %19
  %59 = phi ptr [ @of_6_switch_join_1_1_buff_0, %19 ]
  br label %21

60:                                               ; preds = %19
  %61 = phi ptr [ @of_6_switch_join_1_1_buff_1, %19 ]
  br label %21

62:                                               ; preds = %30
  %63 = phi ptr [ @of_4_broadcast_1_0_1_cons_buff_0, %30 ]
  br label %32

64:                                               ; preds = %30
  %65 = phi ptr [ @of_4_broadcast_1_0_1_cons_buff_1, %30 ]
  br label %32

66:                                               ; preds = %30
  %67 = phi ptr [ @of_4_broadcast_1_0_1_cons_buff_2, %30 ]
  br label %32

68:                                               ; preds = %30
  %69 = phi ptr [ @of_4_broadcast_1_0_1_cons_buff_3, %30 ]
  br label %32

70:                                               ; preds = %35
  %71 = phi ptr [ @of_3_distribute_1_1_1_cons_buff_0, %35 ]
  br label %37

72:                                               ; preds = %35
  %73 = phi ptr [ @of_3_distribute_1_1_1_cons_buff_1, %35 ]
  br label %37

74:                                               ; preds = %35
  %75 = phi ptr [ @of_3_distribute_1_1_1_cons_buff_2, %35 ]
  br label %37

76:                                               ; preds = %35
  %77 = phi ptr [ @of_3_distribute_1_1_1_cons_buff_3, %35 ]
  br label %37
}
