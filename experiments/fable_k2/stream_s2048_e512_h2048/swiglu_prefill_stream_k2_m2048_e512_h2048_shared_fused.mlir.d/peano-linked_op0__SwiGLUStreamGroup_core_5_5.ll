...
24:                                               ; preds = %84, %86, %22
  %25 = phi ptr [ %87, %86 ], [ %85, %84 ], [ @of_7_switch_join_3_0_cons_buff_0, %22 ]
...
35:                                               ; preds = %88, %90, %33
  %36 = phi ptr [ %91, %90 ], [ %89, %88 ], [ @of_7_switch_join_3_1_cons_buff_0, %33 ]
...
52:                                               ; preds = %92, %94, %50
  %53 = phi ptr [ %95, %94 ], [ %93, %92 ], [ @of_9_join_0_3_buff_0, %50 ]
...
57:                                               ; preds = %96, %98, %55
  %58 = phi ptr [ %99, %98 ], [ %97, %96 ], [ @of_8_unicast_3_buff_0, %55 ]
...
84:                                               ; preds = %22
  %85 = phi ptr [ @of_7_switch_join_3_0_cons_buff_0, %22 ]
  br label %24

86:                                               ; preds = %22
  %87 = phi ptr [ @of_7_switch_join_3_0_cons_buff_1, %22 ]
  br label %24

88:                                               ; preds = %33
  %89 = phi ptr [ @of_7_switch_join_3_1_cons_buff_0, %33 ]
  br label %35

90:                                               ; preds = %33
  %91 = phi ptr [ @of_7_switch_join_3_1_cons_buff_1, %33 ]
  br label %35

92:                                               ; preds = %50
  %93 = phi ptr [ @of_9_join_0_3_buff_0, %50 ]
  br label %52

94:                                               ; preds = %50
  %95 = phi ptr [ @of_9_join_0_3_buff_1, %50 ]
  br label %52

96:                                               ; preds = %55
  %97 = phi ptr [ @of_8_unicast_3_buff_0, %55 ]
  br label %57

98:                                               ; preds = %55
  %99 = phi ptr [ @of_8_unicast_3_buff_1, %55 ]
  br label %57
