module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.objectfifo @of_3_distribute_0_1(%mem_tile_0_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_2_3, %tile_0_3}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    ...
    aie.trace @trace_core_4(%tile_1_2) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_5(%tile_1_3) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_6(%tile_1_4) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_7(%tile_1_5) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
  ...
  aie.device(npu2) @op1__SwiGLUStreamGroup {
    ...
    aie.trace @trace_core_0(%tile_6_2) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_1(%tile_6_3) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_2(%tile_6_4) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_3(%tile_6_5) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_4(%tile_7_2) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_5(%tile_7_3) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_6(%tile_7_4) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_7(%tile_7_5) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<177209344xbf16>, %arg1: memref<1048576xbf16>, %arg2: memref<3670016xbf16>, %arg3: memref<1048576xi8>, %arg4: memref<1048576xi8>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5, %arg4) : (memref<256x4096xbf16>, memref<4096x14336xbf16>, memref<4096x14336xbf16>, memref<256x14336xbf16>, memref<1048576xi8>)
      }
      aiex.configure @op1__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %arg3) : (memref<256x14336xbf16>, memref<14336x4096xbf16>, memref<256x4096xbf16>, memref<1048576xi8>)
      }
    }
  }
}
