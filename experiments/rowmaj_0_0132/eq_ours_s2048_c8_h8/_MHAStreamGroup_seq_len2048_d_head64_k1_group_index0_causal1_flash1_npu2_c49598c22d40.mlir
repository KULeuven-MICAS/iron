module {
  aie.device(npu2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c32 step %c1_1 {
            ...
            %c2048_i32_6 = arith.constant 2048 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_0_5, %flash_index_0_5, %11, %c64_i32, %c64_i32_5, %c2048_i32, %c2048_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c32 step %c1_1 {
            ...
            %c2048_i32_6 = arith.constant 2048 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_1_5, %flash_index_1_5, %11, %c64_i32, %c64_i32_5, %c2048_i32, %c2048_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c32 step %c1_1 {
            ...
            %c2048_i32_6 = arith.constant 2048 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_2_5, %flash_index_2_5, %11, %c64_i32, %c64_i32_5, %c2048_i32, %c2048_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c32 step %c1_1 {
            ...
            %c2048_i32_6 = arith.constant 2048 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_3_5, %flash_index_3_5, %11, %c64_i32, %c64_i32_5, %c2048_i32, %c2048_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c32 step %c1_1 {
            ...
            %c2048_i32_6 = arith.constant 2048 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_4_5, %flash_index_4_5, %11, %c64_i32, %c64_i32_5, %c2048_i32, %c2048_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c32 step %c1_1 {
            ...
            %c2048_i32_6 = arith.constant 2048 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_5_5, %flash_index_5_5, %11, %c64_i32, %c64_i32_5, %c2048_i32, %c2048_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c32 step %c1_1 {
            ...
            %c2048_i32_6 = arith.constant 2048 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_6_5, %flash_index_6_5, %11, %c64_i32, %c64_i32_5, %c2048_i32, %c2048_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c32 step %c1_1 {
            ...
            %c2048_i32_6 = arith.constant 2048 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_7_5, %flash_index_7_5, %11, %c64_i32, %c64_i32_5, %c2048_i32, %c2048_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
    ...
    aie.objectfifo @of_8_join_0_1(%tile_0_5, {%mem_tile_0_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_1_0(%tile_1_3, {%mem_tile_1_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_1_1(%tile_1_5, {%mem_tile_1_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_2_0(%tile_2_3, {%mem_tile_2_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_2_1(%tile_2_5, {%mem_tile_2_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_3_0(%tile_3_3, {%mem_tile_3_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_3_1(%tile_3_5, {%mem_tile_3_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_4_0(%tile_4_3, {%mem_tile_4_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_4_1(%tile_4_5, {%mem_tile_4_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_5_0(%tile_5_3, {%mem_tile_5_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_5_1(%tile_5_5, {%mem_tile_5_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_6_0(%tile_6_3, {%mem_tile_6_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_6_1(%tile_6_5, {%mem_tile_6_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_7_0(%tile_7_3, {%mem_tile_7_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_8_join_7_1(%tile_7_5, {%mem_tile_7_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_0_0(%mem_tile_0_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_join_0_0] -> [@of_9_unicast_0_0]([] [])
    aie.objectfifo.link [@of_8_join_0_1] -> [@of_9_unicast_0_0_relay_1]([] [])
    aie.objectfifo @of_9_unicast_0_0_relay_1(%mem_tile_0_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_1_0(%mem_tile_1_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_1_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_join_1_0] -> [@of_9_unicast_1_0]([] [])
    aie.objectfifo.link [@of_8_join_1_1] -> [@of_9_unicast_1_0_relay_1]([] [])
    aie.objectfifo @of_9_unicast_1_0_relay_1(%mem_tile_1_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_1_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_2_0(%mem_tile_2_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_2_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_join_2_0] -> [@of_9_unicast_2_0]([] [])
    aie.objectfifo.link [@of_8_join_2_1] -> [@of_9_unicast_2_0_relay_1]([] [])
    aie.objectfifo @of_9_unicast_2_0_relay_1(%mem_tile_2_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_2_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_3_0(%mem_tile_3_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_3_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_join_3_0] -> [@of_9_unicast_3_0]([] [])
    aie.objectfifo.link [@of_8_join_3_1] -> [@of_9_unicast_3_0_relay_1]([] [])
    aie.objectfifo @of_9_unicast_3_0_relay_1(%mem_tile_3_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_3_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_4_0(%mem_tile_4_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_4_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_join_4_0] -> [@of_9_unicast_4_0]([] [])
    aie.objectfifo.link [@of_8_join_4_1] -> [@of_9_unicast_4_0_relay_1]([] [])
    aie.objectfifo @of_9_unicast_4_0_relay_1(%mem_tile_4_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_4_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_5_0(%mem_tile_5_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_5_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_join_5_0] -> [@of_9_unicast_5_0]([] [])
    aie.objectfifo.link [@of_8_join_5_1] -> [@of_9_unicast_5_0_relay_1]([] [])
    aie.objectfifo @of_9_unicast_5_0_relay_1(%mem_tile_5_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_5_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_6_0(%mem_tile_6_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_6_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_join_6_0] -> [@of_9_unicast_6_0]([] [])
    aie.objectfifo.link [@of_8_join_6_1] -> [@of_9_unicast_6_0_relay_1]([] [])
    aie.objectfifo @of_9_unicast_6_0_relay_1(%mem_tile_6_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_6_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo @of_9_unicast_7_0(%mem_tile_7_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_7_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
    aie.objectfifo.link [@of_8_join_7_0] -> [@of_9_unicast_7_0]([] [])
    aie.objectfifo.link [@of_8_join_7_1] -> [@of_9_unicast_7_0_relay_1]([] [])
    aie.objectfifo @of_9_unicast_7_0_relay_1(%mem_tile_7_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_7_4}, [1 : i32, 2 : i32]) : !aie.objectfifo<memref<64x64xbf16>>  
