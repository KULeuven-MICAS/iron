...
32:                                               ; preds = %72, %74, %30
  %33 = phi ptr [ %75, %74 ], [ %73, %72 ], [ @of_6_join_2_0_buff_0, %30 ]
...
44:                                               ; preds = %43, %40
  call void @op0_matmul_softmax(ptr %19, ptr %39, ptr %34, ptr @flash_state_1_3, ptr @flash_index_1_3, bfloat 0xR3FB9, i32 64, i32 64, i32 1024, i32 1024)
...
72:                                               ; preds = %30
  %73 = phi ptr [ @of_6_join_2_0_buff_0, %30 ]
  br label %32

74:                                               ; preds = %30
  %75 = phi ptr [ @of_6_join_2_0_buff_1, %30 ]
  br label %32
