; ModuleID = '/home/micas/iron-stream-dse/experiments/fusedab_1/eq_ours_s2048_c4_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_3_3.ll'
...
15:                                               ; preds = %6, %24
  ...
  %spec.select5 = select i1 %cond1, ptr @of_6_join_2_1_buff_1, ptr @of_6_join_2_1_buff_0
  ...
  store i32 %21, ptr @flash_index_3_3, align 4
  store i32 %14, ptr getelementptr inbounds nuw (i8, ptr @flash_index_3_3, i20 4), align 4
  %22 = icmp eq i32 %21, 0
...
24:                                               ; preds = %23, %15
  tail call void @op0_matmul_softmax(ptr nonnull %spec.select, ptr nonnull %20, ptr nonnull %spec.select5, ptr nonnull @flash_state_3_3, ptr nonnull @flash_index_3_3, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048)
  tail call void @llvm.aie2p.acquire(i32 54, i32 -1)
  %cond3 = icmp eq i32 %16, 1
  %spec.select6 = select i1 %cond3, ptr @flash_scale_3_3_buff_1, ptr @flash_scale_3_3_buff_0
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_3_3, ptr nonnull %spec.select6, i32 256)
