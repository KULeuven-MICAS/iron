module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.objectfifo @of_9_join_0_0(%tile_5_2, {%mem_tile_2_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_9_join_0_1(%tile_5_3, {%mem_tile_2_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_9_join_0_2(%tile_5_4, {%mem_tile_2_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_9_join_0_3(%tile_5_5, {%mem_tile_2_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_10_mem(%mem_tile_2_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%shim_noc_tile_2_0}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<4x32x64xbf16>>  
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<177209344xbf16>, %arg1: memref<1048576xbf16>, %arg2: memref<3670016xbf16>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        ...
        %subview_2 = memref.subview %arg0[59768832] [58720256] [1] : memref<177209344xbf16> to memref<58720256xbf16, strided<[1], offset: 59768832>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [4096, 14336], strides: [14336, 1] : memref<58720256xbf16, strided<[1], offset: 59768832>> to memref<4096x14336xbf16>
        %subview_4 = memref.subview %arg2[0] [3670016] [1] : memref<3670016xbf16> to memref<3670016xbf16>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [256, 14336], strides: [14336, 1] : memref<3670016xbf16> to memref<256x14336xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5) : (memref<256x4096xbf16>, memref<4096x14336xbf16>, memref<4096x14336xbf16>, memref<256x14336xbf16>)
      }
      aiex.configure @op1__SwiGLUStreamGroup {
        %subview = memref.subview %arg2[0] [3670016] [1] : memref<3670016xbf16> to memref<3670016xbf16>
