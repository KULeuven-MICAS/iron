module {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<24576xbf16>, %arg1: memref<8192xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [8192] [1] : memref<24576xbf16> to memref<8192xbf16>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [128, 64], strides: [64, 1] : memref<8192xbf16> to memref<128x64xbf16>
        %subview_0 = memref.subview %arg0[8192] [8192] [1] : memref<24576xbf16> to memref<8192xbf16, strided<[1], offset: 8192>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 128], strides: [128, 1] : memref<8192xbf16, strided<[1], offset: 8192>> to memref<64x128xbf16>
        %subview_2 = memref.subview %arg0[16384] [8192] [1] : memref<24576xbf16> to memref<8192xbf16, strided<[1], offset: 16384>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [128, 64], strides: [64, 1] : memref<8192xbf16, strided<[1], offset: 16384>> to memref<128x64xbf16>
        %subview_4 = memref.subview %arg1[0] [8192] [1] : memref<8192xbf16> to memref<8192xbf16>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [128, 64], strides: [64, 1] : memref<8192xbf16> to memref<128x64xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5) : (memref<128x64xbf16>, memref<64x128xbf16>, memref<128x64xbf16>, memref<128x64xbf16>)
      }
