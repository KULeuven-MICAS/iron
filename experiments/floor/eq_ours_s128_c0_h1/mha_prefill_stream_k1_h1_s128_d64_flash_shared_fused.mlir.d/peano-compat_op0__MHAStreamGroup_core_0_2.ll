...
12:                                               ; preds = %31, %33, %10
  %13 = phi ptr [ %34, %33 ], [ %32, %31 ], [ @of_6_unicast_0_buff_0, %10 ]
...
16:                                               ; preds = %35, %37, %15
  %17 = phi ptr [ %38, %37 ], [ %36, %35 ], [ @of_4_broadcast_0_0_0_cons_buff_0, %15 ]
...
22:                                               ; preds = %19
  call void @op0_matmul_bf16_bf16_64_64_64(ptr @of_3_unicast_0_0_cons_buff_0, ptr %18, ptr %14)
  br label %23
...
31:                                               ; preds = %10
  %32 = phi ptr [ @of_6_unicast_0_buff_0, %10 ]
  br label %12

33:                                               ; preds = %10
  %34 = phi ptr [ @of_6_unicast_0_buff_1, %10 ]
  br label %12

35:                                               ; preds = %15
  %36 = phi ptr [ @of_4_broadcast_0_0_0_cons_buff_0, %15 ]
  br label %16

37:                                               ; preds = %15
  %38 = phi ptr [ @of_4_broadcast_0_0_0_cons_buff_1, %15 ]
  br label %16
}
