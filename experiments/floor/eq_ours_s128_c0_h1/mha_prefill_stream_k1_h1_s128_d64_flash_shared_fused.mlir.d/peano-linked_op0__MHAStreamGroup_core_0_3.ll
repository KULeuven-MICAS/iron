...
14:                                               ; preds = %41, %43, %12
  %15 = phi ptr [ %44, %43 ], [ %42, %41 ], [ @of_8_unicast_0_buff_0, %12 ]
...
18:                                               ; preds = %45, %47, %17
  %19 = phi ptr [ %48, %47 ], [ %46, %45 ], [ @of_7_unicast_0_0_cons_buff_0, %17 ]
  %20 = getelementptr [64 x [64 x bfloat]], ptr %19, i32 0, i32 0, i32 0
  br label %21

21:                                               ; preds = %18
  %22 = trunc i64 %8 to i32
  store i32 %22, ptr @flash_index_0_3
...
25:                                               ; preds = %24, %21
  call void @op0_partial_softmax(ptr %20, ptr %16, ptr @flash_state_0_3, ptr @flash_index_0_3, bfloat 0xR3FB9, i32 64, i32 64, i32 128, i32 128)
...
27:                                               ; preds = %49, %51, %25
  %28 = phi ptr [ %52, %51 ], [ %50, %49 ], [ @flash_scale_0_3_0_4_buff_0, %25 ]
  %29 = getelementptr [256 x bfloat], ptr %28, i32 0, i32 0
  br label %30

30:                                               ; preds = %27
  call void @op0_passThroughLine(ptr @flash_state_0_3, ptr %29, i32 256)
...
41:                                               ; preds = %12
  %42 = phi ptr [ @of_8_unicast_0_buff_0, %12 ]
  br label %14

43:                                               ; preds = %12
  %44 = phi ptr [ @of_8_unicast_0_buff_1, %12 ]
  br label %14

45:                                               ; preds = %17
  %46 = phi ptr [ @of_7_unicast_0_0_cons_buff_0, %17 ]
  br label %18

47:                                               ; preds = %17
  %48 = phi ptr [ @of_7_unicast_0_0_cons_buff_1, %17 ]
  br label %18

49:                                               ; preds = %25
  %50 = phi ptr [ @flash_scale_0_3_0_4_buff_0, %25 ]
  br label %27

51:                                               ; preds = %25
  %52 = phi ptr [ @flash_scale_0_3_0_4_buff_1, %25 ]
  br label %27
}
