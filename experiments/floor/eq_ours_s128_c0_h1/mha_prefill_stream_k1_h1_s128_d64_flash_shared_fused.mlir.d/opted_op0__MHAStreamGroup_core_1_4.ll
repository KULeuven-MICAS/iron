; ModuleID = '/home/micas/iron-stream-dse/experiments/floor/eq_ours_s128_c0_h1/mha_prefill_stream_k1_h1_s128_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_4.ll'
...
5:                                                ; preds = %1, %13
  ...
  %8 = select i1 %cond1, ptr @of_5_broadcast_0_0_1_cons_buff_1, ptr @of_5_broadcast_0_0_1_cons_buff_0
  %9 = trunc nuw nsw i64 %7 to i32
  store i32 %9, ptr @flash_index_1_4, align 4
  ...
  %10 = select i1 %cond3, ptr @flash_scale_1_3_1_4_buff_1, ptr @flash_scale_1_3_1_4_buff_0
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %8, ptr nonnull %spec.select, ptr nonnull %10, i32 64, i32 %9, ptr nonnull @flash_index_1_4)
  %11 = icmp eq i32 %9, 1
  br i1 %11, label %12, label %13

12:                                               ; preds = %5
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %10, i32 64, ptr nonnull @flash_index_1_4)
  br label %13
