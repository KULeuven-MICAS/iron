...
8:                                                ; preds = %46, %48, %6
  %9 = phi ptr [ %49, %48 ], [ %47, %46 ], [ @of_10_unicast_0_buff_0, %6 ]
...
17:                                               ; preds = %50, %52, %16
  %18 = phi ptr [ %53, %52 ], [ %51, %50 ], [ @of_9_unicast_0_0_cons_buff_0, %16 ]
...
21:                                               ; preds = %54, %56, %20
  %22 = phi ptr [ %57, %56 ], [ %55, %54 ], [ @of_5_broadcast_0_0_0_cons_buff_0, %20 ]
  %23 = getelementptr [64 x [64 x bfloat]], ptr %22, i32 0, i32 0, i32 0
  br label %24

24:                                               ; preds = %21
  %25 = trunc i64 %13 to i32
  store i32 %25, ptr @flash_index_0_4
...
27:                                               ; preds = %58, %60, %24
  %28 = phi ptr [ %61, %60 ], [ %59, %58 ], [ @flash_scale_0_3_0_4_buff_0, %24 ]
...
30:                                               ; preds = %27
  ...
  call void @op0_matmul_PV(ptr %19, ptr %23, ptr %10, ptr %29, i32 64, i32 %32, ptr @flash_index_0_4)
  %33 = icmp eq i32 %25, 1
  br i1 %33, label %34, label %35

34:                                               ; preds = %30
  call void @op0_rescale_O(ptr %10, ptr %29, i32 64, ptr @flash_index_0_4)
  br label %35
...
46:                                               ; preds = %6
  %47 = phi ptr [ @of_10_unicast_0_buff_0, %6 ]
  br label %8

48:                                               ; preds = %6
  %49 = phi ptr [ @of_10_unicast_0_buff_1, %6 ]
  br label %8

50:                                               ; preds = %16
  %51 = phi ptr [ @of_9_unicast_0_0_cons_buff_0, %16 ]
  br label %17

52:                                               ; preds = %16
  %53 = phi ptr [ @of_9_unicast_0_0_cons_buff_1, %16 ]
  br label %17

54:                                               ; preds = %20
  %55 = phi ptr [ @of_5_broadcast_0_0_0_cons_buff_0, %20 ]
  br label %21

56:                                               ; preds = %20
  %57 = phi ptr [ @of_5_broadcast_0_0_0_cons_buff_1, %20 ]
  br label %21

58:                                               ; preds = %24
  %59 = phi ptr [ @flash_scale_0_3_0_4_buff_0, %24 ]
  br label %27

60:                                               ; preds = %24
  %61 = phi ptr [ @flash_scale_0_3_0_4_buff_1, %24 ]
  br label %27
}
