module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<1x64x64xbf16>, %arg1: memref<1x4096xbf16>, %arg2: memref<1x4096xbf16>, %arg3: memref<1x64x64xbf16>) {
      %c1_i32 = arith.constant 1 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage0, 0, %c1_i32) : i32
      %c1_i32_10 = arith.constant 1 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage0, 1, %c1_i32_10) : i32
      %c64_i32 = arith.constant 64 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage0, 2, %c64_i32) : i32
      %c64_i32_11 = arith.constant 64 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage0, 3, %c64_i32_11) : i32
      %c1_i32_12 = arith.constant 1 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 0, %c1_i32_12) : i32
      %c1_i32_13 = arith.constant 1 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 1, %c1_i32_13) : i32
      %c64_i32_14 = arith.constant 64 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 2, %c64_i32_14) : i32
      %c64_i32_15 = arith.constant 64 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 3, %c64_i32_15) : i32
      %c1_i32_16 = arith.constant 1 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 0, %c1_i32_16) : i32
      %c1_i32_17 = arith.constant 1 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 1, %c1_i32_17) : i32
      %c64_i32_18 = arith.constant 64 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 2, %c64_i32_18) : i32
      %c64_i32_19 = arith.constant 64 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 3, %c64_i32_19) : i32
      aiex.set_lock(%lock_0_2, 1)
      aiex.set_lock(%lock_0_3, 1)
      aiex.set_lock(%lock_0_4, 1)
      %0 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x64x64xbf16> offset = 0 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @inK {
        aie.dma_bd(%arg1 : memref<1x4096xbf16> offset = 0 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @inV {
        aie.dma_bd(%arg2 : memref<1x4096xbf16> offset = 0 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x64x64xbf16> offset = 0 len = 4096 sizes = [1, 1, 64, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
