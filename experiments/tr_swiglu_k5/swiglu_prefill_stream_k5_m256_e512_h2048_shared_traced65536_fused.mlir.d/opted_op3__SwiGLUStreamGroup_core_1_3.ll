; ModuleID = '/home/micas/iron-stream-dse/experiments/tr_swiglu_k5/swiglu_prefill_stream_k5_m256_e512_h2048_shared_traced65536_fused.mlir.d/peano-linked_op3__SwiGLUStreamGroup_core_1_3.ll'
...
10:                                               ; preds = %10, %5
  ...
  %spec.select4 = select i1 %cond1, ptr @of_3_distribute_1_1_cons_buff_1, ptr @of_3_distribute_1_1_cons_buff_0
  ...
  %spec.select4.1 = select i1 %cond1.1, ptr @of_3_distribute_1_1_cons_buff_1, ptr @of_3_distribute_1_1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  ...
  %spec.select4.2 = select i1 %cond1.2, ptr @of_3_distribute_1_1_cons_buff_1, ptr @of_3_distribute_1_1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  ...
  %spec.select4.3 = select i1 %cond1.3, ptr @of_3_distribute_1_1_cons_buff_1, ptr @of_3_distribute_1_1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
