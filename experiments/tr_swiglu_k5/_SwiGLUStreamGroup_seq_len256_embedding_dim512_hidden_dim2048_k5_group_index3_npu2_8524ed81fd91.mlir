  ...
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<256x2048xbf16>, %arg1: memref<256x2048xbf16>, %arg2: memref<256x2048xbf16>) {
      ...
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x2048xbf16> offset = 0 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @of_0_mem_1 {
        aie.dma_bd(%arg0 : memref<256x2048xbf16> offset = 2048 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @of_0_mem_2 {
        aie.dma_bd(%arg0 : memref<256x2048xbf16> offset = 4096 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @of_0_mem_3 {
        aie.dma_bd(%arg0 : memref<256x2048xbf16> offset = 6144 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @of_1_mem_0 {
        aie.dma_bd(%arg1 : memref<256x2048xbf16> offset = 0 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @of_1_mem_1 {
        aie.dma_bd(%arg1 : memref<256x2048xbf16> offset = 2048 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%5)
      %6 = aiex.dma_configure_task_for @of_1_mem_2 {
        aie.dma_bd(%arg1 : memref<256x2048xbf16> offset = 4096 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @of_1_mem_3 {
        aie.dma_bd(%arg1 : memref<256x2048xbf16> offset = 6144 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%7)
      %8 = aiex.dma_configure_task_for @of_5_mem_0 {
        aie.dma_bd(%arg2 : memref<256x2048xbf16> offset = 0 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%8)
      %9 = aiex.dma_configure_task_for @of_5_mem_1 {
        aie.dma_bd(%arg2 : memref<256x2048xbf16> offset = 2048 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%9)
      %10 = aiex.dma_configure_task_for @of_5_mem_2 {
        aie.dma_bd(%arg2 : memref<256x2048xbf16> offset = 4096 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%10)
      %11 = aiex.dma_configure_task_for @of_5_mem_3 {
        aie.dma_bd(%arg2 : memref<256x2048xbf16> offset = 6144 len = 131072 sizes = [1, 64, 32, 64] strides = [0, 8192, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
