module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<512x4096xbf16>, %arg1: memref<4096x14336xbf16>, %arg2: memref<4096x14336xbf16>, %arg3: memref<512x14336xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x4096xbf16> offset = 0 len = 524288 sizes = [56, 128, 128, 32] strides = [0, 32, 4096, 1])
        aie.end
      ...
      %6 = aiex.dma_configure_task_for @of_10_mem {
        aie.dma_bd(%arg3 : memref<512x14336xbf16> offset = 0 len = 1835008 sizes = [4, 224, 128, 64] strides = [1835008, 64, 14336, 1])
        aie.end
      ...
      %13 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x4096xbf16> offset = 524288 len = 524288 sizes = [56, 128, 128, 32] strides = [0, 32, 4096, 1])
        aie.end
      ...
      %25 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x4096xbf16> offset = 1048576 len = 524288 sizes = [56, 128, 128, 32] strides = [0, 32, 4096, 1])
        aie.end
      } {issue_token = true, iteration_t = 229376 : index, repeat_count = 55 : i32}
      ...
      %31 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x4096xbf16> offset = 1048576 len = 524288 sizes = [56, 128, 128, 32] strides = [0, 32, 4096, 1])
        aie.end
      } {issue_token = true, iteration_t = 286720 : index, repeat_count = 55 : i32}
      ...
      %37 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x4096xbf16> offset = 1572864 len = 524288 sizes = [56, 128, 128, 32] strides = [0, 32, 4096, 1])
        aie.end
      } {issue_token = true, iteration_t = 344064 : index, repeat_count = 55 : i32}
      ...
      %43 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x4096xbf16> offset = 1572864 len = 524288 sizes = [56, 128, 128, 32] strides = [0, 32, 4096, 1])
        aie.end
      } {issue_token = true, iteration_t = 401408 : index, repeat_count = 55 : i32}
    ...
    aie.objectfifo @of_3_distribute_0_3(%mem_tile_0_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_2_5, %tile_0_5}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    ...
    aie.objectfifo @of_3_distribute_1_0(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_1_2, %tile_3_2}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_3_distribute_1_1(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_1_3, %tile_3_3}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
  ...
  aie.device(npu2) @op1__SwiGLUStreamGroup {
    ...
    %mem_tile_0_1 = aie.tile(0, 1)
    %mem_tile_6_1 = aie.tile(6, 1)
    aie.runtime_sequence(%arg0: memref<512x14336xbf16>, %arg1: memref<14336x4096xbf16>, %arg2: memref<512x4096xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x14336xbf16> offset = 0 len = 1835008 sizes = [32, 224, 128, 64] strides = [0, 64, 14336, 1])
        aie.end
      ...
      %10 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x14336xbf16> offset = 1835008 len = 1835008 sizes = [32, 224, 128, 64] strides = [0, 64, 14336, 1])
        aie.end
      ...
      %18 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x14336xbf16> offset = 3670016 len = 1835008 sizes = [32, 224, 128, 64] strides = [0, 64, 14336, 1])
        aie.end
      } {issue_token = true, iteration_t = 229376 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%18)
      aiex.dma_await_task(%11)
      ...
      %22 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x14336xbf16> offset = 3670016 len = 1835008 sizes = [32, 224, 128, 64] strides = [0, 64, 14336, 1])
        aie.end
      } {issue_token = true, iteration_t = 286720 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%22)
      aiex.dma_await_task(%15)
      ...
      %26 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x14336xbf16> offset = 5505024 len = 1835008 sizes = [32, 224, 128, 64] strides = [0, 64, 14336, 1])
        aie.end
      } {issue_token = true, iteration_t = 344064 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%26)
      aiex.dma_await_task(%19)
      ...
      %30 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<512x14336xbf16> offset = 5505024 len = 1835008 sizes = [32, 224, 128, 64] strides = [0, 64, 14336, 1])
        aie.end
      } {issue_token = true, iteration_t = 401408 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%30)
      aiex.dma_await_task(%23)
    ...
    aie.objectfifo @of_0_mem_0(%shim_noc_tile_1_0, {%mem_tile_1_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<4x32x64xbf16>>  
    ...
    aie.objectfifo @of_2_distribute_0_0(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_6_2}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_2_distribute_0_1(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_6_3}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_2_distribute_0_2(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_6_4}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    aie.objectfifo @of_2_distribute_0_3(%mem_tile_1_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_6_5}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    ...
    aie.objectfifo @of_4_join_0_0(%tile_6_2, {%mem_tile_0_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_join_0_1(%tile_6_3, {%mem_tile_0_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_join_0_2(%tile_6_4, {%mem_tile_0_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_join_0_3(%tile_6_5, {%mem_tile_0_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    ...
    aie.objectfifo @of_5_mem_0(%mem_tile_0_1 dimensionsToStream [<size = 4, stride = 256>, <size = 8, stride = 8>, <size = 4, stride = 64>, <size = 8, stride = 1>], {%shim_noc_tile_0_0}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<4x32x32xbf16>>  
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<178257920xbf16>, %arg1: memref<2097152xbf16>, %arg2: memref<7340032xbf16>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        %subview = memref.subview %arg0[0] [2097152] [1] : memref<178257920xbf16> to memref<2097152xbf16>
        ...
        %subview_0 = memref.subview %arg0[2097152] [58720256] [1] : memref<178257920xbf16> to memref<58720256xbf16, strided<[1], offset: 2097152>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [4096, 14336], strides: [14336, 1] : memref<58720256xbf16, strided<[1], offset: 2097152>> to memref<4096x14336xbf16>
        %subview_2 = memref.subview %arg0[60817408] [58720256] [1] : memref<178257920xbf16> to memref<58720256xbf16, strided<[1], offset: 60817408>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [4096, 14336], strides: [14336, 1] : memref<58720256xbf16, strided<[1], offset: 60817408>> to memref<4096x14336xbf16>
        %subview_4 = memref.subview %arg2[0] [7340032] [1] : memref<7340032xbf16> to memref<7340032xbf16>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [512, 14336], strides: [14336, 1] : memref<7340032xbf16> to memref<512x14336xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5) : (memref<512x4096xbf16>, memref<4096x14336xbf16>, memref<4096x14336xbf16>, memref<512x14336xbf16>)
      }
      aiex.configure @op1__SwiGLUStreamGroup {
        %subview = memref.subview %arg2[0] [7340032] [1] : memref<7340032xbf16> to memref<7340032xbf16>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [512, 14336], strides: [14336, 1] : memref<7340032xbf16> to memref<512x14336xbf16>
        %subview_0 = memref.subview %arg0[119537664] [58720256] [1] : memref<178257920xbf16> to memref<58720256xbf16, strided<[1], offset: 119537664>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [14336, 4096], strides: [4096, 1] : memref<58720256xbf16, strided<[1], offset: 119537664>> to memref<14336x4096xbf16>
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3) : (memref<512x14336xbf16>, memref<14336x4096xbf16>, memref<512x4096xbf16>)
      }
    }
  }
}
