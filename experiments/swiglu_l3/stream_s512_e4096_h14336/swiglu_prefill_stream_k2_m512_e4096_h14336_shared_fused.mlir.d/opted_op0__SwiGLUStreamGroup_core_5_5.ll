; ModuleID = '/home/micas/iron-stream-dse/experiments/swiglu_l3/stream_s512_e4096_h14336/swiglu_prefill_stream_k2_m512_e4096_h14336_shared_fused.mlir.d/peano-linked_op0__SwiGLUStreamGroup_core_5_5.ll'
...
7:                                                ; preds = %7, %.preheader
  ...
  %18 = select i1 %cond2.1, ptr @of_7_switch_join_3_1_cons_buff_1, ptr @of_7_switch_join_3_1_cons_buff_0
  ...
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 17, i32 -1)
  tail call void @op0_eltwise_mul_bf16_vector(ptr nonnull @of_8_unicast_3_buff_1, ptr nonnull %18, ptr nonnull @of_9_join_0_3_buff_1, i32 2048)
  tail call void @llvm.aie2p.release(i32 16, i32 1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.release(i32 52, i32 1)
  %19 = add i32 %14, 1
  ...
  %25 = select i1 %cond2.2, ptr @of_7_switch_join_3_1_cons_buff_1, ptr @of_7_switch_join_3_1_cons_buff_0
  %cond1.2 = icmp eq i32 %21, 1
  %spec.select.2 = select i1 %cond1.2, ptr @of_7_switch_join_3_0_cons_buff_1, ptr @of_7_switch_join_3_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 17, i32 -1)
  tail call void @op0_eltwise_mul_bf16_vector(ptr nonnull @of_8_unicast_3_buff_0, ptr nonnull %spec.select.2, ptr nonnull @of_9_join_0_3_buff_0, i32 2048)
  tail call void @llvm.aie2p.release(i32 16, i32 1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 17, i32 -1)
  tail call void @op0_eltwise_mul_bf16_vector(ptr nonnull @of_8_unicast_3_buff_1, ptr nonnull %25, ptr nonnull @of_9_join_0_3_buff_1, i32 2048)
  tail call void @llvm.aie2p.release(i32 16, i32 1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.release(i32 52, i32 1)
  %26 = add i32 %21, 1
  ...
  %33 = select i1 %cond2.3, ptr @of_7_switch_join_3_1_cons_buff_1, ptr @of_7_switch_join_3_1_cons_buff_0
  %cond1.3 = icmp eq i32 %28, 1
  %spec.select.3 = select i1 %cond1.3, ptr @of_7_switch_join_3_0_cons_buff_1, ptr @of_7_switch_join_3_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 17, i32 -1)
  tail call void @op0_eltwise_mul_bf16_vector(ptr nonnull @of_8_unicast_3_buff_0, ptr nonnull %spec.select.3, ptr nonnull @of_9_join_0_3_buff_0, i32 2048)
  tail call void @llvm.aie2p.release(i32 16, i32 1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 17, i32 -1)
  tail call void @op0_eltwise_mul_bf16_vector(ptr nonnull @of_8_unicast_3_buff_1, ptr nonnull %33, ptr nonnull @of_9_join_0_3_buff_1, i32 2048)
  tail call void @llvm.aie2p.release(i32 16, i32 1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.release(i32 52, i32 1)
  %34 = add i32 %28, 1
