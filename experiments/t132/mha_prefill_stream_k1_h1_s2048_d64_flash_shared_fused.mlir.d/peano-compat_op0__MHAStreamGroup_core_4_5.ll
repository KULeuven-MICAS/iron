...
22:                                               ; preds = %47, %49, %20
  %23 = phi ptr [ %50, %49 ], [ %48, %47 ], [ @of_7_switch_join_4_1_buff_0, %20 ]
...
25:                                               ; preds = %22
  ...
  store i32 %26, ptr @flash_index_4_5
  store i32 %14, ptr getelementptr inbounds nuw (i8, ptr @flash_index_4_5, i64 4)
  %27 = icmp eq i32 %26, 0
...
29:                                               ; preds = %28, %25
  call void @op0_partial_softmax_mode(ptr @of_6_switch_fork_4_1_cons_buff_0, ptr %24, ptr @flash_state_4_5, ptr @flash_index_4_5, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048, i32 3)
...
31:                                               ; preds = %51, %53, %29
  %32 = phi ptr [ %54, %53 ], [ %52, %51 ], [ @flash_scale_4_5_buff_0, %29 ]
  %33 = getelementptr [256 x bfloat], ptr %32, i32 0, i32 0
  br label %34

34:                                               ; preds = %31
  call void @op0_passThroughLine(ptr @flash_state_4_5, ptr %33, i32 256)
...
47:                                               ; preds = %20
  %48 = phi ptr [ @of_7_switch_join_4_1_buff_0, %20 ]
  br label %22

49:                                               ; preds = %20
  %50 = phi ptr [ @of_7_switch_join_4_1_buff_1, %20 ]
  br label %22

51:                                               ; preds = %29
  %52 = phi ptr [ @flash_scale_4_5_buff_0, %29 ]
  br label %31

53:                                               ; preds = %29
  %54 = phi ptr [ @flash_scale_4_5_buff_1, %29 ]
  br label %31
}
