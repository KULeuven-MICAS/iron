; ModuleID = '/home/micas/iron-stream-dse/experiments/long_fused/eq_ours_s32768_c8_h8/mha_prefill_stream_k1_h8_s32768_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_2.ll'
...
6:                                                ; preds = %.preheader, %39
  ...
  %spec.select = select i1 %cond, ptr @of_7_join_2_0_buff_1, ptr @of_7_join_2_0_buff_0
...
15:                                               ; preds = %6, %27
  ...
  %22 = select i1 %cond3, ptr @flash_scale_1_3_buff_1, ptr @flash_scale_1_3_buff_0
  %23 = icmp ne i32 %21, 0
  %24 = zext i1 %23 to i32
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %20, ptr nonnull %spec.select, ptr nonnull %22, i32 64, i32 %24, ptr nonnull @flash_index_1_2)
  %25 = icmp eq i32 %21, 511
  br i1 %25, label %26, label %27

26:                                               ; preds = %15
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %22, i32 64, ptr nonnull @flash_index_1_2)
  br label %27
