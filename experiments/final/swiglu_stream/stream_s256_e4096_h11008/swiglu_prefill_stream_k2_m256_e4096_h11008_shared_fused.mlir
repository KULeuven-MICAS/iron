module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<256x4096xbf16>, %arg1: memref<4096x11008xbf16>, %arg2: memref<4096x11008xbf16>, %arg3: memref<256x11008xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x4096xbf16> offset = 0 len = 524288 sizes = [43, 128, 128, 32] strides = [0, 32, 4096, 1])
        aie.end
      ...
      %6 = aiex.dma_configure_task_for @of_10_mem {
        aie.dma_bd(%arg3 : memref<256x11008xbf16> offset = 0 len = 1409024 sizes = [2, 172, 128, 64] strides = [1409024, 64, 11008, 1])
        aie.end
      ...
      %13 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x4096xbf16> offset = 524288 len = 524288 sizes = [43, 128, 128, 32] strides = [0, 32, 4096, 1])
        aie.end
    ...
    aie.objectfifo @of_3_distribute_0_1(%mem_tile_5_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_2_3, %tile_0_3}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    ...
    aie.objectfifo @of_3_distribute_1_3(%mem_tile_7_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_1_5, %tile_3_5}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
    ...
    aie.objectfifo @of_4_broadcast_0_0(%mem_tile_0_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_0_2, %tile_0_3, %tile_0_4, %tile_0_5}, [2 : i32, 2 : i32, 2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
    ...
    aie.objectfifo @of_5_broadcast_0_0(%mem_tile_2_1 dimensionsToStream [<size = 4, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%tile_2_2, %tile_2_3, %tile_2_4, %tile_2_5}, [2 : i32, 2 : i32, 2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x64xbf16>>  
  ...
  aie.device(npu2) @op1__SwiGLUStreamGroup {
    ...
    %mem_tile_0_1 = aie.tile(0, 1)
    %mem_tile_6_1 = aie.tile(6, 1)
    aie.runtime_sequence(%arg0: memref<256x11008xbf16>, %arg1: memref<11008x4096xbf16>, %arg2: memref<256x4096xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x11008xbf16> offset = 0 len = 1409024 sizes = [32, 172, 128, 64] strides = [0, 64, 11008, 1])
        aie.end
      ...
      %10 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x11008xbf16> offset = 1409024 len = 1409024 sizes = [32, 172, 128, 64] strides = [0, 64, 11008, 1])
        aie.end
    ...
    aie.objectfifo @of_1_mem_0(%shim_noc_tile_5_0, {%mem_tile_5_1}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x32xbf16>>  
    ...
    aie.objectfifo @of_3_broadcast_0_0(%mem_tile_5_1 dimensionsToStream [<size = 8, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_6_2, %tile_6_3, %tile_6_4, %tile_6_5}, [2 : i32, 2 : i32, 2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<64x32xbf16>>  
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<136314880xbf16>, %arg1: memref<1048576xbf16>, %arg2: memref<2818048xbf16>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        %subview = memref.subview %arg0[0] [1048576] [1] : memref<136314880xbf16> to memref<1048576xbf16>
        ...
        %subview_0 = memref.subview %arg0[1048576] [45088768] [1] : memref<136314880xbf16> to memref<45088768xbf16, strided<[1], offset: 1048576>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [4096, 11008], strides: [11008, 1] : memref<45088768xbf16, strided<[1], offset: 1048576>> to memref<4096x11008xbf16>
        %subview_2 = memref.subview %arg0[46137344] [45088768] [1] : memref<136314880xbf16> to memref<45088768xbf16, strided<[1], offset: 46137344>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [4096, 11008], strides: [11008, 1] : memref<45088768xbf16, strided<[1], offset: 46137344>> to memref<4096x11008xbf16>
        %subview_4 = memref.subview %arg2[0] [2818048] [1] : memref<2818048xbf16> to memref<2818048xbf16>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [256, 11008], strides: [11008, 1] : memref<2818048xbf16> to memref<256x11008xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5) : (memref<256x4096xbf16>, memref<4096x11008xbf16>, memref<4096x11008xbf16>, memref<256x11008xbf16>)
      }
      aiex.configure @op1__SwiGLUStreamGroup {
        %subview = memref.subview %arg2[0] [2818048] [1] : memref<2818048xbf16> to memref<2818048xbf16>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [256, 11008], strides: [11008, 1] : memref<2818048xbf16> to memref<256x11008xbf16>
        %subview_0 = memref.subview %arg0[91226112] [45088768] [1] : memref<136314880xbf16> to memref<45088768xbf16, strided<[1], offset: 91226112>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [11008, 4096], strides: [4096, 1] : memref<45088768xbf16, strided<[1], offset: 91226112>> to memref<11008x4096xbf16>
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3) : (memref<256x11008xbf16>, memref<11008x4096xbf16>, memref<256x4096xbf16>)
      }
    }
  }
}
