; ModuleID = '/home/micas/iron-stream-dse/experiments/final/swiglu_stream/stream_s512_e4096_h11008/swiglu_prefill_stream_k2_m512_e4096_h11008_shared_fused.mlir.d/peano-linked_op0__SwiGLUStreamGroup_core_5_2.ll'
...
7:                                                ; preds = %7, %.preheader
  ...
  %19 = select i1 %cond2.1, ptr @of_7_switch_join_0_1_cons_buff_1, ptr @of_7_switch_join_0_1_cons_buff_0
  ...
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 17, i32 -1)
  tail call void @op0_eltwise_mul_bf16_vector(ptr nonnull @of_8_unicast_0_buff_1, ptr nonnull %19, ptr nonnull @of_9_join_0_0_buff_1, i32 2048)
  tail call void @llvm.aie2p.release(i32 16, i32 1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.release(i32 52, i32 1)
  %20 = add i32 %14, 1
