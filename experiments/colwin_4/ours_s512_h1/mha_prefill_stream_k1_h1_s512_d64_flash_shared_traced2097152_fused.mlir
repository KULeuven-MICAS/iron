module {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<98304xbf16>, %arg1: memref<32768xbf16>, %arg2: memref<1xbf16>, %arg3: memref<1xbf16>, %arg4: memref<2097152xi8>) {
      aiex.configure @op0__MHAStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5, %arg4) : (memref<512x64xbf16>, memref<64x512xbf16>, memref<512x64xbf16>, memref<512x64xbf16>, memref<2097152xi8>)
      }
