module {
  ...
  aie.device(npu2) @op1__SwiGLUStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<256x2048xbf16>, %arg1: memref<256x2048xbf16>) {
      aie.trace.host_config {buffer_size = 524288 : i32}
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<3276800xbf16>, %arg1: memref<131072xbf16>, %arg2: memref<2097152xbf16>, %arg3: memref<524288xi8>) {
      ...
      aiex.configure @op2__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %arg3) : (memref<256x2048xbf16>, memref<256x2048xbf16>, memref<256x2048xbf16>, memref<524288xi8>)
      }
