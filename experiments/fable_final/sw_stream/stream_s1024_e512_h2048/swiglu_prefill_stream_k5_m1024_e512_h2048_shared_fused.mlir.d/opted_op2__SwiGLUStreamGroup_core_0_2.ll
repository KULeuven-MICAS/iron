; ModuleID = '/home/micas/iron-stream-dse/experiments/fable_final/sw_stream/stream_s1024_e512_h2048/swiglu_prefill_stream_k5_m1024_e512_h2048_shared_fused.mlir.d/peano-linked_op2__SwiGLUStreamGroup_core_0_2.ll'
...
@switch.table.core_0_2 = private unnamed_addr constant [3 x ptr] [ptr @of_3_unicast_0_0_cons_buff_1, ptr @of_3_unicast_0_0_cons_buff_2, ptr @of_3_unicast_0_0_cons_buff_3], align 4
@switch.table.core_0_2.1 = private unnamed_addr constant [3 x ptr] [ptr @of_2_unicast_0_0_cons_buff_1, ptr @of_2_unicast_0_0_cons_buff_2, ptr @of_2_unicast_0_0_cons_buff_3], align 4
...
switch.lookup:                                    ; preds = %5
  ...
  %switch.gep = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_0_2, i20 0, i20 %11
  %switch.load = load ptr, ptr %switch.gep, align 4
  br label %12

12:                                               ; preds = %switch.lookup, %5
  %13 = phi ptr [ @of_3_unicast_0_0_cons_buff_0, %5 ], [ %switch.load, %switch.lookup ]
...
switch.lookup7:                                   ; preds = %12
  ...
  %switch.gep9 = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_0_2.1, i20 0, i20 %15
  %switch.load10 = load ptr, ptr %switch.gep9, align 4
  br label %16

16:                                               ; preds = %switch.lookup7, %12
  %17 = phi ptr [ @of_2_unicast_0_0_cons_buff_0, %12 ], [ %switch.load10, %switch.lookup7 ]
