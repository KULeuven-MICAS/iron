; ModuleID = '/home/micas/iron-stream-dse/experiments/fable_final/sw_iron/iron_s1024_e512_h2048/swiglu_prefill_s1024_e512_h2048_fused.mlir.d/peano-linked_op3_GEMM_core_3_5.ll'
...
1:                                                ; preds = %0, %._crit_edge13
  ...
  %6 = load i32, ptr @rtp3_3, align 4
  %7 = load i32, ptr getelementptr inbounds nuw (i8, ptr @rtp3_3, i20 4), align 4
  %8 = sext i32 %7 to i64
  %9 = sext i32 %6 to i64
  %10 = icmp sgt i32 %7, 0
...
.lr.ph:                                           ; preds = %12, %.lr.ph
  ...
  %20 = select i1 %cond2, ptr @B_L2L1_3_3_cons_buff_1, ptr @B_L2L1_3_3_cons_buff_0
