; ModuleID = '/home/micas/iron-stream-dse/experiments/fable_final/sw_iron/iron_s2048_e512_h2048/swiglu_prefill_s2048_e512_h2048_fused.mlir.d/peano-linked_op3_GEMM_core_7_4.ll'
source_filename = "LLVMDialectModule"
target datalayout = "e-m:e-p:20:32-i1:8:32-i8:8:32-i16:16:32-i32:32:32-f32:32:32-i64:32-f64:32-a:0:32-n32"
target triple = "aie2p"

@rtp2_7 = local_unnamed_addr global [2 x i32] zeroinitializer
...
1:                                                ; preds = %0, %._crit_edge13
  ...
  %6 = load i32, ptr @rtp2_7, align 4
  %7 = load i32, ptr getelementptr inbounds nuw (i8, ptr @rtp2_7, i20 4), align 4
  %8 = sext i32 %7 to i64
  %9 = sext i32 %6 to i64
  %10 = icmp sgt i32 %7, 0
...
.lr.ph:                                           ; preds = %12, %.lr.ph
  ...
  %spec.select5 = select i1 %cond1, ptr @A_L2L1_2_7_cons_buff_1, ptr @A_L2L1_2_7_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond2 = icmp eq i32 %17, 1
  %20 = select i1 %cond2, ptr @B_L2L1_7_2_cons_buff_1, ptr @B_L2L1_7_2_cons_buff_0
