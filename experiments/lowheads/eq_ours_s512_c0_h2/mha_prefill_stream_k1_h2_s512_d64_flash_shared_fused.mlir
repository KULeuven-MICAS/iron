  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<196608xbf16>, %arg1: memref<65536xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        ...
        %subview_2 = memref.subview %arg0[131072] [32768] [1] : memref<196608xbf16> to memref<32768xbf16, strided<[1], offset: 131072>>
        ...
        %subview_4 = memref.subview %arg1[0] [32768] [1] : memref<65536xbf16> to memref<32768xbf16>
        ...
        %subview_6 = memref.subview %arg0[32768] [32768] [1] : memref<196608xbf16> to memref<32768xbf16, strided<[1], offset: 32768>>
        ...
        %subview_8 = memref.subview %arg0[98304] [32768] [1] : memref<196608xbf16> to memref<32768xbf16, strided<[1], offset: 98304>>
        %reinterpret_cast_9 = memref.reinterpret_cast %subview_8 to offset: [0], sizes: [64, 512], strides: [512, 1] : memref<32768xbf16, strided<[1], offset: 98304>> to memref<64x512xbf16>
        %subview_10 = memref.subview %arg0[163840] [32768] [1] : memref<196608xbf16> to memref<32768xbf16, strided<[1], offset: 163840>>
        %reinterpret_cast_11 = memref.reinterpret_cast %subview_10 to offset: [0], sizes: [512, 64], strides: [64, 1] : memref<32768xbf16, strided<[1], offset: 163840>> to memref<512x64xbf16>
        %subview_12 = memref.subview %arg1[32768] [32768] [1] : memref<65536xbf16> to memref<32768xbf16, strided<[1], offset: 32768>>
