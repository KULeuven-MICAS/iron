; ModuleID = '/home/micas/iron-stream-dse/experiments/ctx_4/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_4.ll'
...
@switch.table.core_1_4 = private unnamed_addr constant [3 x ptr] [ptr @of_5_broadcast_0_0_1_cons_buff_1, ptr @of_5_broadcast_0_0_1_cons_buff_2, ptr @of_5_broadcast_0_0_1_cons_buff_3], align 4
@switch.table.core_1_4.1 = private unnamed_addr constant [3 x ptr] [ptr @flash_scale_1_3_buff_1, ptr @flash_scale_1_3_buff_2, ptr @flash_scale_1_3_buff_3], align 4
@switch.table.core_1_4.2 = private unnamed_addr constant [3 x ptr] [ptr @flash_scale_1_5_buff_1, ptr @flash_scale_1_5_buff_2, ptr @flash_scale_1_5_buff_3], align 4
...
switch.lookup:                                    ; preds = %16
  ...
  %switch.gep = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_1_4, i20 0, i20 %24
  %switch.load = load ptr, ptr %switch.gep, align 4
  br label %25

25:                                               ; preds = %switch.lookup, %16
  %26 = phi ptr [ @of_5_broadcast_0_0_1_cons_buff_0, %16 ], [ %switch.load, %switch.lookup ]
  tail call void @llvm.aie2p.acquire(i32 1, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 33, i32 -1)
  %cond2 = icmp eq i32 %20, 1
  %spec.select = select i1 %cond2, ptr @of_8_switch_join_1_0_buff_1, ptr @of_8_switch_join_1_0_buff_0
  %cond3 = icmp eq i32 %19, 1
  %27 = select i1 %cond3, ptr @of_8_switch_join_1_1_buff_1, ptr @of_8_switch_join_1_1_buff_0
...
35:                                               ; preds = %25, %61
  ...
  %spec.select18 = select i1 %cond4, ptr @of_9_unicast_1_buff_1, ptr @of_9_unicast_1_buff_0
  %.pn17 = select i1 %cond4, ptr %27, ptr %spec.select
  %39 = trunc nuw nsw i64 %38 to i32
  %40 = shl nuw nsw i32 %39, 3
  %.reass = add nuw nsw i32 %40, %invariant.op
  store i32 %28, ptr @flash_index_1_4, align 4
...
switch.lookup38:                                  ; preds = %41
  ...
  %switch.gep40 = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_1_4.1, i20 0, i20 %43
  %switch.load41 = load ptr, ptr %switch.gep40, align 4
  br label %44

44:                                               ; preds = %switch.lookup38, %41
  %45 = phi ptr [ @flash_scale_1_3_buff_0, %41 ], [ %switch.load41, %switch.lookup38 ]
  tail call void @op0_matmul_PV(ptr nonnull %.pn17, ptr nonnull %26, ptr nonnull %spec.select18, ptr nonnull %45, i32 64, i32 %30, ptr nonnull @flash_index_1_4)
  br i1 %31, label %46, label %47

46:                                               ; preds = %44
  tail call void @op0_rescale_O(ptr nonnull %spec.select18, ptr nonnull %45, i32 64, ptr nonnull @flash_index_1_4)
  br label %47
...
switch.lookup42:                                  ; preds = %51
  ...
  %switch.gep44 = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_1_4.2, i20 0, i20 %53
  %switch.load45 = load ptr, ptr %switch.gep44, align 4
  br label %54

54:                                               ; preds = %switch.lookup42, %51
  %55 = phi ptr [ @flash_scale_1_5_buff_0, %51 ], [ %switch.load45, %switch.lookup42 ]
  tail call void @op0_matmul_PV(ptr nonnull %.pn17, ptr nonnull %26, ptr nonnull %spec.select18, ptr nonnull %55, i32 64, i32 %33, ptr nonnull @flash_index_1_4)
  br i1 %34, label %56, label %57

56:                                               ; preds = %54
  tail call void @op0_rescale_O(ptr nonnull %spec.select18, ptr nonnull %55, i32 64, ptr nonnull @flash_index_1_4)
  br label %57
