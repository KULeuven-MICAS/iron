...
@of_0_mem_0_cons_buff_1 = external global [16 x [4 x [32 x [32 x bfloat]]]]
@of_0_mem_0_cons_buff_0 = external global [16 x [4 x [32 x [32 x bfloat]]]]
@of_0_mem_1_cons_buff_1 = external global [16 x [4 x [32 x [32 x bfloat]]]]
@of_0_mem_1_cons_buff_0 = external global [16 x [4 x [32 x [32 x bfloat]]]]
...
9:                                                ; preds = %5
  call void @llvm.aie2p.acquire(i32 48, i32 -8)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_3_buff_0)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_3_buff_1)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_3_buff_2)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_3_buff_3)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_3_buff_4)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_3_buff_5)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_3_buff_6)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_3_buff_7)
  br label %10

10:                                               ; preds = %44, %9
  %11 = phi i64 [ %45, %44 ], [ 0, %9 ]
  %12 = phi i32 [ %17, %44 ], [ %7, %9 ]
...
15:                                               ; preds = %42, %14
  %16 = phi i64 [ %43, %42 ], [ 0, %14 ]
  %17 = phi i32 [ %25, %42 ], [ %12, %14 ]
...
20:                                               ; preds = %51, %53, %55, %57, %59, %61, %63, %65, %19
  %21 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %66, %65 ], [ %64, %63 ], [ %62, %61 ], [ %60, %59 ], [ %58, %57 ], [ %56, %55 ], [ %54, %53 ], [ %52, %51 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_3_buff_0, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %22
...
23:                                               ; preds = %36, %22
  %24 = phi i64 [ %41, %36 ], [ 0, %22 ]
  %25 = phi i32 [ %40, %36 ], [ %17, %22 ]
...
28:                                               ; preds = %67, %69, %27
  %29 = phi ptr [ %70, %69 ], [ %68, %67 ], [ @of_11_broadcast_3_0_cons_buff_0, %27 ]
  %30 = getelementptr [32 x [64 x bfloat]], ptr %29, i32 0, i32 0, i32 0
  br label %31
...
33:                                               ; preds = %71, %73, %31
  %34 = phi ptr [ %74, %73 ], [ %72, %71 ], [ @of_7_broadcast_0_0_3_cons_buff_0, %31 ]
  %35 = getelementptr [64 x [32 x bfloat]], ptr %34, i32 0, i32 0, i32 0
  br label %36

36:                                               ; preds = %33
  %37 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %21, 1
  call void @op0_matmul_bf16_bf16_32_64_32(ptr %30, ptr %35, ptr %37)
...
46:                                               ; preds = %10
  call void @llvm.aie2p.release(i32 49, i32 8)
  %47 = add i64 %6, 1
  br label %5
...
51:                                               ; preds = %19
  %52 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_3_buff_0, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

53:                                               ; preds = %19
  %54 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_3_buff_1, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

55:                                               ; preds = %19
  %56 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_3_buff_2, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

57:                                               ; preds = %19
  %58 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_3_buff_3, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

59:                                               ; preds = %19
  %60 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_3_buff_4, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

61:                                               ; preds = %19
  %62 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_3_buff_5, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

63:                                               ; preds = %19
  %64 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_3_buff_6, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

65:                                               ; preds = %19
  %66 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_3_buff_7, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

67:                                               ; preds = %27
  %68 = phi ptr [ @of_11_broadcast_3_0_cons_buff_0, %27 ]
  br label %28

69:                                               ; preds = %27
  %70 = phi ptr [ @of_11_broadcast_3_0_cons_buff_1, %27 ]
  br label %28

71:                                               ; preds = %31
  %72 = phi ptr [ @of_7_broadcast_0_0_3_cons_buff_0, %31 ]
  br label %33

73:                                               ; preds = %31
  %74 = phi ptr [ @of_7_broadcast_0_0_3_cons_buff_1, %31 ]
  br label %33
}
