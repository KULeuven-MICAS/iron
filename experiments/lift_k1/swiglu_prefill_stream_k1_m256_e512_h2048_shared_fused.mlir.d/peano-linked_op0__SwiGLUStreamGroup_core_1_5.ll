...
21:                                               ; preds = %58, %60, %19
  %22 = phi ptr [ %61, %60 ], [ %59, %58 ], [ @of_8_switch_join_3_1_buff_0, %19 ]
...
32:                                               ; preds = %62, %64, %30
  %33 = phi ptr [ %65, %64 ], [ %63, %62 ], [ @of_5_broadcast_1_0_3_cons_buff_0, %30 ]
...
37:                                               ; preds = %66, %68, %35
  %38 = phi ptr [ %69, %68 ], [ %67, %66 ], [ @of_4_distribute_1_3_1_cons_buff_0, %35 ]
...
58:                                               ; preds = %19
  %59 = phi ptr [ @of_8_switch_join_3_1_buff_0, %19 ]
  br label %21

60:                                               ; preds = %19
  %61 = phi ptr [ @of_8_switch_join_3_1_buff_1, %19 ]
  br label %21
...
66:                                               ; preds = %35
  %67 = phi ptr [ @of_4_distribute_1_3_1_cons_buff_0, %35 ]
  br label %37

68:                                               ; preds = %35
  %69 = phi ptr [ @of_4_distribute_1_3_1_cons_buff_1, %35 ]
  br label %37
}
