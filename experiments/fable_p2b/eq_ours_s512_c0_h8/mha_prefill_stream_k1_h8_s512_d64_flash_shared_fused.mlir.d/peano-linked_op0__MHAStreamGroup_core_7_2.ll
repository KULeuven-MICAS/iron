...
14:                                               ; preds = %37, %39, %12
  %15 = phi ptr [ %40, %39 ], [ %38, %37 ], [ @of_6_unicast_7_buff_0, %12 ]
...
19:                                               ; preds = %41, %43, %17
  %20 = phi ptr [ %44, %43 ], [ %42, %41 ], [ @of_4_broadcast_0_0_7_cons_buff_0, %17 ]
...
25:                                               ; preds = %22
  call void @op0_matmul_bf16_bf16_64_64_64(ptr @of_3_unicast_7_0_cons_buff_0, ptr %21, ptr %16)
  br label %26
...
37:                                               ; preds = %12
  %38 = phi ptr [ @of_6_unicast_7_buff_0, %12 ]
  br label %14

39:                                               ; preds = %12
  %40 = phi ptr [ @of_6_unicast_7_buff_1, %12 ]
  br label %14

41:                                               ; preds = %17
  %42 = phi ptr [ @of_4_broadcast_0_0_7_cons_buff_0, %17 ]
  br label %19

43:                                               ; preds = %17
  %44 = phi ptr [ @of_4_broadcast_0_0_7_cons_buff_1, %17 ]
  br label %19
}
