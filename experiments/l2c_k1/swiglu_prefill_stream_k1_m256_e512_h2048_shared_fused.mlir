module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.objectfifo @of_4_distribute_0_0(%mem_tile_5_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_0_2, %tile_2_2}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    ...
    aie.objectfifo @of_4_distribute_0_2(%mem_tile_5_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_0_4, %tile_2_4}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    aie.objectfifo @of_4_distribute_0_3(%mem_tile_5_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_2_5, %tile_0_5}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
    ...
    aie.objectfifo @of_4_distribute_1_3(%mem_tile_7_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_1_5, %tile_3_5}, [2 : i32, 2 : i32, 2 : i32]) {repeat_count = 256 : i32} : !aie.objectfifo<memref<32x32xbf16>>  
