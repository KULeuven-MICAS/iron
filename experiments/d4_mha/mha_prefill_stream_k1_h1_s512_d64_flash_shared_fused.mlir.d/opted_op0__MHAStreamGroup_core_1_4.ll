; ModuleID = '/home/micas/iron-stream-dse/experiments/d4_mha/mha_prefill_stream_k1_h1_s512_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_4.ll'
...
@switch.table.core_1_4 = private unnamed_addr constant [3 x ptr] [ptr @of_8_switch_join_1_0_buff_1, ptr @of_8_switch_join_1_0_buff_2, ptr @of_8_switch_join_1_0_buff_3], align 4
@switch.table.core_1_4.1 = private unnamed_addr constant [3 x ptr] [ptr @of_8_switch_join_1_1_buff_1, ptr @of_8_switch_join_1_1_buff_2, ptr @of_8_switch_join_1_1_buff_3], align 4
...
switch.lookup:                                    ; preds = %8
  ...
  %switch.gep = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_1_4, i20 0, i20 %16
  %switch.load = load ptr, ptr %switch.gep, align 4
  br label %17

17:                                               ; preds = %switch.lookup, %8
  %18 = phi ptr [ @of_8_switch_join_1_0_buff_0, %8 ], [ %switch.load, %switch.lookup ]
...
switch.lookup36:                                  ; preds = %17
  ...
  %switch.gep38 = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_1_4.1, i20 0, i20 %20
  %switch.load39 = load ptr, ptr %switch.gep38, align 4
  br label %21

21:                                               ; preds = %switch.lookup36, %17
  %22 = phi ptr [ @of_8_switch_join_1_1_buff_0, %17 ], [ %switch.load39, %switch.lookup36 ]
...
30:                                               ; preds = %21, %49
  ...
  %spec.select19 = select i1 %cond3, ptr @of_9_unicast_1_buff_1, ptr @of_9_unicast_1_buff_0
  %.pn18 = select i1 %cond3, ptr %22, ptr %18
  %34 = trunc nuw nsw i64 %33 to i32
  %35 = shl nuw nsw i32 %34, 2
  %36 = or disjoint i32 %35, 1
  store i32 %23, ptr @flash_index_1_4, align 4
  store i32 %36, ptr getelementptr inbounds nuw (i8, ptr @flash_index_1_4, i20 4), align 4
  br i1 %cond3, label %43, label %37

37:                                               ; preds = %30
  tail call void @llvm.aie2p.acquire(i32 5, i32 -1)
  %cond4 = icmp eq i32 %32, 1
  %spec.select20 = select i1 %cond4, ptr @flash_scale_1_3_1_4_buff_1, ptr @flash_scale_1_3_1_4_buff_0
  tail call void @op0_matmul_PV(ptr nonnull %.pn18, ptr nonnull %spec.select, ptr nonnull %spec.select19, ptr nonnull %spec.select20, i32 64, i32 %25, ptr nonnull @flash_index_1_4)
  br i1 %26, label %38, label %39

38:                                               ; preds = %37
  tail call void @op0_rescale_O(ptr nonnull %spec.select19, ptr nonnull %spec.select20, i32 64, ptr nonnull @flash_index_1_4)
  br label %39
...
43:                                               ; preds = %30
  ...
  %spec.select21 = select i1 %cond5, ptr @flash_scale_1_5_1_4_buff_1, ptr @flash_scale_1_5_1_4_buff_0
  tail call void @op0_matmul_PV(ptr nonnull %.pn18, ptr nonnull %spec.select, ptr nonnull %spec.select19, ptr nonnull %spec.select21, i32 64, i32 %28, ptr nonnull @flash_index_1_4)
  br i1 %29, label %44, label %45

44:                                               ; preds = %43
  tail call void @op0_rescale_O(ptr nonnull %spec.select19, ptr nonnull %spec.select21, i32 64, ptr nonnull @flash_index_1_4)
  br label %45
