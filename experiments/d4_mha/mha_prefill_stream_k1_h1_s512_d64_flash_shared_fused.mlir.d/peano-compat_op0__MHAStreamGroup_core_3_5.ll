...
15:                                               ; preds = %46, %48, %50, %52, %13
  %16 = phi ptr [ %53, %52 ], [ %51, %50 ], [ %49, %48 ], [ %47, %46 ], [ @of_8_switch_join_3_1_buff_0, %13 ]
...
20:                                               ; preds = %54, %56, %18
  %21 = phi ptr [ %57, %56 ], [ %55, %54 ], [ @of_7_distribute_3_1_cons_buff_0, %18 ]
...
23:                                               ; preds = %20
  ...
  store i32 7, ptr getelementptr inbounds nuw (i8, ptr @flash_index_3_5, i64 4)
  %25 = icmp eq i32 %24, 0
...
27:                                               ; preds = %26, %23
  call void @op0_partial_softmax_mode(ptr %22, ptr %17, ptr @flash_state_3_5, ptr @flash_index_3_5, bfloat 0xR3FB9, i32 64, i32 64, i32 512, i32 512, i32 2)
...
29:                                               ; preds = %58, %60, %27
  %30 = phi ptr [ %61, %60 ], [ %59, %58 ], [ @flash_scale_3_5_3_4_buff_0, %27 ]
...
50:                                               ; preds = %13
  %51 = phi ptr [ @of_8_switch_join_3_1_buff_2, %13 ]
  br label %15

52:                                               ; preds = %13
  %53 = phi ptr [ @of_8_switch_join_3_1_buff_3, %13 ]
  br label %15

54:                                               ; preds = %18
  %55 = phi ptr [ @of_7_distribute_3_1_cons_buff_0, %18 ]
  br label %20

56:                                               ; preds = %18
  %57 = phi ptr [ @of_7_distribute_3_1_cons_buff_1, %18 ]
  br label %20

58:                                               ; preds = %27
  %59 = phi ptr [ @flash_scale_3_5_3_4_buff_0, %27 ]
  br label %29

60:                                               ; preds = %27
  %61 = phi ptr [ @flash_scale_3_5_3_4_buff_1, %27 ]
  br label %29
}
