...
1:                                                ; preds = %107, %0
  %2 = phi i64 [ %108, %107 ], [ 0, %0 ]
  %3 = phi i32 [ %12, %107 ], [ 0, %0 ]
  %4 = phi i32 [ %13, %107 ], [ 0, %0 ]
  %5 = phi i32 [ %14, %107 ], [ 0, %0 ]
  %6 = phi i32 [ %15, %107 ], [ 0, %0 ]
  %7 = phi i32 [ %16, %107 ], [ 0, %0 ]
...
10:                                               ; preds = %96, %9
  %11 = phi i64 [ %106, %96 ], [ 0, %9 ]
  %12 = phi i32 [ %105, %96 ], [ %3, %9 ]
  %13 = phi i32 [ %99, %96 ], [ %4, %9 ]
  %14 = phi i32 [ %102, %96 ], [ %5, %9 ]
  %15 = phi i32 [ %49, %96 ], [ %6, %9 ]
  %16 = phi i32 [ %50, %96 ], [ %7, %9 ]
...
20:                                               ; preds = %110, %112, %18
  %21 = phi ptr [ %113, %112 ], [ %111, %110 ], [ @of_5_broadcast_0_0_0_cons_buff_0, %18 ]
...
25:                                               ; preds = %114, %116, %118, %120, %23
  %26 = phi ptr [ %121, %120 ], [ %119, %118 ], [ %117, %116 ], [ %115, %114 ], [ @of_8_switch_join_0_0_buff_0, %23 ]
...
36:                                               ; preds = %122, %124, %126, %128, %34
  %37 = phi ptr [ %129, %128 ], [ %127, %126 ], [ %125, %124 ], [ %123, %122 ], [ @of_8_switch_join_0_1_buff_0, %34 ]
...
47:                                               ; preds = %92, %45
  %48 = phi i64 [ %95, %92 ], [ 0, %45 ]
  %49 = phi i32 [ %93, %92 ], [ %15, %45 ]
  %50 = phi i32 [ %94, %92 ], [ %16, %45 ]
...
53:                                               ; preds = %130, %132, %52
  %54 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %133, %132 ], [ %131, %130 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %52 ]
  br label %55
...
56:                                               ; preds = %134, %55
  %57 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %135, %134 ], [ %33, %55 ]
  %58 = trunc i64 %48 to i32
  %59 = mul i32 %58, 4
  store i32 %46, ptr @flash_index_0_4
  store i32 %59, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_4, i64 4)
...
62:                                               ; preds = %136, %138, %60
  %63 = phi ptr [ %139, %138 ], [ %137, %136 ], [ @flash_scale_0_3_0_4_buff_0, %60 ]
  %64 = getelementptr [256 x bfloat], ptr %63, i32 0, i32 0
  br label %65

65:                                               ; preds = %62
  %66 = icmp ne i32 %46, 0
  %67 = zext i1 %66 to i32
  %68 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %57, 1
  %69 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %54, 1
  call void @op0_matmul_PV(ptr %68, ptr %22, ptr %69, ptr %64, i32 64, i32 %67, ptr @flash_index_0_4)
  %70 = icmp eq i32 %46, 7
  br i1 %70, label %71, label %72

71:                                               ; preds = %65
  call void @op0_rescale_O(ptr %69, ptr %64, i32 64, ptr @flash_index_0_4)
  br label %72
...
78:                                               ; preds = %140, %142, %76
  %79 = phi ptr [ %143, %142 ], [ %141, %140 ], [ @flash_scale_0_5_0_4_buff_0, %76 ]
  %80 = getelementptr [256 x bfloat], ptr %79, i32 0, i32 0
  br label %81
...
81:                                               ; preds = %78
  ...
  %85 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %54, 1
  call void @op0_matmul_PV(ptr %84, ptr %22, ptr %85, ptr %80, i32 64, i32 %83, ptr @flash_index_0_4)
  %86 = icmp eq i32 %46, 7
  br i1 %86, label %87, label %88

87:                                               ; preds = %81
  call void @op0_rescale_O(ptr %85, ptr %80, i32 64, ptr @flash_index_0_4)
  br label %88
...
92:                                               ; preds = %72, %88
  %93 = phi i32 [ %49, %88 ], [ %75, %72 ]
  %94 = phi i32 [ %91, %88 ], [ %50, %72 ]
  %95 = add i64 %48, 1
  br label %47
...
110:                                              ; preds = %18
  %111 = phi ptr [ @of_5_broadcast_0_0_0_cons_buff_0, %18 ]
  br label %20

112:                                              ; preds = %18
  %113 = phi ptr [ @of_5_broadcast_0_0_0_cons_buff_1, %18 ]
  br label %20

114:                                              ; preds = %23
  %115 = phi ptr [ @of_8_switch_join_0_0_buff_0, %23 ]
  br label %25

116:                                              ; preds = %23
  %117 = phi ptr [ @of_8_switch_join_0_0_buff_1, %23 ]
  br label %25

118:                                              ; preds = %23
  %119 = phi ptr [ @of_8_switch_join_0_0_buff_2, %23 ]
  br label %25

120:                                              ; preds = %23
  %121 = phi ptr [ @of_8_switch_join_0_0_buff_3, %23 ]
  br label %25

122:                                              ; preds = %34
  %123 = phi ptr [ @of_8_switch_join_0_1_buff_0, %34 ]
  br label %36

124:                                              ; preds = %34
  %125 = phi ptr [ @of_8_switch_join_0_1_buff_1, %34 ]
  br label %36

126:                                              ; preds = %34
  %127 = phi ptr [ @of_8_switch_join_0_1_buff_2, %34 ]
  br label %36

128:                                              ; preds = %34
  %129 = phi ptr [ @of_8_switch_join_0_1_buff_3, %34 ]
  br label %36

130:                                              ; preds = %52
  %131 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %52 ]
  br label %53

132:                                              ; preds = %52
  %133 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_0_buff_1, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %52 ]
  br label %53

134:                                              ; preds = %55
  %135 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %44, %55 ]
  br label %56

136:                                              ; preds = %60
  %137 = phi ptr [ @flash_scale_0_3_0_4_buff_0, %60 ]
  br label %62

138:                                              ; preds = %60
  %139 = phi ptr [ @flash_scale_0_3_0_4_buff_1, %60 ]
  br label %62

140:                                              ; preds = %76
  %141 = phi ptr [ @flash_scale_0_5_0_4_buff_0, %76 ]
  br label %78

142:                                              ; preds = %76
  %143 = phi ptr [ @flash_scale_0_5_0_4_buff_1, %76 ]
  br label %78
}
