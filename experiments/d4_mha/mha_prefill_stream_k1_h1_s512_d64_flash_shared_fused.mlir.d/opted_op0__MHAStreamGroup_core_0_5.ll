; ModuleID = '/home/micas/iron-stream-dse/experiments/d4_mha/mha_prefill_stream_k1_h1_s512_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_5.ll'
...
@switch.table.core_0_5 = private unnamed_addr constant [3 x ptr] [ptr @of_8_switch_join_0_1_buff_1, ptr @of_8_switch_join_0_1_buff_2, ptr @of_8_switch_join_0_1_buff_3], align 4
...
switch.lookup:                                    ; preds = %5
  ...
  %switch.gep = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_0_5, i20 0, i20 %11
  %switch.load = load ptr, ptr %switch.gep, align 4
  br label %12

12:                                               ; preds = %switch.lookup, %5
  %13 = phi ptr [ @of_8_switch_join_0_1_buff_0, %5 ], [ %switch.load, %switch.lookup ]
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond = icmp eq i32 %7, 1
  %spec.select = select i1 %cond, ptr @of_7_distribute_0_1_cons_buff_1, ptr @of_7_distribute_0_1_cons_buff_0
  %14 = trunc nuw nsw i64 %9 to i32
  store i32 %14, ptr @flash_index_0_5, align 4
  store i32 4, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_5, i20 4), align 4
  %15 = icmp eq i32 %14, 0
...
17:                                               ; preds = %16, %12
  tail call void @op0_partial_softmax_mode(ptr nonnull %spec.select, ptr nonnull %13, ptr nonnull @flash_state_0_5, ptr nonnull @flash_index_0_5, bfloat 0xR3FB9, i32 64, i32 64, i32 512, i32 512, i32 2)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %cond1 = icmp eq i32 %6, 1
  %spec.select2 = select i1 %cond1, ptr @flash_scale_0_5_0_4_buff_1, ptr @flash_scale_0_5_0_4_buff_0
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_0_5, ptr nonnull %spec.select2, i32 256)
