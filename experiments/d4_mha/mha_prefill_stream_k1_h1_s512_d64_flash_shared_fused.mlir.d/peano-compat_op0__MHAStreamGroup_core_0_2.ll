...
12:                                               ; preds = %43, %45, %10
  %13 = phi ptr [ %46, %45 ], [ %44, %43 ], [ @of_4_broadcast_0_0_0_cons_buff_0, %10 ]
...
21:                                               ; preds = %47, %49, %20
  %22 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %50, %49 ], [ %48, %47 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %20 ]
  br label %23
...
24:                                               ; preds = %51, %53, %23
  %25 = phi ptr [ %54, %53 ], [ %52, %51 ], [ @of_3_unicast_0_0_cons_buff_0, %23 ]
...
27:                                               ; preds = %24
  ...
  %29 = mul i32 %28, 4
  %30 = icmp sle i32 %16, %29
  br i1 %30, label %31, label %33

31:                                               ; preds = %27
  %32 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %22, 1
  call void @op0_matmul_bf16_bf16_64_64_64(ptr %26, ptr %14, ptr %32)
  br label %33
...
43:                                               ; preds = %10
  %44 = phi ptr [ @of_4_broadcast_0_0_0_cons_buff_0, %10 ]
  br label %12

45:                                               ; preds = %10
  %46 = phi ptr [ @of_4_broadcast_0_0_0_cons_buff_1, %10 ]
  br label %12

47:                                               ; preds = %20
  %48 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %20 ]
  br label %21

49:                                               ; preds = %20
  %50 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_0_relay_1_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %20 ]
  br label %21

51:                                               ; preds = %23
  %52 = phi ptr [ @of_3_unicast_0_0_cons_buff_0, %23 ]
  br label %24

53:                                               ; preds = %23
  %54 = phi ptr [ @of_3_unicast_0_0_cons_buff_1, %23 ]
  br label %24
}
