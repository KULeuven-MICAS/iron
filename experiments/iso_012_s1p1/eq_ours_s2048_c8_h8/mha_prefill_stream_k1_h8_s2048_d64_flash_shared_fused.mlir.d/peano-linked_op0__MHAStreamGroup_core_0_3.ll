...
24:                                               ; preds = %57, %59, %22
  %25 = phi ptr [ %60, %59 ], [ %58, %57 ], [ @of_7_unicast_0_buff_0, %22 ]
...
29:                                               ; preds = %61, %63, %27
  %30 = phi ptr [ %64, %63 ], [ %62, %61 ], [ @of_6_unicast_0_buff_0, %27 ]
...
36:                                               ; preds = %35, %32
  call void @op0_partial_softmax_mode(ptr %31, ptr %26, ptr @flash_state_0_3, ptr @flash_index_0_3, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048, i32 3)
...
57:                                               ; preds = %22
  %58 = phi ptr [ @of_7_unicast_0_buff_0, %22 ]
  br label %24

59:                                               ; preds = %22
  %60 = phi ptr [ @of_7_unicast_0_buff_1, %22 ]
  br label %24

61:                                               ; preds = %27
  %62 = phi ptr [ @of_6_unicast_0_buff_0, %27 ]
  br label %29

63:                                               ; preds = %27
  %64 = phi ptr [ @of_6_unicast_0_buff_1, %27 ]
  br label %29
