...
25:                                               ; preds = %58, %60, %23
  %26 = phi ptr [ %61, %60 ], [ %59, %58 ], [ @of_7_unicast_6_buff_0, %23 ]
...
30:                                               ; preds = %62, %64, %28
  %31 = phi ptr [ %65, %64 ], [ %63, %62 ], [ @of_6_unicast_6_buff_0, %28 ]
...
37:                                               ; preds = %36, %33
  call void @op0_partial_softmax_mode(ptr %32, ptr %27, ptr @flash_state_6_3, ptr @flash_index_6_3, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048, i32 3)
...
58:                                               ; preds = %23
  %59 = phi ptr [ @of_7_unicast_6_buff_0, %23 ]
  br label %25

60:                                               ; preds = %23
  %61 = phi ptr [ @of_7_unicast_6_buff_1, %23 ]
  br label %25

62:                                               ; preds = %28
  %63 = phi ptr [ @of_6_unicast_6_buff_0, %28 ]
  br label %30

64:                                               ; preds = %28
  %65 = phi ptr [ @of_6_unicast_6_buff_1, %28 ]
  br label %30
