; ModuleID = '/home/micas/iron-stream-dse/experiments/three_three/eq_ours_s4096_c8_h32/mha_prefill_stream_k1_h32_s4096_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_7_4.ll'
...
6:                                                ; preds = %.preheader, %39
  ...
  %spec.select = select i1 %cond, ptr @of_9_unicast_7_buff_1, ptr @of_9_unicast_7_buff_0
...
15:                                               ; preds = %6, %27
  ...
  %spec.select5 = select i1 %cond1, ptr @of_8_unicast_7_buff_1, ptr @of_8_unicast_7_buff_0
  ...
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %20, ptr nonnull %spec.select, ptr nonnull %22, i32 64, i32 %24, ptr nonnull @flash_index_7_4)
  %25 = icmp eq i32 %21, 63
  br i1 %25, label %26, label %27

26:                                               ; preds = %15
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %22, i32 64, ptr nonnull @flash_index_7_4)
  br label %27
