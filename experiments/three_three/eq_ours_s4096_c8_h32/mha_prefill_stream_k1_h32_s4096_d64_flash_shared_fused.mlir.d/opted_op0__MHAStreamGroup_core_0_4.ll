; ModuleID = '/home/micas/iron-stream-dse/experiments/three_three/eq_ours_s4096_c8_h32/mha_prefill_stream_k1_h32_s4096_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_4.ll'
...
6:                                                ; preds = %.preheader, %38
  ...
  %spec.select = select i1 %cond, ptr @of_9_unicast_0_buff_1, ptr @of_9_unicast_0_buff_0
...
14:                                               ; preds = %6, %26
  ...
  %spec.select5 = select i1 %cond1, ptr @of_8_unicast_0_buff_1, ptr @of_8_unicast_0_buff_0
  ...
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %19, ptr nonnull %spec.select, ptr nonnull %21, i32 64, i32 %23, ptr nonnull @flash_index_0_4)
  %24 = icmp eq i32 %20, 63
  br i1 %24, label %25, label %26

25:                                               ; preds = %14
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %21, i32 64, ptr nonnull @flash_index_0_4)
  br label %26
...
26:                                               ; preds = %25, %14
  ...
  %37 = icmp samesign ult i64 %18, 63
