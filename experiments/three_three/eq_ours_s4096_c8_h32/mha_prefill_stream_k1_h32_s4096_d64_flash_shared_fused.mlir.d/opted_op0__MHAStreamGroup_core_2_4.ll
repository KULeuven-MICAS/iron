; ModuleID = '/home/micas/iron-stream-dse/experiments/three_three/eq_ours_s4096_c8_h32/mha_prefill_stream_k1_h32_s4096_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_2_4.ll'
...
6:                                                ; preds = %.preheader, %39
  ...
  %spec.select = select i1 %cond, ptr @of_9_unicast_2_buff_1, ptr @of_9_unicast_2_buff_0
...
15:                                               ; preds = %6, %27
  ...
  %spec.select5 = select i1 %cond1, ptr @of_8_unicast_2_buff_1, ptr @of_8_unicast_2_buff_0
