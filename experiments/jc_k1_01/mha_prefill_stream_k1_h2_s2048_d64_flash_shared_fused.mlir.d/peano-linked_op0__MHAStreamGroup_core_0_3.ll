...
17:                                               ; preds = %69, %71, %15
  %18 = phi ptr [ %72, %71 ], [ %70, %69 ], [ @of_7_unicast_0_buff_0, %15 ]
...
42:                                               ; preds = %81, %83, %39
  %43 = phi ptr [ %84, %83 ], [ %82, %81 ], [ @flash_scale_0_2_buff_0, %39 ]
...
45:                                               ; preds = %42
  ...
  call void @op0_matmul_PV(ptr %33, ptr %38, ptr %19, ptr %44, i32 64, i32 %47, ptr @flash_index_0_3)
  %48 = icmp eq i32 %40, 31
  br i1 %48, label %49, label %50

49:                                               ; preds = %45
  call void @op0_rescale_O(ptr %19, ptr %44, i32 64, ptr @flash_index_0_3)
  br label %50
...
69:                                               ; preds = %15
  %70 = phi ptr [ @of_7_unicast_0_buff_0, %15 ]
  br label %17

71:                                               ; preds = %15
  %72 = phi ptr [ @of_7_unicast_0_buff_1, %15 ]
  br label %17
...
81:                                               ; preds = %39
  %82 = phi ptr [ @flash_scale_0_2_buff_0, %39 ]
  br label %42

83:                                               ; preds = %39
  %84 = phi ptr [ @flash_scale_0_2_buff_1, %39 ]
  br label %42
}
