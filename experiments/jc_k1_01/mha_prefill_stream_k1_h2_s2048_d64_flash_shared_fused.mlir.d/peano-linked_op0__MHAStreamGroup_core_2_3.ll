...
17:                                               ; preds = %70, %72, %15
  %18 = phi ptr [ %73, %72 ], [ %71, %70 ], [ @of_7_unicast_2_buff_0, %15 ]
...
43:                                               ; preds = %82, %84, %40
  %44 = phi ptr [ %85, %84 ], [ %83, %82 ], [ @flash_scale_2_2_buff_0, %40 ]
...
46:                                               ; preds = %43
  ...
  call void @op0_matmul_PV(ptr %34, ptr %39, ptr %19, ptr %45, i32 64, i32 %48, ptr @flash_index_2_3)
  %49 = icmp eq i32 %41, 31
  br i1 %49, label %50, label %51

50:                                               ; preds = %46
  call void @op0_rescale_O(ptr %19, ptr %45, i32 64, ptr @flash_index_2_3)
  br label %51
...
70:                                               ; preds = %15
  %71 = phi ptr [ @of_7_unicast_2_buff_0, %15 ]
  br label %17

72:                                               ; preds = %15
  %73 = phi ptr [ @of_7_unicast_2_buff_1, %15 ]
  br label %17
...
82:                                               ; preds = %40
  %83 = phi ptr [ @flash_scale_2_2_buff_0, %40 ]
  br label %43

84:                                               ; preds = %40
  %85 = phi ptr [ @flash_scale_2_2_buff_1, %40 ]
  br label %43
}
