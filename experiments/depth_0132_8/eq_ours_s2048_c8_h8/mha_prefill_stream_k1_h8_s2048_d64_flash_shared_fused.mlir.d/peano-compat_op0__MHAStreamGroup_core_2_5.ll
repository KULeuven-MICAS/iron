...
25:                                               ; preds = %58, %60, %23
  %26 = phi ptr [ %61, %60 ], [ %59, %58 ], [ @of_8_switch_join_2_1_buff_0, %23 ]
...
30:                                               ; preds = %62, %64, %28
  %31 = phi ptr [ %65, %64 ], [ %63, %62 ], [ @of_7_distribute_2_1_cons_buff_0, %28 ]
  %32 = getelementptr [64 x [64 x bfloat]], ptr %31, i32 0, i32 0, i32 0
  br label %33

33:                                               ; preds = %30
  %34 = trunc i64 %18 to i32
  store i32 %34, ptr @flash_index_2_5
  store i32 %16, ptr getelementptr inbounds nuw (i8, ptr @flash_index_2_5, i64 4)
  %35 = icmp eq i32 %34, 0
  br i1 %35, label %36, label %37

36:                                               ; preds = %33
  call void @op0_init_scale_buffer(ptr @flash_state_2_5, i32 64)
  br label %37

37:                                               ; preds = %36, %33
  call void @op0_partial_softmax_mode(ptr %32, ptr %27, ptr @flash_state_2_5, ptr @flash_index_2_5, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048, i32 2)
...
39:                                               ; preds = %66, %68, %70, %72, %74, %76, %78, %80, %37
  %40 = phi ptr [ %81, %80 ], [ %79, %78 ], [ %77, %76 ], [ %75, %74 ], [ %73, %72 ], [ %71, %70 ], [ %69, %68 ], [ %67, %66 ], [ @flash_scale_2_5_buff_0, %37 ]
  %41 = getelementptr [256 x bfloat], ptr %40, i32 0, i32 0
  br label %42

42:                                               ; preds = %39
  call void @op0_passThroughLine(ptr @flash_state_2_5, ptr %41, i32 256)
...
58:                                               ; preds = %23
  %59 = phi ptr [ @of_8_switch_join_2_1_buff_0, %23 ]
  br label %25

60:                                               ; preds = %23
  %61 = phi ptr [ @of_8_switch_join_2_1_buff_1, %23 ]
  br label %25

62:                                               ; preds = %28
  %63 = phi ptr [ @of_7_distribute_2_1_cons_buff_0, %28 ]
  br label %30

64:                                               ; preds = %28
  %65 = phi ptr [ @of_7_distribute_2_1_cons_buff_1, %28 ]
  br label %30

66:                                               ; preds = %37
  %67 = phi ptr [ @flash_scale_2_5_buff_0, %37 ]
  br label %39

68:                                               ; preds = %37
  %69 = phi ptr [ @flash_scale_2_5_buff_1, %37 ]
  br label %39

70:                                               ; preds = %37
  %71 = phi ptr [ @flash_scale_2_5_buff_2, %37 ]
  br label %39

72:                                               ; preds = %37
  %73 = phi ptr [ @flash_scale_2_5_buff_3, %37 ]
  br label %39

74:                                               ; preds = %37
  %75 = phi ptr [ @flash_scale_2_5_buff_4, %37 ]
  br label %39

76:                                               ; preds = %37
  %77 = phi ptr [ @flash_scale_2_5_buff_5, %37 ]
  br label %39

78:                                               ; preds = %37
  %79 = phi ptr [ @flash_scale_2_5_buff_6, %37 ]
  br label %39

80:                                               ; preds = %37
  %81 = phi ptr [ @flash_scale_2_5_buff_7, %37 ]
  br label %39
}
