...
17:                                               ; preds = %9
  ...
  call void @op0_zero_bf16(ptr @of_9_unicast_4_buff_0)
  call void @op0_zero_bf16(ptr @of_9_unicast_4_buff_1)
...
30:                                               ; preds = %124, %126, %28
  %31 = phi ptr [ %127, %126 ], [ %125, %124 ], [ @of_5_broadcast_0_0_4_cons_buff_0, %28 ]
...
35:                                               ; preds = %128, %130, %33
  %36 = phi ptr [ %131, %130 ], [ %129, %128 ], [ @of_8_switch_join_4_0_buff_0, %33 ]
...
46:                                               ; preds = %132, %134, %44
  %47 = phi ptr [ %135, %134 ], [ %133, %132 ], [ @of_8_switch_join_4_1_buff_0, %44 ]
...
63:                                               ; preds = %136, %138, %62
  %64 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %139, %138 ], [ %137, %136 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_4_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %62 ]
  br label %65
...
66:                                               ; preds = %140, %65
  ...
  %70 = add i32 %69, 4
  %71 = add i32 %70, %19
  store i32 %56, ptr @flash_index_4_4
  store i32 %71, ptr getelementptr inbounds nuw (i8, ptr @flash_index_4_4, i64 4)
...
74:                                               ; preds = %142, %144, %146, %148, %150, %152, %154, %156, %72
  %75 = phi ptr [ %157, %156 ], [ %155, %154 ], [ %153, %152 ], [ %151, %150 ], [ %149, %148 ], [ %147, %146 ], [ %145, %144 ], [ %143, %142 ], [ @flash_scale_4_3_buff_0, %72 ]
...
77:                                               ; preds = %74
  ...
  call void @op0_matmul_PV(ptr %80, ptr %32, ptr %81, ptr %76, i32 64, i32 %79, ptr @flash_index_4_4)
  %82 = icmp eq i32 %56, 31
  br i1 %82, label %83, label %84

83:                                               ; preds = %77
  call void @op0_rescale_O(ptr %81, ptr %76, i32 64, ptr @flash_index_4_4)
  br label %84
...
90:                                               ; preds = %158, %160, %162, %164, %166, %168, %170, %172, %88
  %91 = phi ptr [ %173, %172 ], [ %171, %170 ], [ %169, %168 ], [ %167, %166 ], [ %165, %164 ], [ %163, %162 ], [ %161, %160 ], [ %159, %158 ], [ @flash_scale_4_5_buff_0, %88 ]
...
93:                                               ; preds = %90
  ...
  call void @op0_matmul_PV(ptr %96, ptr %32, ptr %97, ptr %92, i32 64, i32 %95, ptr @flash_index_4_4)
  %98 = icmp eq i32 %56, 31
  br i1 %98, label %99, label %100

99:                                               ; preds = %93
  call void @op0_rescale_O(ptr %97, ptr %92, i32 64, ptr @flash_index_4_4)
  br label %100
...
124:                                              ; preds = %28
  %125 = phi ptr [ @of_5_broadcast_0_0_4_cons_buff_0, %28 ]
  br label %30

126:                                              ; preds = %28
  %127 = phi ptr [ @of_5_broadcast_0_0_4_cons_buff_1, %28 ]
  br label %30

128:                                              ; preds = %33
  %129 = phi ptr [ @of_8_switch_join_4_0_buff_0, %33 ]
  br label %35

130:                                              ; preds = %33
  %131 = phi ptr [ @of_8_switch_join_4_0_buff_1, %33 ]
  br label %35

132:                                              ; preds = %44
  %133 = phi ptr [ @of_8_switch_join_4_1_buff_0, %44 ]
  br label %46

134:                                              ; preds = %44
  %135 = phi ptr [ @of_8_switch_join_4_1_buff_1, %44 ]
  br label %46

136:                                              ; preds = %62
  %137 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_4_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %62 ]
  br label %63

138:                                              ; preds = %62
  %139 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_4_buff_1, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %62 ]
  br label %63
...
142:                                              ; preds = %72
  %143 = phi ptr [ @flash_scale_4_3_buff_0, %72 ]
  br label %74

144:                                              ; preds = %72
  %145 = phi ptr [ @flash_scale_4_3_buff_1, %72 ]
  br label %74

146:                                              ; preds = %72
  %147 = phi ptr [ @flash_scale_4_3_buff_2, %72 ]
  br label %74

148:                                              ; preds = %72
  %149 = phi ptr [ @flash_scale_4_3_buff_3, %72 ]
  br label %74

150:                                              ; preds = %72
  %151 = phi ptr [ @flash_scale_4_3_buff_4, %72 ]
  br label %74

152:                                              ; preds = %72
  %153 = phi ptr [ @flash_scale_4_3_buff_5, %72 ]
  br label %74

154:                                              ; preds = %72
  %155 = phi ptr [ @flash_scale_4_3_buff_6, %72 ]
  br label %74

156:                                              ; preds = %72
  %157 = phi ptr [ @flash_scale_4_3_buff_7, %72 ]
  br label %74

158:                                              ; preds = %88
  %159 = phi ptr [ @flash_scale_4_5_buff_0, %88 ]
  br label %90

160:                                              ; preds = %88
  %161 = phi ptr [ @flash_scale_4_5_buff_1, %88 ]
  br label %90

162:                                              ; preds = %88
  %163 = phi ptr [ @flash_scale_4_5_buff_2, %88 ]
  br label %90

164:                                              ; preds = %88
  %165 = phi ptr [ @flash_scale_4_5_buff_3, %88 ]
  br label %90

166:                                              ; preds = %88
  %167 = phi ptr [ @flash_scale_4_5_buff_4, %88 ]
  br label %90

168:                                              ; preds = %88
  %169 = phi ptr [ @flash_scale_4_5_buff_5, %88 ]
  br label %90

170:                                              ; preds = %88
  %171 = phi ptr [ @flash_scale_4_5_buff_6, %88 ]
  br label %90

172:                                              ; preds = %88
  %173 = phi ptr [ @flash_scale_4_5_buff_7, %88 ]
  br label %90
}
