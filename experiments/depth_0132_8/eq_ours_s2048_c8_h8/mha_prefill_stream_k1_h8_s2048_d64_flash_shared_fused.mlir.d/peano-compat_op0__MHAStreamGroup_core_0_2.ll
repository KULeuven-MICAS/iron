...
12:                                               ; preds = %42, %9
  %13 = phi i64 [ %46, %42 ], [ 0, %9 ]
  %14 = phi i32 [ %45, %42 ], [ %7, %9 ]
...
18:                                               ; preds = %52, %54, %16
  %19 = phi ptr [ %55, %54 ], [ %53, %52 ], [ @of_4_broadcast_0_0_0_cons_buff_0, %16 ]
...
21:                                               ; preds = %18
  ...
  call void @op0_zero_bf16_64_64_64(ptr @of_6_unicast_0_buff_0)
  call void @op0_zero_bf16_64_64_64(ptr @of_6_unicast_0_relay_1_buff_0)
...
27:                                               ; preds = %56, %58, %26
  %28 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %59, %58 ], [ %57, %56 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %26 ]
  br label %29
...
30:                                               ; preds = %60, %62, %29
  %31 = phi ptr [ %63, %62 ], [ %61, %60 ], [ @of_3_unicast_0_0_cons_buff_0, %29 ]
...
38:                                               ; preds = %33
  %39 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %28, 1
  call void @op0_matmul_bf16_bf16_64_64_64(ptr %32, ptr %20, ptr %39)
  br label %40
...
52:                                               ; preds = %16
  %53 = phi ptr [ @of_4_broadcast_0_0_0_cons_buff_0, %16 ]
  br label %18

54:                                               ; preds = %16
  %55 = phi ptr [ @of_4_broadcast_0_0_0_cons_buff_1, %16 ]
  br label %18

56:                                               ; preds = %26
  %57 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %26 ]
  br label %27

58:                                               ; preds = %26
  %59 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_0_relay_1_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %26 ]
  br label %27

60:                                               ; preds = %29
  %61 = phi ptr [ @of_3_unicast_0_0_cons_buff_0, %29 ]
  br label %30

62:                                               ; preds = %29
  %63 = phi ptr [ @of_3_unicast_0_0_cons_buff_1, %29 ]
  br label %30
}
