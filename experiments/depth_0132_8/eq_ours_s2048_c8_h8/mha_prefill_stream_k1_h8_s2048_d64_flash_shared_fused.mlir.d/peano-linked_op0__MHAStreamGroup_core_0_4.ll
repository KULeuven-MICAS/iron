...
1:                                                ; preds = %120, %0
  ...
  %3 = phi i32 [ %11, %120 ], [ 0, %0 ]
  %4 = phi i32 [ %12, %120 ], [ 0, %0 ]
  %5 = phi i32 [ %13, %120 ], [ 0, %0 ]
  %6 = phi i32 [ %14, %120 ], [ 0, %0 ]
  %7 = phi i32 [ %15, %120 ], [ 0, %0 ]
  %8 = icmp slt i64 %2, 4294967295
  br i1 %8, label %9, label %122

9:                                                ; preds = %118, %1
  %10 = phi i64 [ %119, %118 ], [ 0, %1 ]
  %11 = phi i32 [ %22, %118 ], [ %3, %1 ]
  %12 = phi i32 [ %23, %118 ], [ %4, %1 ]
  %13 = phi i32 [ %24, %118 ], [ %5, %1 ]
  %14 = phi i32 [ %25, %118 ], [ %6, %1 ]
  %15 = phi i32 [ %26, %118 ], [ %7, %1 ]
  %16 = icmp slt i64 %10, 2
  br i1 %16, label %17, label %120

17:                                               ; preds = %9
  call void @llvm.aie2p.acquire(i32 48, i32 -2)
  call void @op0_zero_bf16(ptr @of_9_unicast_0_buff_0)
  call void @op0_zero_bf16(ptr @of_9_unicast_0_buff_1)
  %18 = trunc i64 %10 to i32
  %19 = mul i32 %18, 16
  br label %20

20:                                               ; preds = %107, %17
  %21 = phi i64 [ %117, %107 ], [ 0, %17 ]
  %22 = phi i32 [ %116, %107 ], [ %11, %17 ]
  %23 = phi i32 [ %110, %107 ], [ %12, %17 ]
  %24 = phi i32 [ %113, %107 ], [ %13, %17 ]
  %25 = phi i32 [ %59, %107 ], [ %14, %17 ]
  %26 = phi i32 [ %60, %107 ], [ %15, %17 ]
...
30:                                               ; preds = %123, %125, %28
  %31 = phi ptr [ %126, %125 ], [ %124, %123 ], [ @of_5_broadcast_0_0_0_cons_buff_0, %28 ]
...
35:                                               ; preds = %127, %129, %33
  %36 = phi ptr [ %130, %129 ], [ %128, %127 ], [ @of_8_switch_join_0_0_buff_0, %33 ]
...
46:                                               ; preds = %131, %133, %44
  %47 = phi ptr [ %134, %133 ], [ %132, %131 ], [ @of_8_switch_join_0_1_buff_0, %44 ]
...
57:                                               ; preds = %103, %55
  %58 = phi i64 [ %106, %103 ], [ 0, %55 ]
  %59 = phi i32 [ %104, %103 ], [ %25, %55 ]
  %60 = phi i32 [ %105, %103 ], [ %26, %55 ]
...
63:                                               ; preds = %135, %137, %62
  %64 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %138, %137 ], [ %136, %135 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %62 ]
  br label %65
...
66:                                               ; preds = %139, %65
  %67 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %140, %139 ], [ %43, %65 ]
  %68 = trunc i64 %58 to i32
  %69 = mul i32 %68, 8
  %70 = add i32 %69, %19
  store i32 %56, ptr @flash_index_0_4
  store i32 %70, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_4, i64 4)
...
73:                                               ; preds = %141, %143, %145, %147, %149, %151, %153, %155, %71
  %74 = phi ptr [ %156, %155 ], [ %154, %153 ], [ %152, %151 ], [ %150, %149 ], [ %148, %147 ], [ %146, %145 ], [ %144, %143 ], [ %142, %141 ], [ @flash_scale_0_3_buff_0, %71 ]
  %75 = getelementptr [256 x bfloat], ptr %74, i32 0, i32 0
  br label %76

76:                                               ; preds = %73
  %77 = icmp ne i32 %56, 0
  %78 = zext i1 %77 to i32
  %79 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %67, 1
  %80 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %64, 1
  call void @op0_matmul_PV(ptr %79, ptr %32, ptr %80, ptr %75, i32 64, i32 %78, ptr @flash_index_0_4)
  %81 = icmp eq i32 %56, 31
  br i1 %81, label %82, label %83

82:                                               ; preds = %76
  call void @op0_rescale_O(ptr %80, ptr %75, i32 64, ptr @flash_index_0_4)
  br label %83
...
89:                                               ; preds = %157, %159, %161, %163, %165, %167, %169, %171, %87
  %90 = phi ptr [ %172, %171 ], [ %170, %169 ], [ %168, %167 ], [ %166, %165 ], [ %164, %163 ], [ %162, %161 ], [ %160, %159 ], [ %158, %157 ], [ @flash_scale_0_5_buff_0, %87 ]
  %91 = getelementptr [256 x bfloat], ptr %90, i32 0, i32 0
  br label %92

92:                                               ; preds = %89
  %93 = icmp ne i32 %56, 0
  %94 = zext i1 %93 to i32
  %95 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %67, 1
  %96 = extractvalue { ptr, ptr, i64, [2 x i64], [2 x i64] } %64, 1
  call void @op0_matmul_PV(ptr %95, ptr %32, ptr %96, ptr %91, i32 64, i32 %94, ptr @flash_index_0_4)
  %97 = icmp eq i32 %56, 31
  br i1 %97, label %98, label %99

98:                                               ; preds = %92
  call void @op0_rescale_O(ptr %96, ptr %91, i32 64, ptr @flash_index_0_4)
  br label %99
...
103:                                              ; preds = %83, %99
  %104 = phi i32 [ %59, %99 ], [ %86, %83 ]
  %105 = phi i32 [ %102, %99 ], [ %60, %83 ]
  %106 = add i64 %58, 1
  br label %57
...
123:                                              ; preds = %28
  %124 = phi ptr [ @of_5_broadcast_0_0_0_cons_buff_0, %28 ]
  br label %30

125:                                              ; preds = %28
  %126 = phi ptr [ @of_5_broadcast_0_0_0_cons_buff_1, %28 ]
  br label %30

127:                                              ; preds = %33
  %128 = phi ptr [ @of_8_switch_join_0_0_buff_0, %33 ]
  br label %35

129:                                              ; preds = %33
  %130 = phi ptr [ @of_8_switch_join_0_0_buff_1, %33 ]
  br label %35

131:                                              ; preds = %44
  %132 = phi ptr [ @of_8_switch_join_0_1_buff_0, %44 ]
  br label %46

133:                                              ; preds = %44
  %134 = phi ptr [ @of_8_switch_join_0_1_buff_1, %44 ]
  br label %46

135:                                              ; preds = %62
  %136 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %62 ]
  br label %63

137:                                              ; preds = %62
  %138 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_0_buff_1, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %62 ]
  br label %63

139:                                              ; preds = %65
  %140 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %54, %65 ]
  br label %66

141:                                              ; preds = %71
  %142 = phi ptr [ @flash_scale_0_3_buff_0, %71 ]
  br label %73

143:                                              ; preds = %71
  %144 = phi ptr [ @flash_scale_0_3_buff_1, %71 ]
  br label %73

145:                                              ; preds = %71
  %146 = phi ptr [ @flash_scale_0_3_buff_2, %71 ]
  br label %73

147:                                              ; preds = %71
  %148 = phi ptr [ @flash_scale_0_3_buff_3, %71 ]
  br label %73

149:                                              ; preds = %71
  %150 = phi ptr [ @flash_scale_0_3_buff_4, %71 ]
  br label %73

151:                                              ; preds = %71
  %152 = phi ptr [ @flash_scale_0_3_buff_5, %71 ]
  br label %73

153:                                              ; preds = %71
  %154 = phi ptr [ @flash_scale_0_3_buff_6, %71 ]
  br label %73

155:                                              ; preds = %71
  %156 = phi ptr [ @flash_scale_0_3_buff_7, %71 ]
  br label %73

157:                                              ; preds = %87
  %158 = phi ptr [ @flash_scale_0_5_buff_0, %87 ]
  br label %89

159:                                              ; preds = %87
  %160 = phi ptr [ @flash_scale_0_5_buff_1, %87 ]
  br label %89

161:                                              ; preds = %87
  %162 = phi ptr [ @flash_scale_0_5_buff_2, %87 ]
  br label %89

163:                                              ; preds = %87
  %164 = phi ptr [ @flash_scale_0_5_buff_3, %87 ]
  br label %89

165:                                              ; preds = %87
  %166 = phi ptr [ @flash_scale_0_5_buff_4, %87 ]
  br label %89

167:                                              ; preds = %87
  %168 = phi ptr [ @flash_scale_0_5_buff_5, %87 ]
  br label %89

169:                                              ; preds = %87
  %170 = phi ptr [ @flash_scale_0_5_buff_6, %87 ]
  br label %89

171:                                              ; preds = %87
  %172 = phi ptr [ @flash_scale_0_5_buff_7, %87 ]
  br label %89
}
