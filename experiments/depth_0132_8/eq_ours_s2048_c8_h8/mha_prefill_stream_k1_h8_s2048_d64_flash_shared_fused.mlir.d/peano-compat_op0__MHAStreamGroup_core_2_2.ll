...
18:                                               ; preds = %53, %55, %16
  %19 = phi ptr [ %56, %55 ], [ %54, %53 ], [ @of_4_broadcast_0_0_2_cons_buff_0, %16 ]
...
21:                                               ; preds = %18
  ...
  call void @op0_zero_bf16_64_64_64(ptr @of_6_unicast_2_buff_0)
  call void @op0_zero_bf16_64_64_64(ptr @of_6_unicast_2_relay_1_buff_0)
...
27:                                               ; preds = %57, %59, %26
  %28 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %60, %59 ], [ %58, %57 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_2_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %26 ]
  br label %29
...
30:                                               ; preds = %61, %63, %29
  %31 = phi ptr [ %64, %63 ], [ %62, %61 ], [ @of_3_unicast_2_0_cons_buff_0, %29 ]
...
53:                                               ; preds = %16
  %54 = phi ptr [ @of_4_broadcast_0_0_2_cons_buff_0, %16 ]
  br label %18

55:                                               ; preds = %16
  %56 = phi ptr [ @of_4_broadcast_0_0_2_cons_buff_1, %16 ]
  br label %18

57:                                               ; preds = %26
  %58 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_2_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %26 ]
  br label %27

59:                                               ; preds = %26
  %60 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_6_unicast_2_relay_1_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %26 ]
  br label %27

61:                                               ; preds = %29
  %62 = phi ptr [ @of_3_unicast_2_0_cons_buff_0, %29 ]
  br label %30

63:                                               ; preds = %29
  %64 = phi ptr [ @of_3_unicast_2_0_cons_buff_1, %29 ]
  br label %30
}
