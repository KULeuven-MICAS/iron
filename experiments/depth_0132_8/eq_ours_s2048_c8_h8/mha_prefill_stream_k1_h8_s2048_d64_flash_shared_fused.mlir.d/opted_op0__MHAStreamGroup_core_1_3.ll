; ModuleID = '/home/micas/iron-stream-dse/experiments/depth_0132_8/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_3.ll'
...
@switch.table.core_1_3 = private unnamed_addr constant [7 x ptr] [ptr @flash_scale_1_3_buff_1, ptr @flash_scale_1_3_buff_2, ptr @flash_scale_1_3_buff_3, ptr @flash_scale_1_3_buff_4, ptr @flash_scale_1_3_buff_5, ptr @flash_scale_1_3_buff_6, ptr @flash_scale_1_3_buff_7], align 4
...
13:                                               ; preds = %5, %25
  ...
  %18 = select i1 %cond1, ptr @of_7_distribute_1_0_cons_buff_1, ptr @of_7_distribute_1_0_cons_buff_0
...
22:                                               ; preds = %21, %13
  tail call void @op0_partial_softmax_mode(ptr nonnull %18, ptr nonnull %spec.select, ptr nonnull @flash_state_1_3, ptr nonnull @flash_index_1_3, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048, i32 2)
...
switch.lookup:                                    ; preds = %22
  ...
  %switch.gep = getelementptr inbounds nuw [7 x ptr], ptr @switch.table.core_1_3, i20 0, i20 %24
  %switch.load = load ptr, ptr %switch.gep, align 4
  br label %25

25:                                               ; preds = %switch.lookup, %22
  %26 = phi ptr [ @flash_scale_1_3_buff_0, %22 ], [ %switch.load, %switch.lookup ]
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_1_3, ptr nonnull %26, i32 256)
