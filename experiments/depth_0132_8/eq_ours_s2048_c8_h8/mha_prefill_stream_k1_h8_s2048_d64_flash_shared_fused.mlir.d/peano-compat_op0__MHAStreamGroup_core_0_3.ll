...
24:                                               ; preds = %57, %59, %22
  %25 = phi ptr [ %60, %59 ], [ %58, %57 ], [ @of_8_switch_join_0_0_buff_0, %22 ]
...
29:                                               ; preds = %61, %63, %27
  %30 = phi ptr [ %64, %63 ], [ %62, %61 ], [ @of_7_distribute_0_0_cons_buff_0, %27 ]
...
36:                                               ; preds = %35, %32
  call void @op0_partial_softmax_mode(ptr %31, ptr %26, ptr @flash_state_0_3, ptr @flash_index_0_3, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048, i32 2)
...
38:                                               ; preds = %65, %67, %69, %71, %73, %75, %77, %79, %36
  %39 = phi ptr [ %80, %79 ], [ %78, %77 ], [ %76, %75 ], [ %74, %73 ], [ %72, %71 ], [ %70, %69 ], [ %68, %67 ], [ %66, %65 ], [ @flash_scale_0_3_buff_0, %36 ]
...
57:                                               ; preds = %22
  %58 = phi ptr [ @of_8_switch_join_0_0_buff_0, %22 ]
  br label %24

59:                                               ; preds = %22
  %60 = phi ptr [ @of_8_switch_join_0_0_buff_1, %22 ]
  br label %24

61:                                               ; preds = %27
  %62 = phi ptr [ @of_7_distribute_0_0_cons_buff_0, %27 ]
  br label %29

63:                                               ; preds = %27
  %64 = phi ptr [ @of_7_distribute_0_0_cons_buff_1, %27 ]
  br label %29
...
69:                                               ; preds = %36
  %70 = phi ptr [ @flash_scale_0_3_buff_2, %36 ]
  br label %38

71:                                               ; preds = %36
  %72 = phi ptr [ @flash_scale_0_3_buff_3, %36 ]
  br label %38

73:                                               ; preds = %36
  %74 = phi ptr [ @flash_scale_0_3_buff_4, %36 ]
  br label %38

75:                                               ; preds = %36
  %76 = phi ptr [ @flash_scale_0_3_buff_5, %36 ]
  br label %38

77:                                               ; preds = %36
  %78 = phi ptr [ @flash_scale_0_3_buff_6, %36 ]
  br label %38

79:                                               ; preds = %36
  %80 = phi ptr [ @flash_scale_0_3_buff_7, %36 ]
  br label %38
}
