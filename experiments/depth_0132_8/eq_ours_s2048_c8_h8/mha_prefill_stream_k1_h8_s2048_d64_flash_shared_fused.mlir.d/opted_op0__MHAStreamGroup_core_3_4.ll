; ModuleID = '/home/micas/iron-stream-dse/experiments/depth_0132_8/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_3_4.ll'
...
@switch.table.core_3_4 = private unnamed_addr constant [7 x ptr] [ptr @flash_scale_3_3_buff_1, ptr @flash_scale_3_3_buff_2, ptr @flash_scale_3_3_buff_3, ptr @flash_scale_3_3_buff_4, ptr @flash_scale_3_3_buff_5, ptr @flash_scale_3_3_buff_6, ptr @flash_scale_3_3_buff_7], align 4
@switch.table.core_3_4.1 = private unnamed_addr constant [7 x ptr] [ptr @flash_scale_3_5_buff_1, ptr @flash_scale_3_5_buff_2, ptr @flash_scale_3_5_buff_3, ptr @flash_scale_3_5_buff_4, ptr @flash_scale_3_5_buff_5, ptr @flash_scale_3_5_buff_6, ptr @flash_scale_3_5_buff_7], align 4
...
7:                                                ; preds = %.preheader, %75
  ...
  %invariant.op = or disjoint i32 %15, 3
  br label %16
...
16:                                               ; preds = %7, %63
  ...
  %23 = select i1 %cond3, ptr @of_8_switch_join_3_0_buff_1, ptr @of_8_switch_join_3_0_buff_0
  %cond4 = icmp eq i32 %19, 1
  %24 = select i1 %cond4, ptr @of_8_switch_join_3_1_buff_1, ptr @of_8_switch_join_3_1_buff_0
...
32:                                               ; preds = %16, %58
  ...
  %spec.select19 = select i1 %cond5, ptr @of_9_unicast_3_buff_1, ptr @of_9_unicast_3_buff_0
  %.pn18 = select i1 %cond5, ptr %24, ptr %23
  %36 = trunc nuw nsw i64 %35 to i32
  %37 = shl nuw nsw i32 %36, 3
  %.reass = add nuw nsw i32 %37, %invariant.op
  store i32 %25, ptr @flash_index_3_4, align 4
  store i32 %.reass, ptr getelementptr inbounds nuw (i8, ptr @flash_index_3_4, i20 4), align 4
...
switch.lookup:                                    ; preds = %38
  ...
  %switch.gep = getelementptr inbounds nuw [7 x ptr], ptr @switch.table.core_3_4, i20 0, i20 %40
  %switch.load = load ptr, ptr %switch.gep, align 4
  br label %41

41:                                               ; preds = %switch.lookup, %38
  %42 = phi ptr [ @flash_scale_3_3_buff_0, %38 ], [ %switch.load, %switch.lookup ]
  tail call void @op0_matmul_PV(ptr nonnull %.pn18, ptr nonnull %spec.select, ptr nonnull %spec.select19, ptr nonnull %42, i32 64, i32 %27, ptr nonnull @flash_index_3_4)
  br i1 %28, label %43, label %44

43:                                               ; preds = %41
  tail call void @op0_rescale_O(ptr nonnull %spec.select19, ptr nonnull %42, i32 64, ptr nonnull @flash_index_3_4)
  br label %44
...
switch.lookup39:                                  ; preds = %48
  ...
  %switch.gep41 = getelementptr inbounds nuw [7 x ptr], ptr @switch.table.core_3_4.1, i20 0, i20 %50
  %switch.load42 = load ptr, ptr %switch.gep41, align 4
  br label %51

51:                                               ; preds = %switch.lookup39, %48
  %52 = phi ptr [ @flash_scale_3_5_buff_0, %48 ], [ %switch.load42, %switch.lookup39 ]
  tail call void @op0_matmul_PV(ptr nonnull %.pn18, ptr nonnull %spec.select, ptr nonnull %spec.select19, ptr nonnull %52, i32 64, i32 %30, ptr nonnull @flash_index_3_4)
  br i1 %31, label %53, label %54

53:                                               ; preds = %51
  tail call void @op0_rescale_O(ptr nonnull %spec.select19, ptr nonnull %52, i32 64, ptr nonnull @flash_index_3_4)
  br label %54
