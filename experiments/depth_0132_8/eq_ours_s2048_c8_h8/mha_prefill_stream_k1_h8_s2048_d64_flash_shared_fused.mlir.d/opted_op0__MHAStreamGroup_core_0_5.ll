; ModuleID = '/home/micas/iron-stream-dse/experiments/depth_0132_8/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_5.ll'
...
@switch.table.core_0_5 = private unnamed_addr constant [7 x ptr] [ptr @flash_scale_0_5_buff_1, ptr @flash_scale_0_5_buff_2, ptr @flash_scale_0_5_buff_3, ptr @flash_scale_0_5_buff_4, ptr @flash_scale_0_5_buff_5, ptr @flash_scale_0_5_buff_6, ptr @flash_scale_0_5_buff_7], align 4
...
13:                                               ; preds = %5, %25
  ...
  %spec.select = select i1 %cond, ptr @of_8_switch_join_0_1_buff_1, ptr @of_8_switch_join_0_1_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1 = icmp eq i32 %15, 1
  %18 = select i1 %cond1, ptr @of_7_distribute_0_1_cons_buff_1, ptr @of_7_distribute_0_1_cons_buff_0
  %19 = trunc nuw nsw i64 %17 to i32
  store i32 %19, ptr @flash_index_0_5, align 4
  store i32 %12, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_5, i20 4), align 4
  %20 = icmp eq i32 %19, 0
  br i1 %20, label %21, label %22

21:                                               ; preds = %13
  tail call void @op0_init_scale_buffer(ptr nonnull @flash_state_0_5, i32 64)
  br label %22

22:                                               ; preds = %21, %13
  tail call void @op0_partial_softmax_mode(ptr nonnull %18, ptr nonnull %spec.select, ptr nonnull @flash_state_0_5, ptr nonnull @flash_index_0_5, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048, i32 2)
...
switch.lookup:                                    ; preds = %22
  ...
  %switch.gep = getelementptr inbounds nuw [7 x ptr], ptr @switch.table.core_0_5, i20 0, i20 %24
  %switch.load = load ptr, ptr %switch.gep, align 4
  br label %25

25:                                               ; preds = %switch.lookup, %22
  %26 = phi ptr [ @flash_scale_0_5_buff_0, %22 ], [ %switch.load, %switch.lookup ]
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_0_5, ptr nonnull %26, i32 256)
