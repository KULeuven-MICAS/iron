; ModuleID = '/home/micas/iron-stream-dse/experiments/three_fused/eq_ours_s4096_c8_h32/mha_prefill_stream_k1_h32_s4096_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_5.ll'
...
15:                                               ; preds = %6, %27
  ...
  store i32 %21, ptr @flash_index_1_5, align 4
  store i32 %14, ptr getelementptr inbounds nuw (i8, ptr @flash_index_1_5, i20 4), align 4
  tail call void @llvm.aie2p.acquire(i32 7, i32 -1)
  %cond3 = icmp eq i32 %16, 1
  %22 = select i1 %cond3, ptr @flash_scale_1_4_buff_1, ptr @flash_scale_1_4_buff_0
  %23 = icmp ne i32 %21, 0
  %24 = zext i1 %23 to i32
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %20, ptr nonnull %spec.select, ptr nonnull %22, i32 64, i32 %24, ptr nonnull @flash_index_1_5)
  %25 = icmp eq i32 %21, 63
  br i1 %25, label %26, label %27

26:                                               ; preds = %15
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %22, i32 64, ptr nonnull @flash_index_1_5)
  br label %27
