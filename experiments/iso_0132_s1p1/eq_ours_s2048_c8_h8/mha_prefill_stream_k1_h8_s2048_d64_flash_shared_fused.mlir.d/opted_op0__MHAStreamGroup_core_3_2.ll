; ModuleID = '/home/micas/iron-stream-dse/experiments/iso_0132_s1p1/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_3_2.ll'
...
3:                                                ; preds = %.preheader, %27
  ...
  %invariant.op = or disjoint i32 %7, 3
  br label %8
...
8:                                                ; preds = %3, %21
  ...
  tail call void @op0_zero_bf16_64_64_64(ptr nonnull @of_6_switch_fork_3_0_buff_0)
  tail call void @op0_zero_bf16_64_64_64(ptr nonnull @of_6_switch_fork_3_1_buff_0)
...
16:                                               ; preds = %12
  ...
  %17 = select i1 %cond1, ptr @of_3_unicast_3_0_cons_buff_1, ptr @of_3_unicast_3_0_cons_buff_0
  %spec.select5 = select i1 %cond1, ptr @of_6_switch_fork_3_1_buff_0, ptr @of_6_switch_fork_3_0_buff_0
