...
17:                                               ; preds = %9
  ...
  call void @op0_zero_bf16(ptr @of_8_unicast_1_buff_0)
  call void @op0_zero_bf16(ptr @of_8_unicast_1_buff_1)
...
35:                                               ; preds = %128, %130, %33
  %36 = phi ptr [ %131, %130 ], [ %129, %128 ], [ @of_7_switch_join_1_0_buff_0, %33 ]
...
46:                                               ; preds = %132, %134, %44
  %47 = phi ptr [ %135, %134 ], [ %133, %132 ], [ @of_7_switch_join_1_1_buff_0, %44 ]
...
63:                                               ; preds = %136, %138, %62
  %64 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %139, %138 ], [ %137, %136 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_8_unicast_1_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %62 ]
  br label %65
...
128:                                              ; preds = %33
  %129 = phi ptr [ @of_7_switch_join_1_0_buff_0, %33 ]
  br label %35

130:                                              ; preds = %33
  %131 = phi ptr [ @of_7_switch_join_1_0_buff_1, %33 ]
  br label %35

132:                                              ; preds = %44
  %133 = phi ptr [ @of_7_switch_join_1_1_buff_0, %44 ]
  br label %46

134:                                              ; preds = %44
  %135 = phi ptr [ @of_7_switch_join_1_1_buff_1, %44 ]
  br label %46

136:                                              ; preds = %62
  %137 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_8_unicast_1_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %62 ]
  br label %63

138:                                              ; preds = %62
  %139 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_8_unicast_1_buff_1, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %62 ]
  br label %63
