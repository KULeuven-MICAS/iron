; ModuleID = '/home/micas/iron-stream-dse/experiments/iso_0132_s1p1/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_7_3.ll'
...
11:                                               ; preds = %4, %18
  ...
  %spec.select = select i1 %cond, ptr @of_7_switch_join_7_0_buff_1, ptr @of_7_switch_join_7_0_buff_0
  tail call void @llvm.aie2p.acquire(i32 3, i32 -1)
  %15 = trunc nuw nsw i64 %14 to i32
  store i32 %15, ptr @flash_index_7_3, align 4
  store i32 %10, ptr getelementptr inbounds nuw (i8, ptr @flash_index_7_3, i20 4), align 4
  %16 = icmp eq i32 %15, 0
...
18:                                               ; preds = %17, %11
  tail call void @op0_partial_softmax_mode(ptr nonnull @of_6_switch_fork_7_0_buff_0, ptr nonnull %spec.select, ptr nonnull @flash_state_7_3, ptr nonnull @flash_index_7_3, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048, i32 3)
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %cond1 = icmp eq i32 %12, 1
  %spec.select3 = select i1 %cond1, ptr @flash_scale_7_3_buff_1, ptr @flash_scale_7_3_buff_0
