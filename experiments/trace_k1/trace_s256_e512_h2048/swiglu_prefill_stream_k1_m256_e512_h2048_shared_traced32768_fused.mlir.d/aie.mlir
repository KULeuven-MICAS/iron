module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<256x512xbf16>, %arg1: memref<512x2048xbf16>, %arg2: memref<512x2048xbf16>, %arg3: memref<2048x512xbf16>, %arg4: memref<256x512xbf16>) {
      aie.trace.host_config {buffer_size = 32768 : i32}
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<3276800xbf16>, %arg1: memref<131072xbf16>, %arg2: memref<1xbf16>, %arg3: memref<32768xi8>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5, %reinterpret_cast_7, %arg3) : (memref<256x512xbf16>, memref<512x2048xbf16>, memref<512x2048xbf16>, memref<2048x512xbf16>, memref<256x512xbf16>, memref<32768xi8>)
      }
