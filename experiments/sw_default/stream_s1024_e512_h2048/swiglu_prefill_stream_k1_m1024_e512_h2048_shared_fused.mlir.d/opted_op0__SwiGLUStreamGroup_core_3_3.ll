; ModuleID = '/home/micas/iron-stream-dse/experiments/sw_default/stream_s1024_e512_h2048/swiglu_prefill_stream_k1_m1024_e512_h2048_shared_fused.mlir.d/peano-linked_op0__SwiGLUStreamGroup_core_3_3.ll'
...
5:                                                ; preds = %.preheader, %5
  ...
  tail call void @op0_matmul_bf16_bf16_32_32_64(ptr nonnull @of_4_distribute_1_1_1_cons_buff_0, ptr nonnull @of_6_broadcast_1_0_1_cons_buff_0, ptr nonnull %spec.select)
  tail call void @llvm.aie2p.release(i32 52, i32 1)
  tail call void @llvm.aie2p.release(i32 50, i32 1)
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  tail call void @op0_matmul_bf16_bf16_32_32_64(ptr nonnull @of_4_distribute_1_1_1_cons_buff_1, ptr nonnull @of_6_broadcast_1_0_1_cons_buff_1, ptr nonnull %spec.select)
  tail call void @llvm.aie2p.release(i32 52, i32 1)
  tail call void @llvm.aie2p.release(i32 50, i32 1)
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
