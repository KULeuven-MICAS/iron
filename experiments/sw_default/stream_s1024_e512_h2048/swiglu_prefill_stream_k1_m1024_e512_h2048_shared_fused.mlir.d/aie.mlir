module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<1024x512xbf16>, %arg1: memref<512x2048xbf16>, %arg2: memref<512x2048xbf16>, %arg3: memref<2048x512xbf16>, %arg4: memref<1024x512xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<1024x512xbf16> offset = 0 len = 65536 sizes = [16, 16, 128, 32] strides = [0, 32, 512, 1])
        aie.end
      ...
      %2 = aiex.dma_configure_task_for @of_1_mem_0 {
        aie.dma_bd(%arg1 : memref<512x2048xbf16> offset = 0 len = 524288 sizes = [8, 16, 512, 64] strides = [0, 128, 2048, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 7 : i32}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @of_1_mem_1 {
        aie.dma_bd(%arg1 : memref<512x2048xbf16> offset = 64 len = 524288 sizes = [8, 16, 512, 64] strides = [0, 128, 2048, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 7 : i32}
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @of_2_mem_0 {
        aie.dma_bd(%arg2 : memref<512x2048xbf16> offset = 0 len = 524288 sizes = [8, 16, 512, 64] strides = [0, 128, 2048, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 7 : i32}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @of_2_mem_1 {
        aie.dma_bd(%arg2 : memref<512x2048xbf16> offset = 64 len = 524288 sizes = [8, 16, 512, 64] strides = [0, 128, 2048, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 7 : i32}
      ...
      %8 = aiex.dma_configure_task_for @of_13_mem_0 {
        aie.dma_bd(%arg4 : memref<1024x512xbf16> offset = 0 len = 8192 sizes = [32, 8, 32, 32] strides = [16384, 64, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%8)
      %9 = aiex.dma_configure_task_for @of_13_mem_1 {
        aie.dma_bd(%arg4 : memref<1024x512xbf16> offset = 32 len = 8192 sizes = [32, 8, 32, 32] strides = [16384, 64, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%9)
      %10 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<1024x512xbf16> offset = 65536 len = 65536 sizes = [16, 16, 128, 32] strides = [0, 32, 512, 1])
        aie.end
      ...
      %14 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<1024x512xbf16> offset = 131072 len = 65536 sizes = [16, 16, 128, 32] strides = [0, 32, 512, 1])
        aie.end
      ...
      %18 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<1024x512xbf16> offset = 196608 len = 65536 sizes = [16, 16, 128, 32] strides = [0, 32, 512, 1])
        aie.end
      ...
      %22 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<1024x512xbf16> offset = 262144 len = 65536 sizes = [16, 16, 128, 32] strides = [0, 32, 512, 1])
        aie.end
      ...
      %26 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<1024x512xbf16> offset = 327680 len = 65536 sizes = [16, 16, 128, 32] strides = [0, 32, 512, 1])
        aie.end
      ...
      %30 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<1024x512xbf16> offset = 393216 len = 65536 sizes = [16, 16, 128, 32] strides = [0, 32, 512, 1])
        aie.end
      ...
      %34 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<1024x512xbf16> offset = 458752 len = 65536 sizes = [16, 16, 128, 32] strides = [0, 32, 512, 1])
        aie.end
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<3670016xbf16>, %arg1: memref<524288xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        ...
        %subview_2 = memref.subview %arg0[1572864] [1048576] [1] : memref<3670016xbf16> to memref<1048576xbf16, strided<[1], offset: 1572864>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [512, 2048], strides: [2048, 1] : memref<1048576xbf16, strided<[1], offset: 1572864>> to memref<512x2048xbf16>
        %subview_4 = memref.subview %arg0[2621440] [1048576] [1] : memref<3670016xbf16> to memref<1048576xbf16, strided<[1], offset: 2621440>>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [2048, 512], strides: [512, 1] : memref<1048576xbf16, strided<[1], offset: 2621440>> to memref<2048x512xbf16>
        %subview_6 = memref.subview %arg1[0] [524288] [1] : memref<524288xbf16> to memref<524288xbf16>
        %reinterpret_cast_7 = memref.reinterpret_cast %subview_6 to offset: [0], sizes: [1024, 512], strides: [512, 1] : memref<524288xbf16> to memref<1024x512xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5, %reinterpret_cast_7) : (memref<1024x512xbf16>, memref<512x2048xbf16>, memref<512x2048xbf16>, memref<2048x512xbf16>, memref<1024x512xbf16>)
      }
