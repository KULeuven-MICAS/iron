; ModuleID = '/home/micas/iron-stream-dse/experiments/arm_split/eq_ours_s4096_c8_h32/mha_prefill_stream_k1_h32_s4096_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_5_3.ll'
...
16:                                               ; preds = %7, %55
  ...
  %23 = select i1 %cond3, ptr @of_6_switch_join_5_0_buff_1, ptr @of_6_switch_join_5_0_buff_0
  %cond4 = icmp eq i32 %19, 1
  %24 = select i1 %cond4, ptr @of_6_switch_join_5_1_buff_1, ptr @of_6_switch_join_5_1_buff_0
...
32:                                               ; preds = %16, %50
  ...
  store i32 %25, ptr @flash_index_5_3, align 4
  store i32 %.reass, ptr getelementptr inbounds nuw (i8, ptr @flash_index_5_3, i20 4), align 4
...
38:                                               ; preds = %32
  ...
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select22, i32 64, i32 %27, ptr nonnull @flash_index_5_3)
...
44:                                               ; preds = %32
  ...
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select23, i32 64, i32 %30, ptr nonnull @flash_index_5_3)
