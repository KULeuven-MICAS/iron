; ModuleID = '/home/micas/iron-stream-dse/experiments/arm_split/eq_ours_s4096_c8_h32/mha_prefill_stream_k1_h32_s4096_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_3_3.ll'
...
7:                                                ; preds = %.preheader, %67
  ...
  tail call void @op0_zero_bf16(ptr nonnull @of_7_unicast_3_buff_0)
  tail call void @op0_zero_bf16(ptr nonnull @of_7_unicast_3_buff_1)
...
16:                                               ; preds = %7, %55
  ...
  %23 = select i1 %cond3, ptr @of_6_switch_join_3_0_buff_1, ptr @of_6_switch_join_3_0_buff_0
  %cond4 = icmp eq i32 %19, 1
  %24 = select i1 %cond4, ptr @of_6_switch_join_3_1_buff_1, ptr @of_6_switch_join_3_1_buff_0
...
32:                                               ; preds = %16, %50
  ...
  %spec.select21 = select i1 %cond5, ptr @of_7_unicast_3_buff_1, ptr @of_7_unicast_3_buff_0
  %.pn20 = select i1 %cond5, ptr %24, ptr %23
  %36 = trunc nuw nsw i64 %35 to i32
  %37 = shl nuw nsw i32 %36, 3
  %.reass = add nuw nsw i32 %37, %invariant.op
  store i32 %25, ptr @flash_index_3_3, align 4
  store i32 %.reass, ptr getelementptr inbounds nuw (i8, ptr @flash_index_3_3, i20 4), align 4
  br i1 %cond1, label %44, label %38

38:                                               ; preds = %32
  tail call void @llvm.aie2p.acquire(i32 7, i32 -1)
  %cond6 = icmp eq i32 %34, 1
  %spec.select22 = select i1 %cond6, ptr @flash_scale_3_2_buff_1, ptr @flash_scale_3_2_buff_0
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select22, i32 64, i32 %27, ptr nonnull @flash_index_3_3)
  br i1 %28, label %39, label %40

39:                                               ; preds = %38
  tail call void @op0_rescale_O(ptr nonnull %spec.select21, ptr nonnull %spec.select22, i32 64, ptr nonnull @flash_index_3_3)
  br label %40
...
44:                                               ; preds = %32
  ...
  %spec.select23 = select i1 %cond7, ptr @flash_scale_3_4_buff_1, ptr @flash_scale_3_4_buff_0
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select23, i32 64, i32 %30, ptr nonnull @flash_index_3_3)
  br i1 %31, label %45, label %46

45:                                               ; preds = %44
  tail call void @op0_rescale_O(ptr nonnull %spec.select21, ptr nonnull %spec.select23, i32 64, ptr nonnull @flash_index_3_3)
  br label %46
