; ModuleID = '/home/micas/iron-stream-dse/experiments/arm_split/eq_ours_s2048_c8_h32/mha_prefill_stream_k1_h32_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_2.ll'
...
14:                                               ; preds = %6, %23
  ...
  %spec.select5 = select i1 %cond1, ptr @of_6_switch_join_0_0_buff_1, ptr @of_6_switch_join_0_0_buff_0
...
22:                                               ; preds = %14
  tail call void @op0_init_scale_buffer(ptr nonnull @flash_state_0_2, i32 64)
  br label %23

23:                                               ; preds = %22, %14
  tail call void @op0_matmul_softmax(ptr nonnull %spec.select, ptr nonnull %19, ptr nonnull %spec.select5, ptr nonnull @flash_state_0_2, ptr nonnull @flash_index_0_2, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048)
  tail call void @llvm.aie2p.acquire(i32 54, i32 -1)
  %cond3 = icmp eq i32 %15, 1
  %spec.select6 = select i1 %cond3, ptr @flash_scale_0_2_buff_1, ptr @flash_scale_0_2_buff_0
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_0_2, ptr nonnull %spec.select6, i32 256)
  ...
  %34 = icmp samesign ult i64 %18, 31
