; ModuleID = '/home/micas/iron-stream-dse/experiments/arm_split/eq_ours_s2048_c8_h32/mha_prefill_stream_k1_h32_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_1_2.ll'
...
6:                                                ; preds = %.preheader, %36
  ...
  %spec.select = select i1 %cond, ptr @of_3_distribute_1_0_cons_buff_1, ptr @of_3_distribute_1_0_cons_buff_0
...
15:                                               ; preds = %6, %24
  ...
  %spec.select5 = select i1 %cond1, ptr @of_6_switch_join_1_0_buff_1, ptr @of_6_switch_join_1_0_buff_0
  tail call void @op0_zero_bf16(ptr nonnull %spec.select5)
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond2 = icmp eq i32 %17, 1
  %20 = select i1 %cond2, ptr @of_4_broadcast_0_0_1_cons_buff_1, ptr @of_4_broadcast_0_0_1_cons_buff_0
  %21 = trunc nuw nsw i64 %19 to i32
  store i32 %21, ptr @flash_index_1_2, align 4
  store i32 %14, ptr getelementptr inbounds nuw (i8, ptr @flash_index_1_2, i20 4), align 4
  %22 = icmp eq i32 %21, 0
  br i1 %22, label %23, label %24

23:                                               ; preds = %15
  tail call void @op0_init_scale_buffer(ptr nonnull @flash_state_1_2, i32 64)
  br label %24

24:                                               ; preds = %23, %15
  tail call void @op0_matmul_softmax(ptr nonnull %spec.select, ptr nonnull %20, ptr nonnull %spec.select5, ptr nonnull @flash_state_1_2, ptr nonnull @flash_index_1_2, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048)
  tail call void @llvm.aie2p.acquire(i32 54, i32 -1)
  %cond3 = icmp eq i32 %16, 1
  %spec.select6 = select i1 %cond3, ptr @flash_scale_1_2_buff_1, ptr @flash_scale_1_2_buff_0
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_1_2, ptr nonnull %spec.select6, i32 256)
