; ModuleID = '/home/micas/iron-stream-dse/experiments/arm_split/eq_ours_s2048_c8_h32/mha_prefill_stream_k1_h32_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_5_2.ll'
...
6:                                                ; preds = %.preheader, %36
  ...
  %spec.select = select i1 %cond, ptr @of_3_distribute_5_0_cons_buff_1, ptr @of_3_distribute_5_0_cons_buff_0
...
15:                                               ; preds = %6, %24
  ...
  %spec.select5 = select i1 %cond1, ptr @of_6_switch_join_5_0_buff_1, ptr @of_6_switch_join_5_0_buff_0
...
24:                                               ; preds = %23, %15
  tail call void @op0_matmul_softmax(ptr nonnull %spec.select, ptr nonnull %20, ptr nonnull %spec.select5, ptr nonnull @flash_state_5_2, ptr nonnull @flash_index_5_2, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048)
  tail call void @llvm.aie2p.acquire(i32 54, i32 -1)
  %cond3 = icmp eq i32 %16, 1
  %spec.select6 = select i1 %cond3, ptr @flash_scale_5_2_buff_1, ptr @flash_scale_5_2_buff_0
  tail call void @op0_passThroughLine(ptr nonnull @flash_state_5_2, ptr nonnull %spec.select6, i32 256)
