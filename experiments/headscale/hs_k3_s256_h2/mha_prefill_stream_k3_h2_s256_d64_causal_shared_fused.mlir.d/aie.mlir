module {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<98304xbf16>, %arg1: memref<32768xbf16>, %arg2: memref<131072xbf16>) {
      ...
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[16384] [16384] [1] : memref<98304xbf16> to memref<16384xbf16, strided<[1], offset: 16384>>
        ...
        %subview_0 = memref.subview %arg0[49152] [16384] [1] : memref<98304xbf16> to memref<16384xbf16, strided<[1], offset: 49152>>
      ...
      aiex.configure @op2__MHAStreamGroup {
        %subview = memref.subview %arg2[65536] [65536] [1] : memref<131072xbf16> to memref<65536xbf16, strided<[1], offset: 65536>>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [256, 256], strides: [256, 1] : memref<65536xbf16, strided<[1], offset: 65536>> to memref<256x256xbf16>
        %subview_0 = memref.subview %arg0[81920] [16384] [1] : memref<98304xbf16> to memref<16384xbf16, strided<[1], offset: 81920>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [256, 64], strides: [64, 1] : memref<16384xbf16, strided<[1], offset: 81920>> to memref<256x64xbf16>
        %subview_2 = memref.subview %arg1[16384] [16384] [1] : memref<32768xbf16> to memref<16384xbf16, strided<[1], offset: 16384>>
