module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<256x512xbf16>, %arg1: memref<512x2048xbf16>, %arg2: memref<256x2048xbf16>) {
      ...
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x512xbf16> offset = 0 len = 32768 sizes = [4, 8, 64, 64] strides = [0, 64, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 3 : i32}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @of_0_mem_1 {
        aie.dma_bd(%arg0 : memref<256x512xbf16> offset = 32768 len = 32768 sizes = [4, 8, 64, 64] strides = [0, 64, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 3 : i32}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @of_0_mem_2 {
        aie.dma_bd(%arg0 : memref<256x512xbf16> offset = 65536 len = 32768 sizes = [4, 8, 64, 64] strides = [0, 64, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 3 : i32}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @of_0_mem_3 {
        aie.dma_bd(%arg0 : memref<256x512xbf16> offset = 98304 len = 32768 sizes = [4, 8, 64, 64] strides = [0, 64, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 3 : i32}
  ...
  aie.device(npu2) @op1__SwiGLUStreamGroup {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c1_2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c4 step %c1_1 {
            %0 = aie.objectfifo.acquire @of_4_join_0_0(Produce, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
            func.call @op1_zero_bf16_64_64_64(%1) : (memref<64x64xbf16>) -> ()
            %c8 = arith.constant 8 : index
            scf.for %arg3 = %c0_0 to %c8 step %c1_1 {
              %2 = aie.objectfifo.acquire @of_3_broadcast_0_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
              %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
              %4 = aie.objectfifo.acquire @of_2_broadcast_0_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
              %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
              func.call @op1_matmul_bf16_bf16_64_64_64(%5, %3, %1) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
              aie.objectfifo.release @of_2_broadcast_0_0(Consume, 1)
              aie.objectfifo.release @of_3_broadcast_0_0(Consume, 1)
            }
            aie.objectfifo.release @of_4_join_0_0(Produce, 1)
    ...
    aie.objectfifo @of_5_mem_7(%mem_tile_7_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%shim_noc_tile_7_0}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<4x64x64xbf16>>  
    aie.objectfifo.link [@of_4_join_7_0, @of_4_join_7_1, @of_4_join_7_2, @of_4_join_7_3] -> [@of_5_mem_7]([0, 4096, 8192, 12288] [])
    func.func private @op1_zero_bf16_64_64_64(memref<64x64xbf16>)
    func.func private @op1_matmul_bf16_bf16_64_64_64(memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>)
  }
  aie.device(npu2) @op2__SwiGLUStreamGroup {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c32 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c1_2 step %c1_1 {
            ...
            func.call @op2_silu_bf16(%1, %3, %c2048_i32) : (memref<1x2048xbf16>, memref<1x2048xbf16>, i32) -> ()
    ...
    func.func private @op2_silu_bf16(memref<1x2048xbf16>, memref<1x2048xbf16>, i32)
  }
  aie.device(npu2) @op3__SwiGLUStreamGroup {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c32 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c1_2 step %c1_1 {
            ...
            %c2048_i32 = arith.constant 2048 : i32
            func.call @op3_eltwise_mul_bf16_vector(%3, %1, %5, %c2048_i32) : (memref<1x2048xbf16>, memref<1x2048xbf16>, memref<1x2048xbf16>, i32) -> ()
    ...
    func.func private @op3_eltwise_mul_bf16_vector(memref<1x2048xbf16>, memref<1x2048xbf16>, memref<1x2048xbf16>, i32)
  }
  aie.device(npu2) @op4__SwiGLUStreamGroup {
    %shim_noc_tile_0_0 = aie.tile(0, 0)
    %shim_noc_tile_1_0 = aie.tile(1, 0)
    %shim_noc_tile_2_0 = aie.tile(2, 0)
    %shim_noc_tile_3_0 = aie.tile(3, 0)
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c1_2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c1_3 step %c1_1 {
            %0 = aie.objectfifo.acquire @of_4_join_0_0(Produce, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
            func.call @op4_zero_bf16_64_64_64(%1) : (memref<64x64xbf16>) -> ()
            %c32 = arith.constant 32 : index
            scf.for %arg3 = %c0_0 to %c32 step %c1_1 {
              ...
              %4 = aie.objectfifo.acquire @of_2_broadcast_0_0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
              %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
              func.call @op4_matmul_bf16_bf16_64_64_64(%5, %3, %1) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>) -> ()
              aie.objectfifo.release @of_2_broadcast_0_0(Consume, 1)
              aie.objectfifo.release @of_3_broadcast_0_0(Consume, 1)
            }
            aie.objectfifo.release @of_4_join_0_0(Produce, 1)
    ...
    aie.objectfifo @of_5_mem_7(%mem_tile_7_1 dimensionsToStream [<size = 8, stride = 512>, <size = 8, stride = 8>, <size = 8, stride = 64>, <size = 8, stride = 1>], {%shim_noc_tile_7_0}, [2 : i32, 2 : i32]) : !aie.objectfifo<memref<4x64x64xbf16>>  
    aie.objectfifo.link [@of_4_join_7_0, @of_4_join_7_1, @of_4_join_7_2, @of_4_join_7_3] -> [@of_5_mem_7]([0, 4096, 8192, 12288] [])
    func.func private @op4_zero_bf16_64_64_64(memref<64x64xbf16>)
    func.func private @op4_matmul_bf16_bf16_64_64_64(memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>)
  }
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<3276800xbf16>, %arg1: memref<131072xbf16>, %arg2: memref<2097152xbf16>, %arg3: memref<1048576xi8>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %arg3) : (memref<256x512xbf16>, memref<512x2048xbf16>, memref<256x2048xbf16>, memref<1048576xi8>)
      }
      aiex.configure @op1__SwiGLUStreamGroup {
        %subview = memref.subview %arg0[0] [131072] [1] : memref<3276800xbf16> to memref<131072xbf16>
        %reinterpret_cast = memref.reinterpret_cast %subview to offset: [0], sizes: [256, 512], strides: [512, 1] : memref<131072xbf16> to memref<256x512xbf16>
        %subview_0 = memref.subview %arg0[1179648] [1048576] [1] : memref<3276800xbf16> to memref<1048576xbf16, strided<[1], offset: 1179648>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [512, 2048], strides: [2048, 1] : memref<1048576xbf16, strided<[1], offset: 1179648>> to memref<512x2048xbf16>
        %subview_2 = memref.subview %arg2[524288] [524288] [1] : memref<2097152xbf16> to memref<524288xbf16, strided<[1], offset: 524288>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [256, 2048], strides: [2048, 1] : memref<524288xbf16, strided<[1], offset: 524288>> to memref<256x2048xbf16>
      ...
      aiex.configure @op4__SwiGLUStreamGroup {
