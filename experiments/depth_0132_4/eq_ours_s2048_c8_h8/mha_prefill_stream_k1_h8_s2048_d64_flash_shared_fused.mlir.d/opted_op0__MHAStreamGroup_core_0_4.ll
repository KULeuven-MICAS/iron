; ModuleID = '/home/micas/iron-stream-dse/experiments/depth_0132_4/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_4.ll'
...
@switch.table.core_0_4 = private unnamed_addr constant [3 x ptr] [ptr @flash_scale_0_3_buff_1, ptr @flash_scale_0_3_buff_2, ptr @flash_scale_0_3_buff_3], align 4
@switch.table.core_0_4.1 = private unnamed_addr constant [3 x ptr] [ptr @flash_scale_0_5_buff_1, ptr @flash_scale_0_5_buff_2, ptr @flash_scale_0_5_buff_3], align 4
...
switch.lookup:                                    ; preds = %39
  ...
  %switch.gep = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_0_4, i20 0, i20 %41
...
49:                                               ; preds = %32
  ...
  %50 = icmp ult i32 %switch.tableidx40, 3
  br i1 %50, label %switch.lookup39, label %52

switch.lookup39:                                  ; preds = %49
  %51 = trunc nuw i32 %switch.tableidx40 to i20
  %switch.gep41 = getelementptr inbounds nuw [3 x ptr], ptr @switch.table.core_0_4.1, i20 0, i20 %51
