; ModuleID = '/home/micas/iron-stream-dse/experiments/ix/mha_prefill_stream_k1_h2_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_3_3.ll'
...
14:                                               ; preds = %7, %54
  ...
  %21 = select i1 %cond3, ptr @of_6_switch_join_3_0_buff_1, ptr @of_6_switch_join_3_0_buff_0
  %cond4 = icmp eq i32 %17, 1
  %22 = select i1 %cond4, ptr @of_6_switch_join_3_1_buff_1, ptr @of_6_switch_join_3_1_buff_0
...
30:                                               ; preds = %14, %49
  ...
  br i1 %cond5, label %43, label %34

34:                                               ; preds = %30
  %35 = trunc nuw nsw i64 %33 to i32
  %36 = mul nuw nsw i32 %35, 17
  %37 = add nuw nsw i32 %36, 6
  store i32 %23, ptr @flash_index_3_3, align 4
  store i32 %37, ptr getelementptr inbounds nuw (i8, ptr @flash_index_3_3, i20 4), align 4
  ...
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select22, i32 64, i32 %25, ptr nonnull @flash_index_3_3)
...
43:                                               ; preds = %30
  store i32 %23, ptr @flash_index_3_3, align 4
  store i32 31, ptr getelementptr inbounds nuw (i8, ptr @flash_index_3_3, i20 4), align 4
  ...
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select23, i32 64, i32 %28, ptr nonnull @flash_index_3_3)
