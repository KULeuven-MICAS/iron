; ModuleID = '/home/micas/iron-stream-dse/experiments/ix/mha_prefill_stream_k1_h2_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_4_3.ll'
...
14:                                               ; preds = %7, %55
  ...
  %21 = select i1 %cond3, ptr @of_6_switch_join_4_0_buff_1, ptr @of_6_switch_join_4_0_buff_0
  %cond4 = icmp eq i32 %17, 1
  %22 = select i1 %cond4, ptr @of_6_switch_join_4_1_buff_1, ptr @of_6_switch_join_4_1_buff_0
...
30:                                               ; preds = %14, %50
  ...
  store i32 %23, ptr @flash_index_4_3, align 4
  br i1 %cond5, label %43, label %36

36:                                               ; preds = %30
  %37 = or disjoint i32 %35, 8
  store i32 %37, ptr getelementptr inbounds nuw (i8, ptr @flash_index_4_3, i20 4), align 4
  ...
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select22, i32 64, i32 %25, ptr nonnull @flash_index_4_3)
...
43:                                               ; preds = %30
  %44 = add nuw nsw i32 %35, 16
  store i32 %44, ptr getelementptr inbounds nuw (i8, ptr @flash_index_4_3, i20 4), align 4
  ...
  tail call void @op0_matmul_PV(ptr nonnull %.pn20, ptr nonnull %spec.select, ptr nonnull %spec.select21, ptr nonnull %spec.select23, i32 64, i32 %28, ptr nonnull @flash_index_4_3)
