; ModuleID = '/home/micas/iron-stream-dse/experiments/ix/mha_prefill_stream_k1_h2_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_3.ll'
...
14:                                               ; preds = %7, %53
  ...
  %21 = select i1 %cond3, ptr @of_6_switch_join_0_0_buff_1, ptr @of_6_switch_join_0_0_buff_0
  %cond4 = icmp eq i32 %17, 1
  %22 = select i1 %cond4, ptr @of_6_switch_join_0_1_buff_1, ptr @of_6_switch_join_0_1_buff_0
...
30:                                               ; preds = %14, %48
  ...
  br i1 %cond5, label %42, label %34

34:                                               ; preds = %30
  %35 = trunc nuw nsw i64 %33 to i32
  %36 = mul nuw nsw i32 %35, 17
  store i32 %23, ptr @flash_index_0_3, align 4
  store i32 %36, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_3, i20 4), align 4
...
42:                                               ; preds = %30
  store i32 %23, ptr @flash_index_0_3, align 4
  store i32 25, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_3, i20 4), align 4
