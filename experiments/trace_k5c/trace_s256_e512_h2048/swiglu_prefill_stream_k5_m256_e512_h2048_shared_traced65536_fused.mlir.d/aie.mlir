module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.trace @trace_core_0(%tile_0_2) {
    ...
    aie.trace @trace_core_1(%tile_0_3) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
  ...
  aie.device(npu2) @op1__SwiGLUStreamGroup {
    ...
    aie.trace @trace_core_1(%tile_1_2) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<3276800xbf16>, %arg1: memref<131072xbf16>, %arg2: memref<2097152xbf16>, %arg3: memref<65536xi8>, %arg4: memref<65536xi8>, %arg5: memref<65536xi8>, %arg6: memref<65536xi8>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast_5, %reinterpret_cast_7, %reinterpret_cast_9, %arg3) : (memref<256x512xbf16>, memref<512x2048xbf16>, memref<256x2048xbf16>, memref<65536xi8>)
      }
      aiex.configure @op1__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %arg4) : (memref<256x2048xbf16>, memref<256x2048xbf16>, memref<65536xi8>)
      }
      aiex.configure @op2__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %arg5) : (memref<256x2048xbf16>, memref<256x2048xbf16>, memref<256x2048xbf16>, memref<65536xi8>)
      }
      aiex.configure @op3__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %arg6) : (memref<256x2048xbf16>, memref<2048x512xbf16>, memref<256x512xbf16>, memref<65536xi8>)
      }
    }
  }
}
