...
define void @core_5_2() {
  ...
  %1 = load i32, ptr @mha_rtpss_5_stage0
  %2 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_5_stage0, i64 4)
  %3 = sext i32 %1 to i64
  %4 = sext i32 %2 to i64
  br label %5
...
11:                                               ; preds = %5
  store i32 0, ptr @idx_buffer_qk_5
  store i32 5, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_qk_5, i64 4)
  br label %12
...
20:                                               ; preds = %59, %61, %18
  %21 = phi ptr [ %62, %61 ], [ %60, %59 ], [ @memQ21_cons_buff_0, %18 ]
...
31:                                               ; preds = %63, %65, %29
  %32 = phi ptr [ %66, %65 ], [ %64, %63 ], [ @memK_5_cons_buff_0, %29 ]
...
36:                                               ; preds = %67, %69, %34
  %37 = phi ptr [ %70, %69 ], [ %68, %67 ], [ @memA5_buff_0, %34 ]
  %38 = getelementptr [64 x [64 x bfloat]], ptr %37, i32 0, i32 0, i32 0
  br label %39

39:                                               ; preds = %36
  call void @zero_bf16(ptr %38)
  call void @matmul_bf16_bf16_wrapper(ptr %22, ptr %33, ptr %38, ptr @idx_buffer_qk_5)
  ...
  %46 = load i32, ptr @idx_buffer_qk_5
  %47 = add i32 %46, 1
  store i32 %47, ptr @idx_buffer_qk_5
  %48 = add i64 %25, 1
  br label %24

49:                                               ; preds = %24
  store i32 0, ptr @idx_buffer_qk_5
  %50 = load i32, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_qk_5, i64 4)
  %51 = add i32 %50, 8
  store i32 %51, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_qk_5, i64 4)
...
59:                                               ; preds = %18
  %60 = phi ptr [ @memQ21_cons_buff_0, %18 ]
  br label %20

61:                                               ; preds = %18
  %62 = phi ptr [ @memQ21_cons_buff_1, %18 ]
  br label %20

63:                                               ; preds = %29
  %64 = phi ptr [ @memK_5_cons_buff_0, %29 ]
  br label %31

65:                                               ; preds = %29
  %66 = phi ptr [ @memK_5_cons_buff_1, %29 ]
  br label %31

67:                                               ; preds = %34
  %68 = phi ptr [ @memA5_buff_0, %34 ]
  br label %36

69:                                               ; preds = %34
  %70 = phi ptr [ @memA5_buff_1, %34 ]
  br label %36
}
