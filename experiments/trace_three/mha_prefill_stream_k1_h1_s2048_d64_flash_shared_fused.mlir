module {
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<2048x64xbf16>, %arg1: memref<64x2048xbf16>, %arg2: memref<2048x64xbf16>, %arg3: memref<2048x64xbf16>) {
      aie.trace.host_config {buffer_size = 8388608 : i32}
    ...
    aie.trace @trace_core_1(%tile_0_4) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
    ...
    aie.trace @trace_core_2(%tile_0_3) {
      aie.trace.mode "Event-Time"
      aie.trace.packet type = core
      aie.trace.event <"INSTR_EVENT_0">
      aie.trace.event <"INSTR_EVENT_1">
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<393216xbf16>, %arg1: memref<131072xbf16>, %arg2: memref<1xbf16>, %arg3: memref<1xbf16>, %arg4: memref<8388608xi8>) {
      aiex.configure @op0__MHAStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5, %arg4) : (memref<2048x64xbf16>, memref<64x2048xbf16>, memref<2048x64xbf16>, memref<2048x64xbf16>, memref<8388608xi8>)
      }
