module {
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.trace @trace_core_0(%tile_0_4) {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<98304xbf16>, %arg1: memref<32768xbf16>, %arg2: memref<1xbf16>, %arg3: memref<1xbf16>, %arg4: memref<1048576xi8>) {
      aiex.configure @op0__MHAStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5, %arg4) : (memref<256x64xbf16>, memref<64x256xbf16>, memref<256x64xbf16>, memref<256x64xbf16>, memref<1048576xi8>)
        ...
        aiex.run @sequence(%reinterpret_cast_7, %reinterpret_cast_9, %reinterpret_cast_11, %reinterpret_cast_13, %arg4) : (memref<256x64xbf16>, memref<64x256xbf16>, memref<256x64xbf16>, memref<256x64xbf16>, memref<1048576xi8>)
      }
