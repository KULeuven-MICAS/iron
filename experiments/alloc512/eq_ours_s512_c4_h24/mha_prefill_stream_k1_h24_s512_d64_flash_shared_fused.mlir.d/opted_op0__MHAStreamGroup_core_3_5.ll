; ModuleID = '/home/micas/iron-stream-dse/experiments/alloc512/eq_ours_s512_c4_h24/mha_prefill_stream_k1_h24_s512_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_3_5.ll'
...
14:                                               ; preds = %13, %5
  tail call void @op0_partial_softmax_mode(ptr nonnull %10, ptr nonnull %spec.select, ptr nonnull @flash_state_3_5, ptr nonnull @flash_index_3_5, bfloat 0xR3FB9, i32 64, i32 64, i32 512, i32 512, i32 2)
  tail call void @llvm.aie2p.acquire(i32 52, i32 -1)
  %cond2 = icmp eq i32 %6, 1
  %spec.select3 = select i1 %cond2, ptr @flash_scale_3_5_3_4_buff_1, ptr @flash_scale_3_5_3_4_buff_0
