      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c8 step %c1_1 {
            ...
            %c2_i32 = arith.constant 2 : i32
            func.call @op0_partial_softmax_mode(%3, %1, %flash_state_0_3, %flash_index_0_3, %11, %c64_i32, %c64_i32_6, %c512_i32, %c512_i32_7, %c2_i32) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c8 step %c1_1 {
            ...
            %c512_i32_7 = arith.constant 512 : i32
            %c2_i32 = arith.constant 2 : i32
            func.call @op0_partial_softmax_mode(%3, %1, %flash_state_1_3, %flash_index_1_3, %11, %c64_i32, %c64_i32_6, %c512_i32, %c512_i32_7, %c2_i32) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32, i32) -> ()
            %c256_i32 = arith.constant 256 : i32
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c8 step %c1_1 {
            ...
            func.call @op0_partial_softmax_mode(%3, %1, %flash_state_0_5, %flash_index_0_5, %11, %c64_i32, %c64_i32_5, %c512_i32, %c512_i32_6, %c2_i32_7) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32, i32) -> ()
            %c256_i32 = arith.constant 256 : i32
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c8 step %c1_1 {
            ...
            %c512_i32_6 = arith.constant 512 : i32
            %c2_i32 = arith.constant 2 : i32
            func.call @op0_partial_softmax_mode(%3, %1, %flash_state_1_5, %flash_index_1_5, %11, %c64_i32, %c64_i32_5, %c512_i32, %c512_i32_6, %c2_i32) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32, i32) -> ()
            %c256_i32 = arith.constant 256 : i32
