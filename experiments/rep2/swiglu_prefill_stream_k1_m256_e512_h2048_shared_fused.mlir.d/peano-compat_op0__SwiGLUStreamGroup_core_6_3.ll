...
9:                                                ; preds = %5
  ...
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_1_buff_0)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_1_buff_1)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_1_buff_2)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_1_buff_3)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_1_buff_4)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_1_buff_5)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_1_buff_6)
  call void @op0_zero_bf16_32_64_32(ptr @of_12_join_0_1_buff_7)
  br label %10
...
20:                                               ; preds = %51, %53, %55, %57, %59, %61, %63, %65, %19
  %21 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %66, %65 ], [ %64, %63 ], [ %62, %61 ], [ %60, %59 ], [ %58, %57 ], [ %56, %55 ], [ %54, %53 ], [ %52, %51 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_1_buff_0, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %22
...
28:                                               ; preds = %67, %69, %27
  %29 = phi ptr [ %70, %69 ], [ %68, %67 ], [ @of_11_broadcast_1_1_cons_buff_0, %27 ]
...
33:                                               ; preds = %71, %73, %31
  %34 = phi ptr [ %74, %73 ], [ %72, %71 ], [ @of_7_broadcast_0_0_1_cons_buff_0, %31 ]
...
51:                                               ; preds = %19
  %52 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_1_buff_0, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

53:                                               ; preds = %19
  %54 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_1_buff_1, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

55:                                               ; preds = %19
  %56 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_1_buff_2, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

57:                                               ; preds = %19
  %58 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_1_buff_3, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

59:                                               ; preds = %19
  %60 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_1_buff_4, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

61:                                               ; preds = %19
  %62 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_1_buff_5, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

63:                                               ; preds = %19
  %64 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_1_buff_6, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

65:                                               ; preds = %19
  %66 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_12_join_0_1_buff_7, i64 0, [2 x i64] [i64 32, i64 32], [2 x i64] [i64 32, i64 1] }, %19 ]
  br label %20

67:                                               ; preds = %27
  %68 = phi ptr [ @of_11_broadcast_1_1_cons_buff_0, %27 ]
  br label %28

69:                                               ; preds = %27
  %70 = phi ptr [ @of_11_broadcast_1_1_cons_buff_1, %27 ]
  br label %28

71:                                               ; preds = %31
  %72 = phi ptr [ @of_7_broadcast_0_0_1_cons_buff_0, %31 ]
  br label %33

73:                                               ; preds = %31
  %74 = phi ptr [ @of_7_broadcast_0_0_1_cons_buff_1, %31 ]
  br label %33
}
