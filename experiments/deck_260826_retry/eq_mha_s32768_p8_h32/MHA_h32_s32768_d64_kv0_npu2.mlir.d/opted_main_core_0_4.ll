; ModuleID = '/home/micas/iron-stream-dse/experiments/deck_260826_retry/eq_mha_s32768_p8_h32/MHA_h32_s32768_d64_kv0_npu2.mlir.d/peano-linked_main_core_0_4.ll'
...
.lr.ph23:                                         ; preds = %8, %68
  ...
  %20 = select i1 %cond2, ptr @memV_0_cons_buff_1, ptr @memV_0_cons_buff_0
...
.lr.ph:                                           ; preds = %.lr.ph23, %.lr.ph
  ...
  %37 = select i1 %cond5, ptr @memV_0_cons_buff_1, ptr @memV_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 1, i32 -1)
...
55:                                               ; preds = %.loopexit
  ...
  %56 = select i1 %cond8, ptr @memV_0_cons_buff_1, ptr @memV_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 1, i32 -1)
