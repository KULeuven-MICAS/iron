...
33:                                               ; preds = %125, %127, %31
  %34 = phi ptr [ %128, %127 ], [ %126, %125 ], [ @of_8_switch_join_0_0_buff_0, %31 ]
...
44:                                               ; preds = %129, %131, %42
  %45 = phi ptr [ %132, %131 ], [ %130, %129 ], [ @of_8_switch_join_0_1_buff_0, %42 ]
...
61:                                               ; preds = %133, %135, %60
  %62 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ %136, %135 ], [ %134, %133 ], [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %60 ]
  br label %63
...
125:                                              ; preds = %31
  %126 = phi ptr [ @of_8_switch_join_0_0_buff_0, %31 ]
  br label %33

127:                                              ; preds = %31
  %128 = phi ptr [ @of_8_switch_join_0_0_buff_1, %31 ]
  br label %33

129:                                              ; preds = %42
  %130 = phi ptr [ @of_8_switch_join_0_1_buff_0, %42 ]
  br label %44

131:                                              ; preds = %42
  %132 = phi ptr [ @of_8_switch_join_0_1_buff_1, %42 ]
  br label %44

133:                                              ; preds = %60
  %134 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_0_buff_0, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %60 ]
  br label %61

135:                                              ; preds = %60
  %136 = phi { ptr, ptr, i64, [2 x i64], [2 x i64] } [ { ptr inttoptr (i64 3735928559 to ptr), ptr @of_9_unicast_0_buff_1, i64 0, [2 x i64] [i64 64, i64 64], [2 x i64] [i64 64, i64 1] }, %60 ]
  br label %61
