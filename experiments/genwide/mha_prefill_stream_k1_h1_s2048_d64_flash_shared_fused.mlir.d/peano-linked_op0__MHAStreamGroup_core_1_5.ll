...
19:                                               ; preds = %59, %61, %17
  %20 = phi ptr [ %62, %61 ], [ %60, %59 ], [ @of_4_broadcast_0_0_1_cons_buff_0, %17 ]
...
30:                                               ; preds = %63, %65, %28
  %31 = phi ptr [ %66, %65 ], [ %64, %63 ], [ @of_6_unicast_1_buff_0, %28 ]
...
34:                                               ; preds = %67, %69, %33
  %35 = phi ptr [ %70, %69 ], [ %68, %67 ], [ @of_3_unicast_1_0_cons_buff_0, %33 ]
...
59:                                               ; preds = %17
  %60 = phi ptr [ @of_4_broadcast_0_0_1_cons_buff_0, %17 ]
  br label %19

61:                                               ; preds = %17
  %62 = phi ptr [ @of_4_broadcast_0_0_1_cons_buff_1, %17 ]
  br label %19

63:                                               ; preds = %28
  %64 = phi ptr [ @of_6_unicast_1_buff_0, %28 ]
  br label %30

65:                                               ; preds = %28
  %66 = phi ptr [ @of_6_unicast_1_buff_1, %28 ]
  br label %30

67:                                               ; preds = %33
  %68 = phi ptr [ @of_3_unicast_1_0_cons_buff_0, %33 ]
  br label %34

69:                                               ; preds = %33
  %70 = phi ptr [ @of_3_unicast_1_0_cons_buff_1, %33 ]
  br label %34
}
