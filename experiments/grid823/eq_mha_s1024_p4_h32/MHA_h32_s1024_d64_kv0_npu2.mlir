module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<32x1024x64xbf16>, %arg1: memref<32x65536xbf16>, %arg2: memref<32x65536xbf16>, %arg3: memref<32x1024x64xbf16>) {
      ...
      aiex.npu.rtp_write(@mha_rtpss_0_stage0, 3, %c1024_i32_25) : i32
      %c4_i32_26 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage0, 0, %c4_i32_26) : i32
      %c16_i32_27 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage0, 1, %c16_i32_27) : i32
      %c1024_i32_28 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage0, 2, %c1024_i32_28) : i32
      %c1024_i32_29 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage0, 3, %c1024_i32_29) : i32
      %c4_i32_30 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage0, 0, %c4_i32_30) : i32
      %c16_i32_31 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage0, 1, %c16_i32_31) : i32
      %c1024_i32_32 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage0, 2, %c1024_i32_32) : i32
      %c1024_i32_33 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage0, 3, %c1024_i32_33) : i32
      %c4_i32_34 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage0, 0, %c4_i32_34) : i32
      %c16_i32_35 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage0, 1, %c16_i32_35) : i32
      %c1024_i32_36 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage0, 2, %c1024_i32_36) : i32
      %c1024_i32_37 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage0, 3, %c1024_i32_37) : i32
      %c4_i32_38 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 0, %c4_i32_38) : i32
      %c16_i32_39 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 1, %c16_i32_39) : i32
      %c1024_i32_40 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 2, %c1024_i32_40) : i32
      %c1024_i32_41 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage1, 3, %c1024_i32_41) : i32
      %c4_i32_42 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage1, 0, %c4_i32_42) : i32
      %c16_i32_43 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage1, 1, %c16_i32_43) : i32
      %c1024_i32_44 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage1, 2, %c1024_i32_44) : i32
      %c1024_i32_45 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage1, 3, %c1024_i32_45) : i32
      %c4_i32_46 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage1, 0, %c4_i32_46) : i32
      %c16_i32_47 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage1, 1, %c16_i32_47) : i32
      %c1024_i32_48 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage1, 2, %c1024_i32_48) : i32
      %c1024_i32_49 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage1, 3, %c1024_i32_49) : i32
      %c4_i32_50 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage1, 0, %c4_i32_50) : i32
      %c16_i32_51 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage1, 1, %c16_i32_51) : i32
      %c1024_i32_52 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage1, 2, %c1024_i32_52) : i32
      %c1024_i32_53 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage1, 3, %c1024_i32_53) : i32
      %c4_i32_54 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 0, %c4_i32_54) : i32
      %c16_i32_55 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 1, %c16_i32_55) : i32
      %c1024_i32_56 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 2, %c1024_i32_56) : i32
      %c1024_i32_57 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_0_stage2, 3, %c1024_i32_57) : i32
      %c4_i32_58 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage2, 0, %c4_i32_58) : i32
      %c16_i32_59 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage2, 1, %c16_i32_59) : i32
      %c1024_i32_60 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage2, 2, %c1024_i32_60) : i32
      %c1024_i32_61 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_1_stage2, 3, %c1024_i32_61) : i32
      %c4_i32_62 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage2, 0, %c4_i32_62) : i32
      %c16_i32_63 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage2, 1, %c16_i32_63) : i32
      %c1024_i32_64 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage2, 2, %c1024_i32_64) : i32
      %c1024_i32_65 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_2_stage2, 3, %c1024_i32_65) : i32
      %c4_i32_66 = arith.constant 4 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage2, 0, %c4_i32_66) : i32
      %c16_i32_67 = arith.constant 16 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage2, 1, %c16_i32_67) : i32
      %c1024_i32_68 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage2, 2, %c1024_i32_68) : i32
      %c1024_i32_69 = arith.constant 1024 : i32
      aiex.npu.rtp_write(@mha_rtpss_3_stage2, 3, %c1024_i32_69) : i32
