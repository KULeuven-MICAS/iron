  ...
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<32768x64xbf16>, %arg1: memref<64x32768xbf16>, %arg2: memref<32768x64xbf16>, %arg3: memref<32768x64xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<32768x64xbf16> offset = 0 len = 524288 sizes = [1, 128, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @of_0_mem_1 {
        aie.dma_bd(%arg0 : memref<32768x64xbf16> offset = 4096 len = 524288 sizes = [1, 128, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @of_0_mem_2 {
        aie.dma_bd(%arg0 : memref<32768x64xbf16> offset = 8192 len = 524288 sizes = [1, 128, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @of_0_mem_3 {
        aie.dma_bd(%arg0 : memref<32768x64xbf16> offset = 12288 len = 524288 sizes = [1, 128, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      ...
      %6 = aiex.dma_configure_task_for @of_11_mem_0 {
        aie.dma_bd(%arg3 : memref<32768x64xbf16> offset = 0 len = 524288 sizes = [1, 128, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @of_11_mem_1 {
        aie.dma_bd(%arg3 : memref<32768x64xbf16> offset = 4096 len = 524288 sizes = [1, 128, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%7)
      %8 = aiex.dma_configure_task_for @of_11_mem_2 {
        aie.dma_bd(%arg3 : memref<32768x64xbf16> offset = 8192 len = 524288 sizes = [1, 128, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      aiex.dma_start_task(%8)
      %9 = aiex.dma_configure_task_for @of_11_mem_3 {
        aie.dma_bd(%arg3 : memref<32768x64xbf16> offset = 12288 len = 524288 sizes = [1, 128, 64, 64] strides = [0, 16384, 64, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index}
      ...
      %10 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x32768xbf16> offset = 0 len = 2097152 sizes = [32, 512, 64, 64] strides = [0, 64, 32768, 1])
        aie.end
      } {issue_token = true, iteration_t = 65536 : index, repeat_count = 31 : i32}
      ...
      %14 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x32768xbf16> offset = 0 len = 2097152 sizes = [32, 512, 64, 64] strides = [0, 64, 32768, 1])
        aie.end
      } {issue_token = true, iteration_t = 196608 : index, repeat_count = 31 : i32}
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<6291456xbf16>, %arg1: memref<2097152xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [2097152] [1] : memref<6291456xbf16> to memref<2097152xbf16>
        ...
        %subview_0 = memref.subview %arg0[2097152] [2097152] [1] : memref<6291456xbf16> to memref<2097152xbf16, strided<[1], offset: 2097152>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 32768], strides: [32768, 1] : memref<2097152xbf16, strided<[1], offset: 2097152>> to memref<64x32768xbf16>
        %subview_2 = memref.subview %arg0[4194304] [2097152] [1] : memref<6291456xbf16> to memref<2097152xbf16, strided<[1], offset: 4194304>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [32768, 64], strides: [64, 1] : memref<2097152xbf16, strided<[1], offset: 4194304>> to memref<32768x64xbf16>
        %subview_4 = memref.subview %arg1[0] [2097152] [1] : memref<2097152xbf16> to memref<2097152xbf16>
