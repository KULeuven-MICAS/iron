  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<3145728xbf16>, %arg1: memref<1048576xbf16>, %arg2: memref<1xbf16>) {
      aiex.configure @op0__MHAStreamGroup {
        %subview = memref.subview %arg0[0] [1048576] [1] : memref<3145728xbf16> to memref<1048576xbf16>
        ...
        %subview_0 = memref.subview %arg0[1048576] [1048576] [1] : memref<3145728xbf16> to memref<1048576xbf16, strided<[1], offset: 1048576>>
        %reinterpret_cast_1 = memref.reinterpret_cast %subview_0 to offset: [0], sizes: [64, 16384], strides: [16384, 1] : memref<1048576xbf16, strided<[1], offset: 1048576>> to memref<64x16384xbf16>
        %subview_2 = memref.subview %arg0[2097152] [1048576] [1] : memref<3145728xbf16> to memref<1048576xbf16, strided<[1], offset: 2097152>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [16384, 64], strides: [64, 1] : memref<1048576xbf16, strided<[1], offset: 2097152>> to memref<16384x64xbf16>
        %subview_4 = memref.subview %arg1[0] [1048576] [1] : memref<1048576xbf16> to memref<1048576xbf16>
