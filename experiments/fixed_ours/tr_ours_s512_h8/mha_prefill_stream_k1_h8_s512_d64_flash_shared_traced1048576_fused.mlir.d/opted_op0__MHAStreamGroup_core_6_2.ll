; ModuleID = '/home/micas/iron-stream-dse/experiments/fixed_ours/tr_ours_s512_h8/mha_prefill_stream_k1_h8_s512_d64_flash_shared_traced1048576_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_6_2.ll'
...
5:                                                ; preds = %1, %12
  ...
  %spec.select = select i1 %cond, ptr @of_6_unicast_6_buff_1, ptr @of_6_unicast_6_buff_0
  tail call void @op0_zero_bf16_64_64_64(ptr nonnull %spec.select)
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %9 = icmp samesign ult i64 %8, 7
  br i1 %9, label %10, label %12

10:                                               ; preds = %5
  %cond1 = icmp eq i32 %6, 1
  %11 = select i1 %cond1, ptr @of_4_broadcast_0_0_6_cons_buff_1, ptr @of_4_broadcast_0_0_6_cons_buff_0
  tail call void @op0_matmul_bf16_bf16_64_64_64(ptr nonnull @of_3_unicast_6_0_cons_buff_0, ptr nonnull %11, ptr nonnull %spec.select)
  br label %12
