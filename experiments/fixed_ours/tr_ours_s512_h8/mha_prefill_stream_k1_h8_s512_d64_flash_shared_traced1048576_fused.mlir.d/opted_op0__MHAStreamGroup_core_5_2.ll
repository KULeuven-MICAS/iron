; ModuleID = '/home/micas/iron-stream-dse/experiments/fixed_ours/tr_ours_s512_h8/mha_prefill_stream_k1_h8_s512_d64_flash_shared_traced1048576_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_5_2.ll'
...
5:                                                ; preds = %1, %12
  ...
  %spec.select = select i1 %cond, ptr @of_6_unicast_5_buff_1, ptr @of_6_unicast_5_buff_0
...
10:                                               ; preds = %5
  ...
  %11 = select i1 %cond1, ptr @of_4_broadcast_0_0_5_cons_buff_1, ptr @of_4_broadcast_0_0_5_cons_buff_0
  tail call void @op0_matmul_bf16_bf16_64_64_64(ptr nonnull @of_3_unicast_5_0_cons_buff_0, ptr nonnull %11, ptr nonnull %spec.select)
  br label %12
