; ModuleID = '/home/micas/iron-stream-dse/experiments/fixed_ours/tr_ours_s512_h8/mha_prefill_stream_k1_h8_s512_d64_flash_shared_traced1048576_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_5_4.ll'
...
7:                                                ; preds = %1, %19
  ...
  %12 = select i1 %cond2, ptr @of_5_broadcast_0_0_5_cons_buff_1, ptr @of_5_broadcast_0_0_5_cons_buff_0
  %13 = trunc nuw nsw i64 %11 to i32
  store i32 %13, ptr @flash_index_5_4, align 4
  store i32 5, ptr getelementptr inbounds nuw (i8, ptr @flash_index_5_4, i20 4), align 4
  tail call void @llvm.aie2p.acquire(i32 5, i32 -1)
  %cond3 = icmp eq i32 %8, 1
  %14 = select i1 %cond3, ptr @flash_scale_5_3_5_4_buff_1, ptr @flash_scale_5_3_5_4_buff_0
  %15 = icmp ne i32 %13, 0
  %16 = zext i1 %15 to i32
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %12, ptr nonnull %spec.select, ptr nonnull %14, i32 64, i32 %16, ptr nonnull @flash_index_5_4)
  %17 = icmp eq i32 %13, 7
  br i1 %17, label %18, label %19

18:                                               ; preds = %7
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %14, i32 64, ptr nonnull @flash_index_5_4)
  br label %19
