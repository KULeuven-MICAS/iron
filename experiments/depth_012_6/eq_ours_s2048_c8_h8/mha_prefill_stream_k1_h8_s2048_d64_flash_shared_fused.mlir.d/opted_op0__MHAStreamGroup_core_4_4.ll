; ModuleID = '/home/micas/iron-stream-dse/experiments/depth_012_6/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_4_4.ll'
...
@switch.table.core_4_4 = private unnamed_addr constant [5 x ptr] [ptr @flash_scale_4_3_buff_1, ptr @flash_scale_4_3_buff_2, ptr @flash_scale_4_3_buff_3, ptr @flash_scale_4_3_buff_4, ptr @flash_scale_4_3_buff_5], align 4
...
15:                                               ; preds = %6, %30
  ...
  %spec.select4 = select i1 %cond1, ptr @of_9_unicast_4_0_cons_buff_1, ptr @of_9_unicast_4_0_cons_buff_0
...
switch.lookup:                                    ; preds = %15
  ...
  %switch.gep = getelementptr inbounds nuw [5 x ptr], ptr @switch.table.core_4_4, i20 0, i20 %23
  %switch.load = load ptr, ptr %switch.gep, align 4
  br label %24

24:                                               ; preds = %switch.lookup, %15
  %25 = phi ptr [ @flash_scale_4_3_buff_0, %15 ], [ %switch.load, %switch.lookup ]
  %26 = icmp ne i32 %21, 0
  %27 = zext i1 %26 to i32
  tail call void @op0_matmul_PV(ptr nonnull %spec.select4, ptr nonnull %20, ptr nonnull %spec.select, ptr nonnull %25, i32 64, i32 %27, ptr nonnull @flash_index_4_4)
  %28 = icmp eq i32 %21, 31
  br i1 %28, label %29, label %30

29:                                               ; preds = %24
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %25, i32 64, ptr nonnull @flash_index_4_4)
  br label %30
