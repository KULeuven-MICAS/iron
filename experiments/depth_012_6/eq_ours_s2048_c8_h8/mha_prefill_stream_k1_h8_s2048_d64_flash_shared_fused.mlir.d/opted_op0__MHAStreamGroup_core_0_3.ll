; ModuleID = '/home/micas/iron-stream-dse/experiments/depth_012_6/eq_ours_s2048_c8_h8/mha_prefill_stream_k1_h8_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_3.ll'
...
@switch.table.core_0_3 = private unnamed_addr constant [5 x ptr] [ptr @flash_scale_0_3_buff_1, ptr @flash_scale_0_3_buff_2, ptr @flash_scale_0_3_buff_3, ptr @flash_scale_0_3_buff_4, ptr @flash_scale_0_3_buff_5], align 4
...
12:                                               ; preds = %5, %24
  ...
  %17 = select i1 %cond1, ptr @of_7_unicast_0_0_cons_buff_1, ptr @of_7_unicast_0_0_cons_buff_0
...
21:                                               ; preds = %20, %12
  tail call void @op0_partial_softmax(ptr nonnull %17, ptr nonnull %spec.select, ptr nonnull @flash_state_0_3, ptr nonnull @flash_index_0_3, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048)
...
switch.lookup:                                    ; preds = %21
  ...
  %switch.gep = getelementptr inbounds nuw [5 x ptr], ptr @switch.table.core_0_3, i20 0, i20 %23
