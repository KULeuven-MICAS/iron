module {
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<3276800xbf16>, %arg1: memref<131072xbf16>, %arg2: memref<2097152xbf16>, %arg3: memref<65536xi8>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        ...
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %arg3) : (memref<256x512xbf16>, memref<512x2048xbf16>, memref<256x2048xbf16>, memref<65536xi8>)
      }
