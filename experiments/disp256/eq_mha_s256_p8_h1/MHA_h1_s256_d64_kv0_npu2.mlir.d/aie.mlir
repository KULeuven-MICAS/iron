module {
  aie.device(npu2) {
    ...
    aie.runtime_sequence(%arg0: memref<1x512x64xbf16>, %arg1: memref<1x32768xbf16>, %arg2: memref<1x32768xbf16>, %arg3: memref<1x512x64xbf16>) {
      %c1_i32 = arith.constant 1 : i32
      ...
      %0 = aiex.dma_configure_task_for @inQ {
        aie.dma_bd(%arg0 : memref<1x512x64xbf16> offset = 0 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @inQ2 {
        aie.dma_bd(%arg0 : memref<1x512x64xbf16> offset = 16384 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @inK {
        aie.dma_bd(%arg1 : memref<1x32768xbf16> offset = 0 len = 32768 sizes = [1, 1, 512, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @inV {
        aie.dma_bd(%arg2 : memref<1x32768xbf16> offset = 0 len = 32768 sizes = [1, 1, 512, 64] strides = [0, 0, 64, 1])
        aie.end
      }
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @memO {
        aie.dma_bd(%arg3 : memref<1x512x64xbf16> offset = 0 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @memO2 {
        aie.dma_bd(%arg3 : memref<1x512x64xbf16> offset = 16384 len = 16384 sizes = [1, 1, 256, 64] strides = [0, 0, 64, 1])
        aie.end
      } {issue_token = true}
