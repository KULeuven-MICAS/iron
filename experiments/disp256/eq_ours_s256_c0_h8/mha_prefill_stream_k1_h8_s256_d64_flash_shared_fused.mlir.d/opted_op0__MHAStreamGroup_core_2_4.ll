; ModuleID = '/home/micas/iron-stream-dse/experiments/disp256/eq_ours_s256_c0_h8/mha_prefill_stream_k1_h8_s256_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_2_4.ll'
...
7:                                                ; preds = %1, %19
  ...
  %spec.select5 = select i1 %cond1, ptr @of_9_unicast_2_0_cons_buff_1, ptr @of_9_unicast_2_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2 = icmp eq i32 %9, 1
  %12 = select i1 %cond2, ptr @of_5_broadcast_0_0_2_cons_buff_1, ptr @of_5_broadcast_0_0_2_cons_buff_0
  %13 = trunc nuw nsw i64 %11 to i32
  store i32 %13, ptr @flash_index_2_4, align 4
  store i32 2, ptr getelementptr inbounds nuw (i8, ptr @flash_index_2_4, i20 4), align 4
  tail call void @llvm.aie2p.acquire(i32 5, i32 -1)
  %cond3 = icmp eq i32 %8, 1
  %14 = select i1 %cond3, ptr @flash_scale_2_3_2_4_buff_1, ptr @flash_scale_2_3_2_4_buff_0
  %15 = icmp ne i32 %13, 0
  %16 = zext i1 %15 to i32
  tail call void @op0_matmul_PV(ptr nonnull %spec.select5, ptr nonnull %12, ptr nonnull %spec.select, ptr nonnull %14, i32 64, i32 %16, ptr nonnull @flash_index_2_4)
  %17 = icmp eq i32 %13, 3
  br i1 %17, label %18, label %19

18:                                               ; preds = %7
  tail call void @op0_rescale_O(ptr nonnull %spec.select, ptr nonnull %14, i32 64, ptr nonnull @flash_index_2_4)
  br label %19
