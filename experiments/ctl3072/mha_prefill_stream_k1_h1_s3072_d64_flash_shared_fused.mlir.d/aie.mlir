  ...
  aie.device(npu2) @op0__MHAStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<3072x64xbf16>, %arg1: memref<64x3072xbf16>, %arg2: memref<3072x64xbf16>, %arg3: memref<3072x64xbf16>) {
      ...
      %8 = aiex.dma_configure_task_for @of_1_mem {
        aie.dma_bd(%arg1 : memref<64x3072xbf16> offset = 0 len = 196608 sizes = [6, 48, 64, 64] strides = [0, 64, 3072, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 5 : i32}
      aiex.dma_start_task(%8)
      %9 = aiex.dma_configure_task_for @of_2_mem {
        aie.dma_bd(%arg2 : memref<3072x64xbf16> offset = 0 len = 196608 sizes = [6, 1, 384, 512] strides = [0, 0, 512, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 5 : i32}
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c48 step %c1_1 {
            ...
            %16 = arith.cmpi eq, %8, %c47_i32 : i32
            scf.if %16 {
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c48 step %c1_1 {
            ...
            func.call @op0_partial_softmax(%3, %1, %flash_state_0_3, %flash_index_0_3, %11, %c64_i32, %c64_i32_6, %c3072_i32, %c3072_i32_7) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c48 step %c1_1 {
            ...
            %c3072_i32_7 = arith.constant 3072 : i32
            %c0_i32_8 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_1_3, %flash_index_1_3, %11, %c64_i32, %c64_i32_6, %c3072_i32, %c3072_i32_7) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c48 step %c1_1 {
            ...
            func.call @op0_partial_softmax(%3, %1, %flash_state_2_3, %flash_index_2_3, %11, %c64_i32, %c64_i32_5, %c3072_i32, %c3072_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c48 step %c1_1 {
            ...
            %c3072_i32_6 = arith.constant 3072 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_3_3, %flash_index_3_3, %11, %c64_i32, %c64_i32_5, %c3072_i32, %c3072_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c48 step %c1_1 {
            ...
            %c3072_i32_6 = arith.constant 3072 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_4_3, %flash_index_4_3, %11, %c64_i32, %c64_i32_5, %c3072_i32, %c3072_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c48 step %c1_1 {
            ...
            %c3072_i32_6 = arith.constant 3072 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_5_3, %flash_index_5_3, %11, %c64_i32, %c64_i32_5, %c3072_i32, %c3072_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c48 step %c1_1 {
            ...
            %c3072_i32_6 = arith.constant 3072 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_6_3, %flash_index_6_3, %11, %c64_i32, %c64_i32_5, %c3072_i32, %c3072_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c6 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c48 step %c1_1 {
            ...
            %c3072_i32_6 = arith.constant 3072 : i32
            %c0_i32_7 = arith.constant 0 : i32
            func.call @op0_partial_softmax(%3, %1, %flash_state_7_3, %flash_index_7_3, %11, %c64_i32, %c64_i32_5, %c3072_i32, %c3072_i32_6) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
