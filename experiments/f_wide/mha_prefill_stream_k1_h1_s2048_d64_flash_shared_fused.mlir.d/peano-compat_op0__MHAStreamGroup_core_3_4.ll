...
33:                                               ; preds = %30
  ...
  store i32 %34, ptr @flash_index_3_4
  store i32 %16, ptr getelementptr inbounds nuw (i8, ptr @flash_index_3_4, i64 4)
  %35 = icmp eq i32 %34, 0
...
37:                                               ; preds = %36, %33
  call void @op0_partial_softmax_tiled(ptr %32, ptr %27, ptr @flash_state_3_4, ptr @flash_index_3_4, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048)
...
39:                                               ; preds = %66, %68, %37
  %40 = phi ptr [ %69, %68 ], [ %67, %66 ], [ @flash_scale_3_4_buff_0, %37 ]
  %41 = getelementptr [256 x bfloat], ptr %40, i32 0, i32 0
  br label %42

42:                                               ; preds = %39
  call void @op0_passThroughLine(ptr @flash_state_3_4, ptr %41, i32 256)
...
66:                                               ; preds = %37
  %67 = phi ptr [ @flash_scale_3_4_buff_0, %37 ]
  br label %39

68:                                               ; preds = %37
  %69 = phi ptr [ @flash_scale_3_4_buff_1, %37 ]
  br label %39
}
