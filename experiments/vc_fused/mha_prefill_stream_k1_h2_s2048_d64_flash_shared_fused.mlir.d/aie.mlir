      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c32 step %c1_1 {
            ...
            %c2048_i32 = arith.constant 2048 : i32
            %c2048_i32_7 = arith.constant 2048 : i32
            func.call @op0_matmul_softmax(%1, %5, %3, %flash_state_1_3, %flash_index_1_3, %13, %c64_i32, %c64_i32_6, %c2048_i32, %c2048_i32_7) : (memref<64x64xbf16>, memref<64x64xbf16>, memref<64x64xbf16>, memref<256xbf16>, memref<2xi32>, bf16, i32, i32, i32, i32) -> ()
