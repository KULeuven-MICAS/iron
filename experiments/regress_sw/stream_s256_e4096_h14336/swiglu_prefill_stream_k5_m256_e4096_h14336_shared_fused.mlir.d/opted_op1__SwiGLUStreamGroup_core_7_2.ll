; ModuleID = '/home/micas/iron-stream-dse/experiments/regress_sw/stream_s256_e4096_h14336/swiglu_prefill_stream_k5_m256_e4096_h14336_shared_fused.mlir.d/peano-linked_op1__SwiGLUStreamGroup_core_7_2.ll'
...
.preheader:                                       ; preds = %.preheader2, %.preheader
  ...
  %spec.select = select i1 %cond, ptr @of_2_unicast_7_buff_1, ptr @of_2_unicast_7_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1 = icmp eq i32 %4, 1
  %7 = select i1 %cond1, ptr @of_1_unicast_7_0_cons_buff_1, ptr @of_1_unicast_7_0_cons_buff_0
  ...
  %spec.select.1 = select i1 %cond.1, ptr @of_2_unicast_7_buff_1, ptr @of_2_unicast_7_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.1 = icmp eq i32 %10, 1
  %14 = select i1 %cond1.1, ptr @of_1_unicast_7_0_cons_buff_1, ptr @of_1_unicast_7_0_cons_buff_0
  ...
  %spec.select.2 = select i1 %cond.2, ptr @of_2_unicast_7_buff_1, ptr @of_2_unicast_7_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.2 = icmp eq i32 %17, 1
  %21 = select i1 %cond1.2, ptr @of_1_unicast_7_0_cons_buff_1, ptr @of_1_unicast_7_0_cons_buff_0
  ...
  %spec.select.3 = select i1 %cond.3, ptr @of_2_unicast_7_buff_1, ptr @of_2_unicast_7_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.3 = icmp eq i32 %24, 1
  %28 = select i1 %cond1.3, ptr @of_1_unicast_7_0_cons_buff_1, ptr @of_1_unicast_7_0_cons_buff_0
  ...
  %spec.select.4 = select i1 %cond.4, ptr @of_2_unicast_7_buff_1, ptr @of_2_unicast_7_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.4 = icmp eq i32 %31, 1
  %35 = select i1 %cond1.4, ptr @of_1_unicast_7_0_cons_buff_1, ptr @of_1_unicast_7_0_cons_buff_0
  ...
  %spec.select.5 = select i1 %cond.5, ptr @of_2_unicast_7_buff_1, ptr @of_2_unicast_7_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.5 = icmp eq i32 %38, 1
  %42 = select i1 %cond1.5, ptr @of_1_unicast_7_0_cons_buff_1, ptr @of_1_unicast_7_0_cons_buff_0
  ...
  %spec.select.6 = select i1 %cond.6, ptr @of_2_unicast_7_buff_1, ptr @of_2_unicast_7_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.6 = icmp eq i32 %45, 1
  %49 = select i1 %cond1.6, ptr @of_1_unicast_7_0_cons_buff_1, ptr @of_1_unicast_7_0_cons_buff_0
