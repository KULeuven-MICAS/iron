; ModuleID = '/home/micas/iron-stream-dse/experiments/regress_sw/stream_s256_e4096_h14336/swiglu_prefill_stream_k5_m256_e4096_h14336_shared_fused.mlir.d/peano-linked_op2__SwiGLUStreamGroup_core_0_2.ll'
...
.preheader:                                       ; preds = %.preheader3, %.preheader
  ...
  %spec.select = select i1 %cond, ptr @of_4_unicast_0_buff_1, ptr @of_4_unicast_0_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1 = icmp eq i32 %6, 1
  %9 = select i1 %cond1, ptr @of_3_unicast_0_0_cons_buff_1, ptr @of_3_unicast_0_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2 = icmp eq i32 %5, 1
  %10 = select i1 %cond2, ptr @of_2_unicast_0_0_cons_buff_1, ptr @of_2_unicast_0_0_cons_buff_0
  ...
  %spec.select.1 = select i1 %cond.1, ptr @of_4_unicast_0_buff_1, ptr @of_4_unicast_0_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.1 = icmp eq i32 %16, 1
  %20 = select i1 %cond1.1, ptr @of_3_unicast_0_0_cons_buff_1, ptr @of_3_unicast_0_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2.1 = icmp eq i32 %13, 1
  %21 = select i1 %cond2.1, ptr @of_2_unicast_0_0_cons_buff_1, ptr @of_2_unicast_0_0_cons_buff_0
  ...
  %spec.select.2 = select i1 %cond.2, ptr @of_4_unicast_0_buff_1, ptr @of_4_unicast_0_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.2 = icmp eq i32 %27, 1
  %31 = select i1 %cond1.2, ptr @of_3_unicast_0_0_cons_buff_1, ptr @of_3_unicast_0_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2.2 = icmp eq i32 %24, 1
  %32 = select i1 %cond2.2, ptr @of_2_unicast_0_0_cons_buff_1, ptr @of_2_unicast_0_0_cons_buff_0
  ...
  %spec.select.3 = select i1 %cond.3, ptr @of_4_unicast_0_buff_1, ptr @of_4_unicast_0_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.3 = icmp eq i32 %38, 1
  %42 = select i1 %cond1.3, ptr @of_3_unicast_0_0_cons_buff_1, ptr @of_3_unicast_0_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2.3 = icmp eq i32 %35, 1
  %43 = select i1 %cond2.3, ptr @of_2_unicast_0_0_cons_buff_1, ptr @of_2_unicast_0_0_cons_buff_0
  ...
  %spec.select.4 = select i1 %cond.4, ptr @of_4_unicast_0_buff_1, ptr @of_4_unicast_0_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.4 = icmp eq i32 %49, 1
  %53 = select i1 %cond1.4, ptr @of_3_unicast_0_0_cons_buff_1, ptr @of_3_unicast_0_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2.4 = icmp eq i32 %46, 1
  %54 = select i1 %cond2.4, ptr @of_2_unicast_0_0_cons_buff_1, ptr @of_2_unicast_0_0_cons_buff_0
  ...
  %spec.select.5 = select i1 %cond.5, ptr @of_4_unicast_0_buff_1, ptr @of_4_unicast_0_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.5 = icmp eq i32 %60, 1
  %64 = select i1 %cond1.5, ptr @of_3_unicast_0_0_cons_buff_1, ptr @of_3_unicast_0_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2.5 = icmp eq i32 %57, 1
  %65 = select i1 %cond2.5, ptr @of_2_unicast_0_0_cons_buff_1, ptr @of_2_unicast_0_0_cons_buff_0
  ...
  %spec.select.6 = select i1 %cond.6, ptr @of_4_unicast_0_buff_1, ptr @of_4_unicast_0_buff_0
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  %cond1.6 = icmp eq i32 %71, 1
  %75 = select i1 %cond1.6, ptr @of_3_unicast_0_0_cons_buff_1, ptr @of_3_unicast_0_0_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2.6 = icmp eq i32 %68, 1
  %76 = select i1 %cond2.6, ptr @of_2_unicast_0_0_cons_buff_1, ptr @of_2_unicast_0_0_cons_buff_0
