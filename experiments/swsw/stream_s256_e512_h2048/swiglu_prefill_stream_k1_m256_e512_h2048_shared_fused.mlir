module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.objectfifo @of_4_distribute_1_2(%mem_tile_7_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_1_4, %tile_3_4}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
