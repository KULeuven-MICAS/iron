; ModuleID = '/home/micas/iron-stream-dse/experiments/swsw/stream_s256_e2048_h8192/swiglu_prefill_stream_k2_m256_e2048_h8192_shared_fused.mlir.d/peano-linked_op0__SwiGLUStreamGroup_core_2_5.ll'
...
14:                                               ; preds = %14, %9
  ...
  %spec.select4 = select i1 %cond1, ptr @of_5_broadcast_0_0_3_cons_buff_1, ptr @of_5_broadcast_0_0_3_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2 = icmp eq i32 %15, 1
  %18 = select i1 %cond2, ptr @of_3_distribute_0_3_0_cons_buff_1, ptr @of_3_distribute_0_3_0_cons_buff_0
  ...
  %spec.select4.1 = select i1 %cond1.1, ptr @of_5_broadcast_0_0_3_cons_buff_1, ptr @of_5_broadcast_0_0_3_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2.1 = icmp eq i32 %21, 1
  %25 = select i1 %cond2.1, ptr @of_3_distribute_0_3_0_cons_buff_1, ptr @of_3_distribute_0_3_0_cons_buff_0
  ...
  %spec.select4.2 = select i1 %cond1.2, ptr @of_5_broadcast_0_0_3_cons_buff_1, ptr @of_5_broadcast_0_0_3_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2.2 = icmp eq i32 %28, 1
  %32 = select i1 %cond2.2, ptr @of_3_distribute_0_3_0_cons_buff_1, ptr @of_3_distribute_0_3_0_cons_buff_0
  ...
  %spec.select4.3 = select i1 %cond1.3, ptr @of_5_broadcast_0_0_3_cons_buff_1, ptr @of_5_broadcast_0_0_3_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2.3 = icmp eq i32 %35, 1
  %40 = select i1 %cond2.3, ptr @of_3_distribute_0_3_0_cons_buff_1, ptr @of_3_distribute_0_3_0_cons_buff_0
  ...
  %48 = icmp samesign ult i64 %39, 63
