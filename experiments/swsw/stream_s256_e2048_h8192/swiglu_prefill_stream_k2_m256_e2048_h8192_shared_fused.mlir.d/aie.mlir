module {
  aie.device(npu2) @op0__SwiGLUStreamGroup {
    ...
    aie.runtime_sequence(%arg0: memref<256x2048xbf16>, %arg1: memref<2048x8192xbf16>, %arg2: memref<2048x8192xbf16>, %arg3: memref<256x8192xbf16>) {
      %0 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x2048xbf16> offset = 0 len = 262144 sizes = [32, 64, 128, 32] strides = [0, 32, 2048, 1])
        aie.end
      ...
      %2 = aiex.dma_configure_task_for @of_1_mem_0 {
        aie.dma_bd(%arg1 : memref<2048x8192xbf16> offset = 0 len = 131072 sizes = [32, 32, 64, 64] strides = [128, 524288, 8192, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @of_1_mem_1 {
        aie.dma_bd(%arg1 : memref<2048x8192xbf16> offset = 64 len = 131072 sizes = [32, 32, 64, 64] strides = [128, 524288, 8192, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @of_2_mem_0 {
        aie.dma_bd(%arg2 : memref<2048x8192xbf16> offset = 0 len = 131072 sizes = [32, 32, 64, 64] strides = [128, 524288, 8192, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @of_2_mem_1 {
        aie.dma_bd(%arg2 : memref<2048x8192xbf16> offset = 64 len = 131072 sizes = [32, 32, 64, 64] strides = [128, 524288, 8192, 1])
        aie.end
      } {issue_token = true, iteration_t = 0 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%5)
      %6 = aiex.dma_configure_task_for @of_10_mem {
        aie.dma_bd(%arg3 : memref<256x8192xbf16> offset = 0 len = 1048576 sizes = [2, 128, 128, 64] strides = [1048576, 64, 8192, 1])
        aie.end
      ...
      %7 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x2048xbf16> offset = 0 len = 262144 sizes = [32, 64, 128, 32] strides = [0, 32, 2048, 1])
        aie.end
      } {issue_token = true, iteration_t = 16384 : index, repeat_count = 31 : i32}
      ...
      %9 = aiex.dma_configure_task_for @of_1_mem_0 {
        aie.dma_bd(%arg1 : memref<2048x8192xbf16> offset = 4096 len = 131072 sizes = [32, 32, 64, 64] strides = [128, 524288, 8192, 1])
        aie.end
      } {issue_token = true, iteration_t = 16384 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%9)
      %10 = aiex.dma_configure_task_for @of_1_mem_1 {
        aie.dma_bd(%arg1 : memref<2048x8192xbf16> offset = 4160 len = 131072 sizes = [32, 32, 64, 64] strides = [128, 524288, 8192, 1])
        aie.end
      } {issue_token = true, iteration_t = 16384 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%10)
      %11 = aiex.dma_configure_task_for @of_2_mem_0 {
        aie.dma_bd(%arg2 : memref<2048x8192xbf16> offset = 4096 len = 131072 sizes = [32, 32, 64, 64] strides = [128, 524288, 8192, 1])
        aie.end
      } {issue_token = true, iteration_t = 16384 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%11)
      %12 = aiex.dma_configure_task_for @of_2_mem_1 {
        aie.dma_bd(%arg2 : memref<2048x8192xbf16> offset = 4160 len = 131072 sizes = [32, 32, 64, 64] strides = [128, 524288, 8192, 1])
        aie.end
      } {issue_token = true, iteration_t = 16384 : index, repeat_count = 31 : i32}
      aiex.dma_start_task(%12)
      aiex.dma_await_task(%0)
      %13 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x2048xbf16> offset = 262144 len = 262144 sizes = [32, 64, 128, 32] strides = [0, 32, 2048, 1])
        aie.end
      ...
      %19 = aiex.dma_configure_task_for @of_0_mem_0 {
        aie.dma_bd(%arg0 : memref<256x2048xbf16> offset = 262144 len = 262144 sizes = [32, 64, 128, 32] strides = [0, 32, 2048, 1])
        aie.end
      } {issue_token = true, iteration_t = 49152 : index, repeat_count = 31 : i32}
      ...
      scf.for %arg0 = %c0 to %c4294967295 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c2 step %c1_1 {
          ...
          scf.for %arg2 = %c0_0 to %c64 step %c1_1 {
            ...
            scf.for %arg3 = %c0_0 to %c64_2 step %c1_1 {
    ...
    aie.objectfifo @of_3_distribute_0_0(%mem_tile_6_1 dimensionsToStream [<size = 4, stride = 256>, <size = 4, stride = 8>, <size = 8, stride = 32>, <size = 8, stride = 1>], {%tile_0_2, %tile_2_2}, [2 : i32, 2 : i32, 2 : i32]) : !aie.objectfifo<memref<32x32xbf16>>  
  ...
  aie.device(npu2) {
    aie.runtime_sequence(%arg0: memref<50855936xbf16>, %arg1: memref<524288xbf16>, %arg2: memref<2097152xbf16>) {
      aiex.configure @op0__SwiGLUStreamGroup {
        ...
        %subview_2 = memref.subview %arg0[17301504] [16777216] [1] : memref<50855936xbf16> to memref<16777216xbf16, strided<[1], offset: 17301504>>
        %reinterpret_cast_3 = memref.reinterpret_cast %subview_2 to offset: [0], sizes: [2048, 8192], strides: [8192, 1] : memref<16777216xbf16, strided<[1], offset: 17301504>> to memref<2048x8192xbf16>
        %subview_4 = memref.subview %arg2[0] [2097152] [1] : memref<2097152xbf16> to memref<2097152xbf16>
        %reinterpret_cast_5 = memref.reinterpret_cast %subview_4 to offset: [0], sizes: [256, 8192], strides: [8192, 1] : memref<2097152xbf16> to memref<256x8192xbf16>
        aiex.run @sequence(%reinterpret_cast, %reinterpret_cast_1, %reinterpret_cast_3, %reinterpret_cast_5) : (memref<256x2048xbf16>, memref<2048x8192xbf16>, memref<2048x8192xbf16>, memref<256x8192xbf16>)
      }
      aiex.configure @op1__SwiGLUStreamGroup {
        %subview = memref.subview %arg2[0] [2097152] [1] : memref<2097152xbf16> to memref<2097152xbf16>
