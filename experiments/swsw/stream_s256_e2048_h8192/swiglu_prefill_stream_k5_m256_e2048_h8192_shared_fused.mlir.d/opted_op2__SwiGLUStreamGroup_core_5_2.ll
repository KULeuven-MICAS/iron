; ModuleID = '/home/micas/iron-stream-dse/experiments/swsw/stream_s256_e2048_h8192/swiglu_prefill_stream_k5_m256_e2048_h8192_shared_fused.mlir.d/peano-linked_op2__SwiGLUStreamGroup_core_5_2.ll'
...
.preheader:                                       ; preds = %.preheader, %.preheader3
  ...
  tail call void @op2_eltwise_mul_bf16_vector(ptr nonnull @of_2_unicast_5_0_cons_buff_0, ptr nonnull @of_3_unicast_5_0_cons_buff_0, ptr nonnull @of_4_unicast_5_buff_0, i32 2048)
  ...
  tail call void @llvm.aie2p.acquire(i32 51, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  tail call void @op2_eltwise_mul_bf16_vector(ptr nonnull @of_2_unicast_5_0_cons_buff_1, ptr nonnull @of_3_unicast_5_0_cons_buff_1, ptr nonnull @of_4_unicast_5_buff_1, i32 2048)
  tail call void @llvm.aie2p.release(i32 52, i32 1)
  tail call void @llvm.aie2p.release(i32 50, i32 1)
  tail call void @llvm.aie2p.release(i32 49, i32 1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
