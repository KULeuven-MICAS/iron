...
10:                                               ; preds = %58, %60, %8
  %11 = phi ptr [ %61, %60 ], [ %59, %58 ], [ @of_10_unicast_4_buff_0, %8 ]
...
22:                                               ; preds = %62, %64, %20
  %23 = phi ptr [ %65, %64 ], [ %63, %62 ], [ @of_9_unicast_4_0_cons_buff_0, %20 ]
...
27:                                               ; preds = %66, %68, %25
  %28 = phi ptr [ %69, %68 ], [ %67, %66 ], [ @of_5_broadcast_0_0_4_cons_buff_0, %25 ]
  %29 = getelementptr [64 x [64 x bfloat]], ptr %28, i32 0, i32 0, i32 0
  br label %30

30:                                               ; preds = %27
  %31 = trunc i64 %15 to i32
  store i32 %31, ptr @flash_index_4_4
  store i32 4, ptr getelementptr inbounds nuw (i8, ptr @flash_index_4_4, i64 4)
...
33:                                               ; preds = %70, %72, %30
  %34 = phi ptr [ %73, %72 ], [ %71, %70 ], [ @flash_scale_4_3_4_4_buff_0, %30 ]
...
36:                                               ; preds = %33
  ...
  call void @op0_matmul_PV(ptr %24, ptr %29, ptr %12, ptr %35, i32 64, i32 %38, ptr @flash_index_4_4)
  %39 = icmp eq i32 %31, 7
  br i1 %39, label %40, label %41

40:                                               ; preds = %36
  call void @op0_rescale_O(ptr %12, ptr %35, i32 64, ptr @flash_index_4_4)
  br label %41
...
58:                                               ; preds = %8
  %59 = phi ptr [ @of_10_unicast_4_buff_0, %8 ]
  br label %10

60:                                               ; preds = %8
  %61 = phi ptr [ @of_10_unicast_4_buff_1, %8 ]
  br label %10

62:                                               ; preds = %20
  %63 = phi ptr [ @of_9_unicast_4_0_cons_buff_0, %20 ]
  br label %22

64:                                               ; preds = %20
  %65 = phi ptr [ @of_9_unicast_4_0_cons_buff_1, %20 ]
  br label %22

66:                                               ; preds = %25
  %67 = phi ptr [ @of_5_broadcast_0_0_4_cons_buff_0, %25 ]
  br label %27

68:                                               ; preds = %25
  %69 = phi ptr [ @of_5_broadcast_0_0_4_cons_buff_1, %25 ]
  br label %27

70:                                               ; preds = %30
  %71 = phi ptr [ @flash_scale_4_3_4_4_buff_0, %30 ]
  br label %33

72:                                               ; preds = %30
  %73 = phi ptr [ @flash_scale_4_3_4_4_buff_1, %30 ]
  br label %33
}
