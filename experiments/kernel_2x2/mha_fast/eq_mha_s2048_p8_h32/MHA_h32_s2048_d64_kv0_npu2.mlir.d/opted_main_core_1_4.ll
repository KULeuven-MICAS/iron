; ModuleID = '/home/micas/iron-stream-dse/experiments/kernel_2x2/mha_fast/eq_mha_s2048_p8_h32/MHA_h32_s2048_d64_kv0_npu2.mlir.d/peano-linked_main_core_1_4.ll'
source_filename = "LLVMDialectModule"
target datalayout = "e-m:e-p:20:32-i1:8:32-i8:8:32-i16:16:32-i32:32:32-f32:32:32-i64:32-f64:32-a:0:32-n32"
target triple = "aie2p"

@idx_buffer_pv_1 = global [2 x i32] zeroinitializer
@mha_rtpss_1_stage2 = external local_unnamed_addr global [4 x i32]
...
define void @core_1_4() local_unnamed_addr {
  ...
  %1 = load i32, ptr @mha_rtpss_1_stage2, align 4
  %2 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_1_stage2, i20 4), align 4
  %3 = sext i32 %1 to i64
  %4 = icmp sgt i32 %2, 1
  %5 = icmp sgt i32 %1, 0
  %6 = add nsw i32 %2, -2
...
8:                                                ; preds = %0, %._crit_edge
  ...
  store i32 0, ptr @idx_buffer_pv_1, align 4
  store i32 1, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_pv_1, i20 4), align 4
...
.lr.ph23:                                         ; preds = %8, %68
  ...
  %spec.select = select i1 %cond, ptr @outO1_buff_1, ptr @outO1_buff_0
  tail call void @zero_bf16(ptr nonnull %spec.select)
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %cond1 = icmp eq i32 %16, 1
  %19 = select i1 %cond1, ptr @outP1_cons_buff_1, ptr @outP1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond2 = icmp eq i32 %15, 1
  %20 = select i1 %cond2, ptr @memV_1_cons_buff_1, ptr @memV_1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 1, i32 -1)
  %cond3 = icmp eq i32 %14, 1
  %21 = select i1 %cond3, ptr @scaleOF1_buff_1, ptr @scaleOF1_buff_0
  tail call void @matmul_PV(ptr nonnull %19, ptr nonnull %20, ptr nonnull %spec.select, ptr nonnull %21, i32 64, i32 0, ptr nonnull @idx_buffer_pv_1)
  ...
  %31 = load i32, ptr @idx_buffer_pv_1, align 4
  %32 = add i32 %31, 1
  store i32 %32, ptr @idx_buffer_pv_1, align 4
...
.lr.ph:                                           ; preds = %.lr.ph23, %.lr.ph
  ...
  %spec.select13 = select i1 %cond4, ptr @outP1_cons_buff_1, ptr @outP1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond5 = icmp eq i32 %34, 1
  %37 = select i1 %cond5, ptr @memV_1_cons_buff_1, ptr @memV_1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 1, i32 -1)
  %cond6 = icmp eq i32 %33, 1
  %38 = select i1 %cond6, ptr @scaleOF1_buff_1, ptr @scaleOF1_buff_0
  tail call void @matmul_PV(ptr nonnull %spec.select13, ptr nonnull %37, ptr nonnull %spec.select, ptr nonnull %38, i32 64, i32 1, ptr nonnull @idx_buffer_pv_1)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  %39 = add i32 %35, 1
  ...
  %48 = load i32, ptr @idx_buffer_pv_1, align 4
  %49 = add i32 %48, 1
  store i32 %49, ptr @idx_buffer_pv_1, align 4
...
55:                                               ; preds = %.loopexit
  ...
  %spec.select14 = select i1 %cond7, ptr @outP1_cons_buff_1, ptr @outP1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond8 = icmp eq i32 %53, 1
  %56 = select i1 %cond8, ptr @memV_1_cons_buff_1, ptr @memV_1_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 1, i32 -1)
  %cond9 = icmp eq i32 %54, 1
  %57 = select i1 %cond9, ptr @scaleOF1_buff_1, ptr @scaleOF1_buff_0
  tail call void @matmul_PV(ptr nonnull %spec.select14, ptr nonnull %56, ptr nonnull %spec.select, ptr nonnull %57, i32 64, i32 1, ptr nonnull @idx_buffer_pv_1)
  tail call void @rescale_O(ptr nonnull %spec.select, ptr nonnull %57, i32 64, ptr nonnull @idx_buffer_pv_1)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  %58 = add i32 %52, 1
...
67:                                               ; preds = %.loopexit
  tail call void @rescale_O(ptr nonnull %spec.select, ptr nonnull %21, i32 64, ptr nonnull @idx_buffer_pv_1)
  br label %68
...
68:                                               ; preds = %67, %55
  ...
  store i32 0, ptr @idx_buffer_pv_1, align 4
  %72 = load i32, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_pv_1, i20 4), align 4
  %73 = add i32 %72, 8
  store i32 %73, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_pv_1, i20 4), align 4
