; ModuleID = '/home/micas/iron-stream-dse/experiments/kernel_2x2/mha_fast/eq_mha_s2048_p8_h32/MHA_h32_s2048_d64_kv0_npu2.mlir.d/peano-linked_main_core_3_3.ll'
source_filename = "LLVMDialectModule"
target datalayout = "e-m:e-p:20:32-i1:8:32-i8:8:32-i16:16:32-i32:32:32-f32:32:32-i64:32-f64:32-a:0:32-n32"
target triple = "aie2p"

@scale_buffer_softmax_3 = global [256 x bfloat] zeroinitializer
@idx_buffer_softmax_3 = global [2 x i32] zeroinitializer
@mha_rtpss_3_stage1 = external local_unnamed_addr global [4 x i32]
...
define void @core_3_3() local_unnamed_addr {
  ...
  %1 = load i32, ptr @mha_rtpss_3_stage1, align 4
  %2 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_3_stage1, i20 4), align 4
  %3 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_3_stage1, i20 8), align 4
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_3_stage1, i20 12), align 4
  %5 = sext i32 %1 to i64
  %6 = sext i32 %2 to i64
  %7 = icmp sgt i32 %1, 0
  %8 = icmp sgt i32 %2, 0
...
9:                                                ; preds = %0, %._crit_edge14
  ...
  store i32 0, ptr @idx_buffer_softmax_3, align 4
  store i32 3, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_softmax_3, i20 4), align 4
...
.lr.ph13:                                         ; preds = %9, %._crit_edge
  ...
  tail call void @init_scale_buffer(ptr nonnull @scale_buffer_softmax_3, i32 64)
...
.lr.ph:                                           ; preds = %.lr.ph13, %.lr.ph
  ...
  %spec.select = select i1 %cond, ptr @memP3_buff_1, ptr @memP3_buff_0
  tail call void @llvm.aie2p.acquire(i32 53, i32 -1)
  %cond1 = icmp eq i32 %19, 1
  %22 = select i1 %cond1, ptr @outA3_cons_buff_1, ptr @outA3_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  %cond2 = icmp eq i32 %18, 1
  %23 = select i1 %cond2, ptr @scaleOF3_buff_1, ptr @scaleOF3_buff_0
  tail call void @partial_softmax(ptr nonnull %22, ptr nonnull %spec.select, ptr nonnull @scale_buffer_softmax_3, ptr nonnull @idx_buffer_softmax_3, bfloat 0xR3E39, i32 64, i32 64, i32 %3, i32 %4)
  tail call void @passThroughLine(ptr nonnull @scale_buffer_softmax_3, ptr nonnull %23, i32 256)
  ...
  %33 = load i32, ptr @idx_buffer_softmax_3, align 4
  %34 = add i32 %33, 1
  store i32 %34, ptr @idx_buffer_softmax_3, align 4
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph13
  ...
  store i32 0, ptr @idx_buffer_softmax_3, align 4
  %37 = load i32, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_softmax_3, i20 4), align 4
  %38 = add i32 %37, 8
  store i32 %38, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_softmax_3, i20 4), align 4
