; ModuleID = '/home/micas/iron-stream-dse/experiments/kernel_2x2/mha_fast/eq_mha_s2048_p8_h32/MHA_h32_s2048_d64_kv0_npu2.mlir.d/peano-linked_main_core_6_2.ll'
source_filename = "LLVMDialectModule"
target datalayout = "e-m:e-p:20:32-i1:8:32-i8:8:32-i16:16:32-i32:32:32-f32:32:32-i64:32-f64:32-a:0:32-n32"
target triple = "aie2p"

@idx_buffer_qk_6 = global [2 x i32] zeroinitializer
@mha_rtpss_6_stage0 = external local_unnamed_addr global [4 x i32]
...
define void @core_6_2() local_unnamed_addr {
  ...
  %1 = load i32, ptr @mha_rtpss_6_stage0, align 4
  %2 = load i32, ptr getelementptr inbounds nuw (i8, ptr @mha_rtpss_6_stage0, i20 4), align 4
  %3 = sext i32 %1 to i64
  %4 = sext i32 %2 to i64
  %5 = icmp sgt i32 %1, 0
  %6 = icmp sgt i32 %2, 0
...
7:                                                ; preds = %0, %._crit_edge13
  ...
  store i32 0, ptr @idx_buffer_qk_6, align 4
  store i32 6, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_qk_6, i20 4), align 4
...
.lr.ph12:                                         ; preds = %7, %._crit_edge
  ...
  %spec.select = select i1 %cond, ptr @memQ22_cons_buff_1, ptr @memQ22_cons_buff_0
...
.lr.ph:                                           ; preds = %.lr.ph12, %.lr.ph
  ...
  %spec.select5 = select i1 %cond1, ptr @memK_6_cons_buff_1, ptr @memK_6_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  %cond2 = icmp eq i32 %16, 1
  %19 = select i1 %cond2, ptr @memA6_buff_1, ptr @memA6_buff_0
  tail call void @zero_bf16(ptr nonnull %19)
  tail call void @matmul_bf16_bf16_wrapper(ptr nonnull %spec.select, ptr nonnull %spec.select5, ptr nonnull %19, ptr nonnull @idx_buffer_qk_6)
  ...
  %26 = load i32, ptr @idx_buffer_qk_6, align 4
  %27 = add i32 %26, 1
  store i32 %27, ptr @idx_buffer_qk_6, align 4
...
._crit_edge:                                      ; preds = %.lr.ph, %.lr.ph12
  ...
  store i32 0, ptr @idx_buffer_qk_6, align 4
  %30 = load i32, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_qk_6, i20 4), align 4
  %31 = add i32 %30, 8
  store i32 %31, ptr getelementptr inbounds nuw (i8, ptr @idx_buffer_qk_6, i20 4), align 4
