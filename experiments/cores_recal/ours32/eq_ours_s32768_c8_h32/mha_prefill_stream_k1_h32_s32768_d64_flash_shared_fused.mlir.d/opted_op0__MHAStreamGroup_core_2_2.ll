; ModuleID = '/home/micas/iron-stream-dse/experiments/cores_recal/ours32/eq_ours_s32768_c8_h32/mha_prefill_stream_k1_h32_s32768_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_2_2.ll'
...
3:                                                ; preds = %.preheader, %27
  ...
  %invariant.op = or disjoint i32 %7, 2
  br label %8
...
8:                                                ; preds = %3, %21
  ...
  %spec.select = select i1 %cond, ptr @of_4_broadcast_0_0_2_cons_buff_1, ptr @of_4_broadcast_0_0_2_cons_buff_0
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  tail call void @llvm.aie2p.acquire(i32 48, i32 -1)
  tail call void @op0_zero_bf16_64_64_64(ptr nonnull @of_6_unicast_2_buff_0)
  tail call void @op0_zero_bf16_64_64_64(ptr nonnull @of_6_unicast_2_relay_1_buff_0)
...
16:                                               ; preds = %12
  ...
  %17 = select i1 %cond1, ptr @of_3_unicast_2_0_cons_buff_1, ptr @of_3_unicast_2_0_cons_buff_0
  %spec.select5 = select i1 %cond1, ptr @of_6_unicast_2_relay_1_buff_0, ptr @of_6_unicast_2_buff_0
