; ModuleID = '/home/micas/iron-stream-dse/experiments/verify4/mha_prefill_stream_k1_h2_s1024_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_2_4.ll'
...
24:                                               ; preds = %23, %15
  tail call void @op0_matmul_softmax(ptr nonnull %spec.select, ptr nonnull %20, ptr nonnull %spec.select5, ptr nonnull @flash_state_2_4, ptr nonnull @flash_index_2_4, bfloat 0xR3FB9, i32 64, i32 64, i32 1024, i32 1024)
