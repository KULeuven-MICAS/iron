; ModuleID = '/home/micas/iron-stream-dse/experiments/x1/mha_prefill_stream_k1_h1_s2048_d64_flash_shared_fused.mlir.d/peano-linked_op0__MHAStreamGroup_core_0_4.ll'
...
7:                                                ; preds = %.preheader, %68
  ...
  tail call void @op0_zero_bf16(ptr nonnull @of_8_unicast_0_buff_0)
  tail call void @op0_zero_bf16(ptr nonnull @of_8_unicast_0_buff_1)
...
16:                                               ; preds = %7, %56
  ...
  %23 = select i1 %cond3, ptr @of_7_switch_join_0_0_buff_1, ptr @of_7_switch_join_0_0_buff_0
  %cond4 = icmp eq i32 %19, 1
  %24 = select i1 %cond4, ptr @of_7_switch_join_0_1_buff_1, ptr @of_7_switch_join_0_1_buff_0
...
32:                                               ; preds = %16, %51
  ...
  %spec.select21 = select i1 %cond5, ptr @of_8_unicast_0_buff_1, ptr @of_8_unicast_0_buff_0
