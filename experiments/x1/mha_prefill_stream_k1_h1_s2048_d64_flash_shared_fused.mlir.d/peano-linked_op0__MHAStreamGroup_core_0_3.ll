...
14:                                               ; preds = %33, %11
  %15 = phi i64 [ %40, %33 ], [ 0, %11 ]
  %16 = phi i32 [ %39, %33 ], [ %8, %11 ]
  %17 = phi i32 [ %36, %33 ], [ %9, %11 ]
  %18 = icmp slt i64 %15, 32
...
21:                                               ; preds = %46, %48, %19
  %22 = phi ptr [ %49, %48 ], [ %47, %46 ], [ @of_7_switch_join_0_0_buff_0, %19 ]
...
24:                                               ; preds = %21
  ...
  store i32 %25, ptr @flash_index_0_3
  store i32 %13, ptr getelementptr inbounds nuw (i8, ptr @flash_index_0_3, i64 4)
  %26 = icmp eq i32 %25, 0
...
28:                                               ; preds = %27, %24
  call void @op0_partial_softmax_mode(ptr @of_6_switch_fork_0_0_buff_0, ptr %23, ptr @flash_state_0_3, ptr @flash_index_0_3, bfloat 0xR3FB9, i32 64, i32 64, i32 2048, i32 2048, i32 3)
...
30:                                               ; preds = %50, %52, %28
  %31 = phi ptr [ %53, %52 ], [ %51, %50 ], [ @flash_scale_0_3_buff_0, %28 ]
  %32 = getelementptr [256 x bfloat], ptr %31, i32 0, i32 0
  br label %33

33:                                               ; preds = %30
  call void @op0_passThroughLine(ptr @flash_state_0_3, ptr %32, i32 256)
...
46:                                               ; preds = %19
  %47 = phi ptr [ @of_7_switch_join_0_0_buff_0, %19 ]
  br label %21

48:                                               ; preds = %19
  %49 = phi ptr [ @of_7_switch_join_0_0_buff_1, %19 ]
  br label %21

50:                                               ; preds = %28
  %51 = phi ptr [ @flash_scale_0_3_buff_0, %28 ]
  br label %30

52:                                               ; preds = %28
  %53 = phi ptr [ @flash_scale_0_3_buff_1, %28 ]
  br label %30
}
